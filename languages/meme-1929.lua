...
OP.Global.Locales.Languages["meme-1929"] = {
	...
	anti_cheat = {
		...
		notification_invalid_health = "undefined",
	...
	logs = {
		...
		get_logs_no_permissions = "Player tried to get logs without the necessary permissions."
	},
