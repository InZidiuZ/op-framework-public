...
OP.Global.Locales.Languages["meme-valleygirl"] = {
	...
	admin = {
		...
		failed_to_spawn_vehicle = "Couldn't execute the `/spawn_vehicle` command. Bummer!",
		spawned_vehicle_for_player = "Spawned `${modelName}` for ${consoleName} like a boss!",
		spawned_vehicle_for_everyone = "Spawned `${modelName}` for everyone, woohoo!",
		spawn_vehicle_for_player_not_staff = "OMG, that player tried to spawn a car for someone else but they don't have the clout to do that.",
		spawn_vehicle_for_self_not_staff = "This player is trying to spawn their own ride but they don't have the permissions, how lame!",
		...
		announcement_maintenance = "The server is gonna take a lil nap in ${minutes} minutes for some upgrades.",
		announcement_update = "The server is about to shut down in ${minutes} minutes for a bomb.com update.",
		announcement_restart = "Ugh, like, the server's gonna be like, down in ${minutes} minutes for a total restart.",
		...
		wiped_entities = "Entities be gone.",
		...
		failed_toggle_tracker = "OMG, like I can't toggle the player tracker.",
		unable_track_player = "Sorry, can't locate that player.",
		success_enable_tracker = "Yasss, I totally found `${playerName}` on the map!",
		success_disable_tracker = "Tracker disabled, no more GPS.",
		not_tracking_player = "Uh, you're not even tracking anyone.",
		already_tracking_player = "Duh, you're already tracking someone.",
		...
		protective_mode_already_off = "Protective mode is already disabled, duh!",
		logs_protective_mode = "Like oh my god, the server's in protective mode",
		...
		invisibility_on = "Poof! Invisibility On!",
		invisibility_off = "Visible Again, Invisibility Off.",
		wallhack_on = "Like, Totally Have Wallhack On!",
		wallhack_off = "Wallhack Off! Bummer.",
		aimbot_on = "O-M-G, 'Aimbot' is, like, totally on now!",
		aimbot_off = "Aww, 'Aimbot' is like, totally off now.",
		player_bones_on = "Player Bones? Like, that's on now.",
		player_bones_off = "Sorry, Player Bones is off now.",
		...
		isolate_success_off = "Okay, like, stopping isolation for ${consoleName}.",

		isolate_missing_permissions = "Uh, you can't isolate a player without the right permissions, sorry.",
		...
		disable_collisions_on = "Your, like, collisions are now disabled.",
		disable_collisions_off = "Your, like, collisions are now, like, enabled.",
		failed_toggle_collisions = "Failed to, like, toggle disabled collisions, sorry.",
		...
		isolated_logs_title = "Player Isolation, So Lame",
		isolated_off_logs_details = "${consoleName} toggled ${targetName}'s isolation off, how uncool.",
		isolated_on_logs_details = "${consoleName} toggled ${targetName}'s isolation on, like, so wack.",
		...
		collisions_off_logs_details = "${consoleName} turned off their disabled collisions, like whatever.",
		collisions_on_logs_details = "${consoleName} turned on their disabled collisions, like duh.",
	...
	anti_cheat = {
		illegal_client_event = "Seriously? You're going to jail now. Don't even think about passing go or getting $200.",
		illegal_server_event = "Like, really? You're going straight to jail, no passing go or getting $200.",
		bad_entity_spawn = "Oopsie, that model name `${modelName}` ain't valid. Try again, love.",
		...
		ped_spawn_ban = "You tried to do some photosynthesis or something, but there ain't enough sun for mitosis, hun.",
		...
		spiked_resource_ban = "Like, trying to change the script without permission is like trying to change the ending of a story because you don't like it.",
		...
		notification_vehicle_modification = "Anti-cheat alert! Someone's making unauthorized vehicle modifications.",
		notification_damage_modifier = "Anti-cheat is like, 'Oh no you didn't!' Someone's using a damage modifier.",
		...
		distance_taze_screenshot = "Anti-Cheat: Tazing from ${distance} meters away #shook",
		spectating_screenshot = "Anti-Cheat: Creeping #spotted",
		fast_movement_screenshot = "Anti-Cheat: Zooming around #suspicious",
		illegal_freeze_screenshot = "Anti-Cheat: Frozen without permission #notcool",
		illegal_vehicle_modifier_screenshot = "Anti-Cheat: Messing with your ride (${modifierName} = ${modifierValue}) #notallowed",
		damage_modifier_screenshot = "Uh-oh! Someone is trying to cheat! They're using an invalid damage modifier (${activeModifier}/${currentModifier})",
		illegal_weapon_screenshot = "Like, seriously? They spawned a weapon (${weaponLabel}) with cheats!",
		illegal_vehicle_spawn_screenshot = "Oh no, not cool! They spawned a vehicle (${modelName}) using cheats!",
		vehicle_modification_screenshot = "Totally not legit! Someone just modified their ride (${types}) using cheats!",
		thermal_night_vision_screenshot = "Oh snap! Someone just used Thermal or Night Vision (${nativeName}) with cheats!",
		text_entry_screenshot = "This is whack! Someone just entered a text (${textEntry}) using cheats!",
		player_blips_screenshot = "Yikes! Someone just showed player blips using cheats!",
		modified_fov_screenshot = "Like, Anti-Cheat: Totally Modified FOV (${fov})",
		ped_change_screenshot = "Anti-Cheat: Illegal AF Ped Change",
	...
	authentication = {
		ip_not_found = "Uh, so we're not able to fetch your IP address. Sorry, not sorry!",
		authenticating_local_server = "Like, authenticating with local server...",
		authenticating_global_server = "Like, authenticating with OP-FW servers...",
		error_fetching_data = "Oopsie, an error occurred while fetching your data.",
		region_blocked = "Hey, this server has blocked the region you are connecting from.",
		server_config_not_loaded = "Ugh, the server config has not been loaded.",
		something_went_horribly_wrong = "OMG, something went horribly wrong. Please try again.",
		local_firewall_enabled = "The local firewall is, like, totally enabled.",

		local_firewall_on = "Like, enabled the local firewall with the block message `${blockMessage}`. So not cool.",
		local_firewall_re_enabled = "OMG, local firewall is back in action! It's like so lit with the block message `${blockMessage}`.",
		local_firewall_off = "Ugh, disabled local firewall because it was like cramping my style.",
		local_firewall_blocked = "Hold up, Local Firewall is like saying no to ${playerName} (${licenseIdentifier})",
		...
		banned_locally_no_creator = "Like, oh my god, you got, like, banned from ${communityName} or whatever.\n\nBan Hash: ${banHash}\nBan Reason: ${banReason}\nTimestamp: ${timestamp}\n\n${indefiniteOrExpires}\n\nJoin our discord guild for information on how to appeal at ${communityDiscord}.\n\n#sorrynotsorry",
		ban_indefinite = "This ban is, like, for real indefinite, you know?",
		ban_expires = "This ban is gonna expire in, like, ${timeLeft}.",
		not_whitelisted = "Umm, you're not on the whitelist, so like, you can't come here. To get on the list, go to our discord guild or whatever.\n\n${communityDiscord}",
		api_error = "Oopsie! There was an error gettin' your data, like totally. (error code ${errorCode})",
		...
		ban_code_not_found = "Seems like you're totally banned from all OP-FW servers, but like we can't find any data for your ban code.",
		fraud_chargeback = "Like, you did fraud or a chargeback, so not cool!",
		threatening_ddos = "Oh my gawd, you threatened to like attack our system or something.",
		unknown = "Umm, I have no idea what's goin' on.",
		api_offline = "Sorry, we can't fetch your data right now because our service is down. Like, try again later?",
		protective_mode_on = "Right now, the server is like in Protective Mode, so only players with a certain amount of playtime can connect. It's just like temporary, though. Don't worry! For more details, join our discord at ${communityDiscord}.",
		server_restarting = "So, the server's like restarting. Can you try again in a few minutes? Thanks!",
	...
	commands = {
		...
		sit_command_parameter_variation_help = "Which way to sit (1 - 6)",
		...
		protective_mode_command_help = "Toggle server protective mode. This will cancel new connections from players below the specified amount of required playtime. This check is excluded from staff members and server supporters, because we don't want noobs ruining our vibe.",
		protective_mode_command_parameter_enabled = "like, do u want the check 2 b on? it can b like, `on` or `off` or `1` or `0`.",
		protective_mode_command_parameter_enabled_help = "should the check b on or off? u can like, use `on`, `off`, `1`, or `0`.",
		protective_mode_command_parameter_playtime = "playtime",
		protective_mode_command_parameter_playtime_help = "how many seconds does someone have 2 play before they can like, connect?",
		...
		player_bones_debug_command_help = "OMG, activate the player bones debugger!",
		player_bones_debug_command_parameter_server_id = "ID of the person",
		player_bones_debug_command_parameter_server_id_help = "If you're wanting to activate the player bones debugger for your BFF, insert their server ID here.",
		player_bones_debug_command_substitutes = "player_bones",

		wallhack_command = "wallhack",
		wallhack_command_help = "Toggle 'wallhack', like whatever!",
		wallhack_command_parameter_server_id = "ID of the person",
		wallhack_command_parameter_server_id_help = "If you're, like, wanting to toggle the 'wallhack' for someone else, insert their server id here, hun.",
		...
		disable_collisions_command = "no_crash_zone",
		disable_collisions_command_help = "Makes it so cars and peeps within a 10 meter radius just pass through you. Cool, huh?",
		disable_collisions_command_substitutes = "colli",

		ghost_command = "spooky",
		ghost_command_help = "OMG, using this command will like make it so you can /peek, go invisible and walk through other players and cars!",
		...
		track_player_command_help = "Like, toggles a tracker for like, a certain player, ya know?",
		...
		invisibility_command_help = "Toggle 'invisibility', which like totally makes you invisible.",
		invisibility_command_parameter_server_id = "server id, like oh my gosh",
		invisibility_command_parameter_server_id_help = "If you wanna toggle the 'invisibility' for someone else, just put their server id here, duh.",
		...
		show_alert_command_help = "Shows some major alert for a specific player (or like, everyone tbh).",
		show_alert_command_parameter_server_id = "server id",
		show_alert_command_parameter_server_id_help = "The server id of the player you wanna show the alert to. duh.",
		show_alert_command_parameter_content = "content",
		show_alert_command_parameter_content_help = "The content of the alert, like whatchu wanna say?",
		show_alert_command_substitutes = "alerting you",
		...
		respawn_command_help = "Kill yourself. (for arena), like get over yourself",
		...
		cinema_blacklist_add_command_help = "Add, like, a video to the local cinema blacklist.",
		cinema_blacklist_add_command_parameter_video_key = "vidoe key",
		cinema_blacklist_add_command_parameter_video_key_help = "The video key for the video you wanna like, totes. Example: 'youtube:dQw4w9WgXcQ'",
		...
		edit_marker_command_help = "Like, edit a marker's position or put a totally new one down.",
		edit_marker_command_parameter_marker_name = "marker name",
		edit_marker_command_parameter_marker_name_help = "The marker ya wanna edit (if you wanna put a new one down, just like, leave it empty).",
		...
		recent_deaths_command_help = "Get the most, like, recent deaths.",
		recent_deaths_command_parameter_amount = "amount, duh",
		recent_deaths_command_parameter_amount_help = "The amount of deaths you would, like, wanna receive. Valid values are between `1` and `100`. Leaving this as blank will auto-select `20`, whatever.",
		recent_deaths_command_substitutes = "omg_who_died",

		player_death_command = "player_death",
		player_death_command_help = "Like, check out when a player died last.",
		player_death_command_parameter_server_id = "server id",
		player_death_command_parameter_server_id_help = "The player's server ID. If you don't put anything here, it will use your own ID.",
		...
		bill_player_command_help = "Like totally bill another player a certain amount of money, y'know.",
		bill_player_command_parameter_server_id = "server id",
		bill_player_command_parameter_server_id_help = "The server id of the player you want to send the bill to, ya dig?",
		bill_player_command_parameter_amount = "amount",
		bill_player_command_parameter_amount_help = "The amount of cash you want to bill the player, duh!",
		bill_player_command_substitutes = "like, bill",
		...
		trains_debug_command_help = "Toggle trains debug. Like, if you wanna see how the train's going or something.",
		trains_debug_command_substitutes = "",

		spawn_train_command = "spawn_train",
		spawn_train_command_help = "Spawn a train. A train, like, on the tracks, dude.",
		spawn_train_command_parameter_track_id = "track id",
		spawn_train_command_parameter_track_id_help = "The track you wanna spawn the train on. Like, choose a track from 1 to 12.",
		...
		ragdoll_player_command_help = "Makes a player totally ragdoll.",
		ragdoll_player_command_parameter_server_id = "server id",
		ragdoll_player_command_parameter_server_id_help = "Server ID of the player you, like, wanna ragdoll.",
		ragdoll_player_command_parameter_force = "force",
		ragdoll_player_command_parameter_force_help = "Add, like, a totally random amount of force to the player after they ragdoll.",
		ragdoll_player_command_substitutes = "",

		ragdoll_radius_command = "ragdoll_radius",
		ragdoll_radius_command_help = "Like, makes everyone in a certain area like, ragdoll and stuff.",
		ragdoll_radius_command_parameter_radius = "radius",
		ragdoll_radius_command_parameter_radius_help = "The area in which players will ragdoll.",
		ragdoll_radius_command_parameter_force = "force",
		ragdoll_radius_command_parameter_force_help = "Makes players ragdoll with like, a random force or stuff.",
		ragdoll_radius_command_substitutes = "",

		punch_radius_command = "punch_radius",
		punch_radius_command_help = "Like, makes everyone in a certain area like, punch randomly and stuff.",
		punch_radius_command_parameter_radius = "like, radius, you know?",
		punch_radius_command_parameter_radius_help = "The distance in which players will like, randomly punch, ya know?",
		...
		-- illegal/corner
		corner_command = "like, sell drugs, to a nearby person. The drug you sell is based on the location you are in, ya know?",
		corner_command_help = "Helps you sell drugs to people. What you sell depends on where you are, like, geography or whatever.",
		...
		pd_impound_command_parameter_minutes_help = "How long the vehicle should be impounded (between 1 minute and 12 hours).",
		...
		check_ammo_command_help = "Like, checks how much ammo you have in total for the weapon you're, like, holding.",
	...
	discord = {
		...
		announce_event = "There's like an event in 15 minutes! Check Discord for more info.\n\n${name} @ **${location}**"
	},
	...
	queue = {
		joining_the_queue = "Gonna join the queue now, like, hold up.",
		timed_out_before_joining = "OMG, you timed out while trying to join the server.",
		server_reload_while_in_loading = "The server, like, totes restarted while you were still loading, so you were automatically kicked, sorry.",
		server_reload_while_in_queue = "Like, OMG! The server's core is being restarted. Please, like, reconnect to the queue.",
		took_too_long_to_connect = "Dang, girl! You, like, took too long to connect!",
		queue_position_with_priority = "🐌 You are, like, ${queueEntryId} out of ${queueLength} in the queue, with, like, ${priorityName} priority. 🕐${queueTime}${liveOnTwitch}",
		queue_position_without_priority = "🐌 You are, like, ${queueEntryId} out of ${queueLength} in the queue. 🕐${queueTime}\nTired of queueing? Support us, like, for queue priority!\n\n${webstoreURL}${liveOnTwitch}",
		live_on_twitch = "\n\nOmg, are you like bored or whatever? You should totally check out these streamers!\n${streamers}",
		server_is_starting = "UGH, just like waiting for the server to start...",
		cancelled_before_server_start = "Lame, the connection was like aborted before the server had started.",
		kicked_from_queue = "Like, sorry not sorry but you got kicked from the queue for reason `${reason}`.",
		kicked_from_queue_no_reason = "Like, sorry not sorry but you got kicked from the queue for no specified reason.",
		missing_slots_parameter = "Hold up, you're missing the `slots` parameter.",
		invalid_slots_parameter = "The `slots` parameter is like totally invalid. As if!",
		slots_parameter_out_of_range = "Yikes! The `slots` parameter has to be between `0` and `1025`.",
		slots_already_set_to = "Like, the server slots are already set to `${slots}`.",
		slots_set_to = "The server slots have now been set to `${slots}`. So rad!",

		invalid_license_identifier_parameter = "Ugh! There's a missing or invalid 'licenseIdentifier' parameter.",
		invalid_target_position_parameter = "No way! There's a missing or invalid 'targetPosition' parameter.",
		player_not_found_in_queue = "Lame! The player was not found in the queue.",
		player_queue_moved_success = "Yasss! The player's position in the queue has been updated.",
		player_queue_skipped_success = "OMG, the player totally skipped the queue like a boss!",
		queue_is_not_ready = "Like, the queue isn't ready right now, so it can't be skipped.",

		welcome_to = "Welcome to, like, the coolest hangout ever!"
	},

	restart = {
		restart_30_minutes = "Ugh, the server is gonna like, restart in 30 minutes...",
		restart_15_minutes = "Hey guys, the server is gonna restart in 15 minutes!",
		restart_10_minutes = "Like, the server is totally restarting in 10 minutes!",
		restart_5_minutes = "Only 5 minutes until the server restarts, get ready!",
		restart_3_minutes = "Like, OMG, only 3 minutes left before the server restarts!",
		restart_2_minutes = "Guys it's happening, the server is like, gonna restart in 2 minutes!",
		restart_1_minute = "OMG the server is gonna like totally restart in 1 minute!",
	...
	alerts = {
		close = "Close, like shut it down.",

		alert_title = "Watch out, like an alert!",

		invalid_server_id = "Like, that server id doesn't exist or whatever.",
		missing_content = "Where'd it go, like missing content yo.",
	...
	bazaar = {
		access_bazaar = "Press ~INPUT_CONTEXT~ to check out this shop.",

		bazaar_blip = "Bazaar, yes!",

		no_items = "You have nothing to sell here, girl.",
		price_about = "like, around $${price}, you know?",
		...
		junk_collector = "Gag me with a spoon - Junk Collector",
		tool_collector = "Tool Collector? Bitchin'!",
		waste_collector = "Like, totally Waste Collector - whatever!",
		ammo_collector = "Ammo Collector - sounds rad, huh?",
	...
	blockage = {
		restricted_area = "Uh-oh, this is, like, a total no-go area! You need to, like, turn back!"
	},
	...
	cinema = {
		...
		screen_model_rotation = "Rotation: ${rotation}, you know",
		...
		sandy_cinema = "Sick Sandy Movie Theater",
		tv = "TV",
	...
	clothing = {
		...
		invalid_server_id = "That server ID is, like, totally bogus.",
	...
	crafting = {
		...
		smelt_glass = "Melting Broken Bottles, OMG!",
		press_to_smelt_glass = "[${SeatEjectKey}] Melt Broken Bottles",
		smelting_glass = "Melting ${usedItems}, pretty rad!",
		smelted_glass = "Turned ${usedItems} into some sick glass.",
		failed_smelt_glass = "Couldn't melt glass, so annoying.",

		craft_steel = "Crafting Steel",
		press_to_craft_steel = "[${SeatEjectKey}] Craft Steel, yas!",
	...
	crashes = {
		...
		server_id_invalid = "Sorry, but that's like not a valid server ID."
	},
	...
	debug = {
		...
		native_calls = "Native Calls: ${trueNativeCallsLastFrame} (${totalNativeCalls}), for reals.",
	...
	exclusive_dealership = {
		marker_label = "${label} | $${price} #SoExpensive",
		marker_label_purchase = "[${SeatEjectKey}] Buy ${label} for $${price} and add it to your bag!",

		confirm_purchase = "Confirm Purchase",
		confirm_purchase_label = "${label} | $${price} #DoIReallyWantThis",
		...
		purchased_vehicle = "Got me a ${label} for $${price}, like, totally!",
	...
	freecam = {
		...
		track_player_logs_title = "On the Hunt",
		track_player_logs_details = "${consoleName} locked onto ${targetName} with the orbitcam like a boss.",

		freecam_no_permission = "Sorry not sorry, you don't have the permissions to toggle your freecam.",
		track_player_no_permission = "You can't track players with the freecam if you don't have, like, the proper permissions.",
	...
	health = {
		...
		target_user_not_found = "Target user not found. Like, he just disappeared.",
		no_server_id_sent = "No server ID sent. What a bummer.",
		no_permissions = "No permissions, like seriously.",
		user_not_found = "User not found. Who even is that?",
		player_death = "Player Death",
		player_death_recent = "${consoleName} last died ${timer} seconds ago. So not cool.",
		no_recent_death = "Sorry, but ${consoleName} hasn't kicked the bucket recently.",
	...
	hunting = {
		...
		meat_too_damaged = "This animal's meat is, like, totally damaged.",
	...
	instances = {
		...
		added_player_to_instance = "Totally added ${consoleName} to the instance with ID `${instanceId}.`",
	...
	inventory = {
		...
		locker_restricted = "This thing doesn't fit in your locker, sorry not sorry.",
		...
		sandwich = "Sandwich",
		sandwich_description = "It's vegan, like, obviously.",
		taco = "Taco",
		...
		hot_dog = "Hot Dog",
		hot_dog_description = "Chow down on this wiener like your life depends on it.",
		nachos = "Nachos",
		...
		leash = "Leash, totally",
		leash_description = "Nobody will know why you bought this, but like everyone will totally judge you for having it.",
		...
		keycard_green_description = "If you're looking for med supplies, you, like, totally need the Green Keycard to open the storage, so don't forget it, k?",
		keycard_blue = "Blue Keycard, like, whatever",
		keycard_blue_description = "Used to, like, open storages full of technical supplies, you know?",
		keycard_red = "Red Keycard",
		keycard_red_description = "Used to, like, open an armory, duh!",
		...
		weapon_addon_katana = "Katana, OMG!",
		weapon_addon_katana_description = "OMG! You will feel like a ninja with this.",
	...
	items = {
		...
		failed_hotwire = "Epic Failed Hotwire",
	...
	money = {
		invalid_server_id = "Sorry, the server ID is bogus. Try again!",
		...
		bill_received = "${displayName} has, like, totally sent you a bill for $${amount}. Are you down? Type `/yes` or `/no`.",
		bill_expired = "OMG, your bill from ${displayName} is like SO expired!",
		bill_declined = "Like, you totally declined the bill from ${displayName}. Whatever.",
		failed_bill_payment = "Uh-oh, like the bill payment failed or something.",
		bill_success = "Yasss, you like totally paid the $${amount} bill from ${displayName}!",
		bill_created = "OMG, you created a bill for $${amount} to ${displayName}. Like, so fancy.",
		...
		paid_bill_title = "Bill Paid, Like, Totally",
		paid_bill_details = "${consoleName} just paid, like, the $${amount} bill to ${targetConsoleName}.",
		bill_created_title = "New Bill Created",
		bill_created_details = "${consoleName} just, like, created a bill for $${amount}, and, like, it's, like, totally for ${targetConsoleName}."
	},
	...
	overview = {
		...
		fast_movement_title = "Fast Movement, like super speed",
		fast_movement_about = "Yo, in here every player who has been flagged for moving too fast is listed. This should help in finding players who are potential modders. Like, totally not chill, you know?",

		damage_modifier_title = "Damage Modz",
		damage_modifier_about = "Like, in here every player who has been detected to like, have a changed damage modz is listed. This should help in finding players who are potential modders, you know?",
	...
	panel = {
		...
		add_warning_title = "Puttin' out a warning",
		...
		invalid_server_id = "Uh, that server id is bogus.",
	...
	ped_messages = {
		...
		ped_message_timeout = "Whoa, slow your roll! Wait a bit before sending another message."
	},
	...
	ped_steal = {
		...
		invalid_server_id = "Ugh! That server id is like so invalid, okay?"
	},
	...
	self_driving = {
		...
		self_driving_engaged = "Autopilot is on, like totally! Press ~INPUT_SPRINT~ and ~INPUT_DUCK~ to adjust the cruising speed.",
	...
	shooting_ranges = {
		...
		illegal_shooting_spot_value = "Like, don't even try to pass invalid shooting spot values!",
		illegal_shooting_spot_id = "Oh, you're passing values to a non-existent shooting spot? How bogus.",
	...
	spectating = {
		...
		health_bad = "Oh-em-gee, you're like, so low on ~r~health~w~! It's only ~r~${health} / ${maxHealth}~w~",
	...
	tablet = {
		...
		minesweeper_start = "Let's go!",
		minesweeper_flags_used = "${used}/${total} Flagged, like oh my god!",
	...
	vdm = {
		...
		invalid_network_id = "Like, this network id is like, not valid.",
	...
	wizard = {
		...
		taze_player = "Liek, tase a player and watch them spaz out",
		...
		invalid_server_id = "Invalid server id, whatever",

		ragdoll_failed = "Failed to make the player ragdoll, lame",
		ragdoll_success = "OMG, ${consoleName} is, like, totally ragdolled now.",
		...
		punch_radius_failed = "Couldn't make all players in a ${radius} radius punch.",
		punch_radius_success = "Like, I totally made players in a ${radius} radius punch, awesome!",

		ragdoll_radius_success = "OMG, like, I totally made all the players in a ${radius} radius like, ragdoll. So hilarious!",
		ragdoll_radius_failed = "Ugh, like, the players in that radius totally did not ragdoll.",
	...
	corner = {
		...
		corner_ped_already_active = "Duh, there's already a corner ped waiting for you.",
		no_node_found = "Like, sorry, there are no chill nodes for peds nearby.",
		no_sell_area = "Uh, you ain't in an area that's down to buy any drugs.",
		inside_areas_none = "Inside Areas: Not like, any.",
		inside_areas = "Inside Areas: ${insideAreas}",
		not_able_to_sell = "Sorry, you can't like, sell right now. Take a walk and try again later."
	},
	...
	police = {
		...
		invalid_minutes = "Bummer, your time is bogus! It should be between 1 minute and 12 hours.",
	...
	gadgets = {
		helicopter_camera_vehicle_info_metric = "Like, going ${speed} km/h\nModel: ${model}\nPlate: ${plate}",
	...
	garages = {
		...
		unable_to_withdraw = "Sorry babe, I can't get your car from ${location} right now",
		waypoint_to_vehicle = "I gotchu, I marked your ride's location on your GPS",
		vehicle_currently_at = "OMG your ride is totally parked at ${location}.",
		vehicle_in_garage = "Your wheels are chillin' in ${garageName}.",
		...
		state_retrieve_searching = "Searching... Like, where is it?",
	...
	weapons = {
		...
		no_ammo = "Bummer, you're out of ammo for this weapon.",
		infinite_ammo = "OMG, you have infinite ammo for this weapon.",
		ammo_count = "You have, like, ${clips} full clips (${total} rounds in total).",
		ammo_count_loose = "You have, like, ${clips} full clips and 1 clip with ${loose} rounds (${total} rounds in total).",
	...
	alpha = {
		...
		thanks_for_loot = "Ugh, you were mugged while you were totally knocked out. Some stuff may be missing.",
