...
OP.Global.Locales.Languages["it-IT"] = {
	...
	admin = {
		...
		user_indefinitely_banned_warning_no_reason = "Ho bannato a tempo indeterminato questa persona senza un motivo specifico. Questo avviso è stato generato automaticamente a seguito del ban.",
		user_indefinitely_banned_warning = "Ho bannato a tempo indeterminato questa persona per `${reason}`. Questo avviso è stato generato automaticamente a seguito del bad.",
		user_temporarily_banned_warning_no_reason = "Ho bannato a tempo indeterminato questa persona senza un motivo specifico ${displayTime}. Questo avviso è stato generato automaticamente a seguito del bad..",
		user_temporarily_banned_warning = "Ho bannato questa persona per `${reason}` per ${displayTime}. Questo avviso è stato generato automaticamente a seguito del bad.",
	...
	anti_cheat = {
		...
		honeypot_ban = "Hai tentato di attivare/disattivare la modalità creativa, ma non disponevi delle autorizzazioni per farlo.",

		illegal_ped_change = "È pericoloso eseguire la chirurgia plastica su te stesso.",
		illegal_spectating = "Devi essere un agente FIB per guardare altri giocatori o utilizzare /gamemode spettatore prima di guardare.",
		...
		notification_distance_taze = "Anti-Cheat: ${displayName} Tazed qualcuno su una distanza molto grande (${distance}m).",
	...
	commands = {
		...
		call_airstrike_command_parameter_radius = "raggio",
		call_airstrike_command_parameter_radius_help = "Il raggio dell'area nella quale vuoi bombardare.",
		...
		ped_debug_command_help = "Debug di informazioni su un PED.",
		ped_debug_command_parameter_network_id = "network id",
		ped_debug_command_parameter_network_id_help = "L'ID di rete PEDS.",
		...
		local_time_command_parameter_hour = "ora",
		...
		give_key_command_parameter_plate_number = "Targa",
	...
	arena = {
		...
		hold_to_leave = "Premi ~INPUT_FRONTEND_PAUSE_ALTERNATE~ per ${seconds} secondi per abbandonare l'arena.",
		...
		respawn_cancelled = "Il respawn è stato annullato mentre ti muovevi.",
	...
	boosting = {
		...
		start_contract_type_info = "Ti piacerebbe fare un drop-off o un graffio VIN? Il graffio VIN costa un supplemento ${cost} CRYPT.",
		...
		exit_the_vehicle_to_scratch = "Esci dal veicolo per fare il graffio VIN.",

		scratch = "VIN graffio.",
		press_to_scratch = "Premi ~g~E ~w~per il graffio VIN.",

		scratching_vehicle = "Graffianco il veicolo",
	...
	clothing = {
		...
		mask = "Maschera",
		armor = "Armatura",
		parachute_and_bag = "Paracadute e borse",
		hats_and_helmets = "Cappelli e caschi",
		glasses = "Occhiali",
	...
	crafting = {
		smelt_glass = "Fondi vetro",
		press_to_smelt_glass = "[${SeatEjectKey}] Fondi vetro delle bottiglie rotte",
		smelting_glass = "Fondendo ${usedItems}",
		smelted_glass = "Vetro ${usedItems} fuso.",
		...
		crafting_steel = "Modanatura ${usedItems}",
		crafted_steel = "Craftato ${usedItems} in acciaio.",
		failed_craft_steel = "Non si è riusciti a craftare l'acciaio.",

		scrapping_item = "Articoli di scarto",
		scrapped_item = "Metallo rottamado estratto da ${usedItems}.",
		...
		scrap_item = "Taglia patate",
		press_to_scrap_item = "[${SeatEjectKey}] Taglia patate",
		failed_scrap_item = "Non si è riusciti a tagliare le patate.",
		...
		grill_item = "Assembla l'Hamburger",
		press_to_grill_item = "[${SeatEjectKey}] Griglia l'Hamburger",
		grilling_item = "Grigliando l'Hamburger",
		grilled_item = "Hamburger grigliato",
		failed_grill_item = "Non si è riusciti a grigliare un hamburger.",
		...
		assemble_cheeseburger = "Assembla il Cheeseburger",
		press_to_assemble_cheeseburger = "[${SeatEjectKey}] Assembla il Cheeseburger",
	...
	courthouse = {
		press_to_use_gavel = "Premi ~INPUT_CONTEXT~ per utilizare il martello."
	},
	...
	debug = {
		...
		first_owned_by_us = "Prima di nostra proprietà",
		first_owned_by = "Prima proprietà di",
		first_owned_unknown = "Prima propietà sconosciuta",
		...
		vehicle_acceleration_force = "Accelerazione: ${force}",
	...
	inventory = {
		...
		pink_dildo_description = "Fatto a mano, intagliato e testato da @lele®#0948.",
		...
		cheetos = "Cheetos",
		cheetos_description = "Il miglior snack per le tue sessioni di gioco.",
	...
	overview = {
		...
		field_name = "Campo...",
		value = "Valore...",
		current_overrides = "Attuale sostituzione",
		...
		ped_models_title = "Modello ped player",
		...
		animal_ped_models_title = "Modelli Animali locali",
	...
	spectating = {
		...
		spectate_logs_title = "Giocatore spectato",
		spectate_logs_details = "${consoleName} spectando ${targetUser}."
	},
	...
	police = {
		...
		impound_lot = "Lotto del sequesto",
		exit_impound = "Esci dal sequestro",
		...
		impound_withdraw_logs_title = "Ritiro veicolo PD",
		...
		active_robberies = "\nActive Negozio: ${store}.\nActive Banca: ${bank}\nActive Gioielleria: ${jewelry}",
	...
	vehicles = {
		...
		breaking_window = "Rompendo vetro",
		not_near_window = "Non sei abbastanza vicino al vetro.",
