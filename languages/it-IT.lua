...
OP.Global.Locales.Languages["it-IT"] = {
	...
	inventory = {
		...
		raw_morganite_description = "Una pietra preziosa di un delicato rosa nel suo stato naturale, la morganite grezza è rara e apprezzata per le sue tonalità delicate. Promette il fascino di una bellezza raffinata una volta tagliata e lucidata con maestria.",
		...
		raw_sapphire_description = "Questo zaffiro grezzo, con le sue intense tonalità di blu, parla di profondità e mistero. Resistente quanto è bello, è pronto per essere lavorato in un gioiello che riflette i cieli.",
		...
		emerald = "Smeraldo",
		emerald_description = "Lucidato per rivelare un verde vibrante che rivalizza con la vitalità della primavera, questo smeraldo è una testimonianza dello splendore della natura. Apprezzato per il suo ricco colore e la sua chiarezza, è un must in ogni collezione di gemme.",

		ring = "Annello",
		ring_description = "Una base semplice ma elegante per una creazione personale, questo anello vuoto è realizzato con metallo pregiato, pronto per essere decorato con qualsiasi pietra preziosa. È la tela perfetta per un messaggio inciso, rendendolo unico quanto la storia del suo possessore.",
		...
		morganite_ring_description = "Morbido e delicato, questo anello di morganite brilla con una calda tonalità rosa pesca. La pietra preziosa è incastonata in un telaio in oro rosa che ne esalta il colore delicato, offrendo un pezzo moderno e romantico che si distingue per il suo fascino femminile.",
		ruby_ring = "Anello di rubino",
		ruby_ring_description = "Audace e affascinante, questo anello di rubini vanta una pietra preziosa cremisi intenso al suo centro. Incastonato in una classica fascia d'argento con dettagli intricati, è un pezzo che simboleggia la passione e la forza inarrestabile dell'amore.",
		...
		grenade_shell_description = "Questo guscio vuoto di granata è un componente cruciale per la creazione di granate specializzate, come quelle fumogene o al gas. La sua robusta carcassa è progettata per contenere in modo sicuro e dispiegare varie sostanze quando utilizzata in combinazione con il meccanismo di innesco corretto.",
		...
		skin_brushstroke_description = "Diventa artistico con il tuo arsenale usando questa skin astratta a pennellate. È come avere un pezzo d'arte moderna che può anche fare dei buchi nei tuoi nemici.",
		...
		skin_leopard_description = "Libera il tuo lato selvaggio e vai in cerca con questa pelle a stampa di leopardo feroce. È il modo perfetto per aggiungere un po' di magnetismo animale al tuo equipaggiamento.",
		...
		gold_bar_description = "Questo lingotto d'oro massiccio è un simbolo di ricchezza e opportunità, risplendente di potenziale. Trovato attraverso l'esplorazione e le abili iniziative, può essere venduto per una somma considerevole, rendendolo un bene prezioso per coloro che cercano di migliorare la propria situazione finanziaria. Ciascun lingotto è una testimonianza del valore duraturo dell'oro in qualsiasi mercato.",
		...
		aluminium_description = "Una forma grezza e non raffinata di alluminio, tipicamente trovata in stati meno elaborati. È ideale per riparazioni di base e artigianato, conferendo le sue proprietà leggere ma robuste a varie applicazioni.",
		glass = "Vetro ruvido",
		glass_description = "Questa forma base di vetro, anche se non lucidata e imperfetta, è versatile per vari bisogni di artigianato e riparazioni di base, fornendo essenziale trasparenza e protezione.",
		rubber = "Gomma non curata",
		rubber_description = "Flessibile e modellabile, questa gomma non vulcanizzata è essenziale per l'artigianato e le riparazioni di base dei veicoli. La sua adattabilità la rende adatta a una varietà di usi, dall'isolamento all'assorbimento degli urti.",
		...
		steel_description = "Robusto e resistente, l'acciaio grezzo è un materiale fondamentale per la lavorazione e le riparazioni. La sua natura robusta lo rende indispensabile per l'integrità strutturale in progetti semplici e complessi.",
		...
		vulcanized_rubber_description = "Processato attraverso vulcanizzazione per migliorare la resistenza e l'elasticità, questa gomma è utilizzata in riparazioni di alta qualità. Offre prestazioni migliorate e longevità, ideale per componenti critiche del veicolo.",
		processed_metal = "Metallo processato",
		processed_metal_description = "Questo metallo è stato raffinato e trattato per soddisfare standard di qualità più elevati. Sebbene non sia adatto per la lavorazione artigianale, eccelle nelle riparazioni di veicoli, offrendo maggiore resistenza e resistenza all'usura.",
		refined_steel = "Acciaio raffinato",
		refined_steel_description = "Elegantemente rifinito per applicazioni di alta qualità, questo acciaio è utilizzato esclusivamente dai meccanici per riparazioni di veicoli premium. La sua resistenza superiore e la resistenza alla corrosione garantiscono prestazioni ottimali.",
		...
		rose = "Rosa",
		rose_description = "Una singola, elegante rosa, i suoi petali vibranti e la delicata fragranza parlano da sole. Questo simbolo senza tempo dell'affetto è un modo classico per esprimere i propri sentimenti, portando con sé l'essenza della bellezza e dell'ammirazione profonda.",
		teddy_bear = "Orsacchiotto",
		teddy_bear_description = "Quest'orsetto di peluche morbido e coccoloso è un regalo che scalda il cuore, perfetto per mostrare affetto e cura. Il suo abbraccio peluche trasmette il calore di chi lo dona, rendendolo un ricordo prezioso che simboleggia amore e amicizia.",
		...
		campfire = "Falò",
		campfire_description = "Riunisciti attorno a questo rustico falo, un faro di calore e luce sotto le stelle. Ideale per raccontare storie e scaldarsi, è un rifugio temporaneo che arde luminoso prima di tramutarsi in cenere. Può essere posizionato ovunque nel mondo.",
		tent = "Tenda",
		...
		cloth_tent_description = "Leggera e facile da trasportare, questa tenda di stoffa è il rifugio ideale per i minimalisti che ti tiene al riparo dagli elementi durante le tue escursioni all'aria aperta. Può essere posizionato ovunque nel mondo.",
		...
		plastic_chair_description = "Semplice ma funzionale, questa sedia in plastica offre un rapido punto di riposo ovunque tu vada. Leggera e facile da spostare, è ideale per brevi pause nelle tue attività all'aperto. Può essere posizionata ovunque nel mondo.",
		...
		yoga_mat_description = "Questo tappetino da yoga portatile è la tua base per il relax e l'esercizio all'aperto. Srotolalo per trovare la tua serenità o per fare stretching dopo un'escursione vigorosa. Può essere posizionato ovunque nel mondo.",
		cooler_box = "Scatola frigo",
		cooler_box_description = "Mantieni le tue bevande fresche e rinfrescanti con questa scatola termica isolata. È un must per qualsiasi giornata al sole, mantenendo le tue bevande e snack freddi e pronti. Può essere posizionata ovunque nel mondo.",
		parasol = "Parasole",
		...
		parasol_table_description = "Questo tavolo con parasole è l'ideale compagno per esterni, offrendo una superficie da pranzo stabile con ombra integrata. Perfetto per godersi pasti o rilassarsi all'aperto senza l'abbagliante sole. Può essere posizionato ovunque nel mondo.",
		table = "Tavolo",
		table_description = "Questo semplice tavolo è l'aggiunta perfetta per il tuo campeggio o picnic, fornendo una superficie stabile per i pasti, giochi o per pianificare la tua prossima avventura. Può essere posizionato ovunque nel mondo.",
		towel = "Asciugamano",
		towel_description = "Un asciugamano morbido e assorbente per asciugarti dopo un tuffo nel lago o per asciugare il sudore della giornata. È un piccolo comfort che fa tutta la differenza nella natura. Può essere posizionato ovunque nel mondo.",
		...
		grill = "Griglia",
		grill_description = "Un robusto barbecue progettato per l'avventuriero culinario. Che si tratti di rosolare bistecche o arrostire verdure, questo barbecue è il tuo affidabile compagno per creare festini alla luce del fuoco. Può essere posizionato ovunque nel mondo.",
		torch = "Torch",
		...
		police_barrier_description = "Questo non è solo un blocco stradale; è una linea nella sabbia. Per il controllo della folla, le scene del crimine, o quando hai semplicemente bisogno di un po' di spazio personale. Può essere posizionato ovunque nel mondo.",
		dummy = "Ciuccio",
		dummy_description = "Non è solo un bel viso. Usalo per fare pratica di tiro, o per completare il numero durante le noiose appostamenti. Può essere posizionato ovunque nel mondo.",
		target = "Target",
		...
		spike_strips_large_description = "Questo è per catturare i grossi pesci o quando hai bisogno di coprire più asfalto. È come stendere il tappeto rosso, tranne che non è per VIP, e buca le gomme. Può essere posizionato ovunque nel mondo.",
		...
		beach_chair_description = "Rilassati e goditi il sole con questa leggera sedia da spiaggia. Progettata per la comodità e la portabilità, è il tuo posto preferito per le sponde sabbiose e le oasi a bordo piscina. Può essere posizionato ovunque nel mondo.",
		...
		fishing_rod_description = "Realizzata per resistenza e precisione, questa canna da pesca è il compagno ideale in acqua. Il suo design bilanciato garantisce un'esperienza di lancio ottimale, adatta sia ai pescatori alle prime armi che a quelli più esperti.",
		...
		cooked_meat_description = "Grigliata alla perfezione, questa carne cotta cattura l'essenza della natura selvaggia. Ogni morso è pervaso dal sapore affumicato dell'aria aperta, offrendo un pasto soddisfacente dopo una caccia riuscita.",
		burnt_meat = "Carne bruciata",
		burnt_meat_description = "Rimasto troppo a lungo sulla griglia, questa carne si è bruciata in una forma meno desiderabile. Anche se è ancora commestibile, mangiare carne bruciata potrebbe lasciarti un retrogusto amaro e qualche disagio.",
		leather = "Cuoio",
		leather_description = "Questo resistente cuoio, ottenuto dalla pelle degli animali cacciati, vanta una texture robusta. Ideale per la lavorazione artigianale o per l'utilizzo in vari manufatti durevoli, è una risorsa preziosa per qualsiasi amante della natura o artigiano.",
		wood = "Legno",
		wood_description = "Questo mucchio di legna, proveniente da foreste locali gestite in modo sostenibile, offre sia calore che utilità. Ideale per la lavorazione, la costruzione o per alimentare i fuochi, è una risorsa essenziale per qualsiasi ambiente naturalistico o di sopravvivenza.",
		charcoal = "Carbonella",
		charcoal_description = "Prodotto bruciando legno su una griglia, questo carbone è un combustibile ad alta efficienza che migliora l'esperienza di grigliata. Brucia più caldo e pulito del legno grezzo, rendendolo perfetto per cucinare e prolungare il divertimento delle attività culinarie all'aperto.",
