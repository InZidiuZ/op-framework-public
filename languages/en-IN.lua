...
OP.Global.Locales.Languages["en-IN"] = {
	...
	shared = {
		...
		missing_or_invalid_input = "Input is missing or invalid.",
		player_not_found = "No player found with server ID `${serverId}`.",
	...
	emotes = {
		get_in_trunk = "Press ~INPUT_ENTER~ to get into the boot.",
		put_boombox_in_trunk = "Press ~INPUT_ENTER~ to keep the boombox in the boot.",
		put_bicycle_in_trunk = "Press ~INPUT_ENTER~ to place the bicycle inside the boot.",
		cant_put_bicycle_in_trunk = "This boot cannot accommodate a bicycle.",
		put_player_in_trunk = "Press ~INPUT_ENTER~ to place the player inside the boot.",
		put_player_in_seat = "[${VehicleEnterKey}] Seat the player",
		putting_player_in_seat = "Seating the player",
		trunk_interaction_display = "[${VehicleEnterKey}] Step Out [${InteractionKey}] Open/Close Boot",
		trunk_open_close_display = "[${InteractionKey}] Open/Close Boot",
		trunk_get_out_display = "[${VehicleEnterKey}] Step Out",
		boombox_already_in_trunk = "A boombox is already placed in the boot.",
		the_trunk_is_occupied = "The boot is currently occupied.",
		unable_to_toggle_carry = "Please wait a moment before toggling the carry.",
		carry_disabled_animal = "Animal Peds are not allowed to carry.",
		no_carry_nearby = "No one is nearby to carry.",
		cant_reach_carry = "You are unable to reach the closest person.",

		trunk_hint = "Use \"/door\" to open or close the boot while standing near it.",
		...
		you_are_not_being_carried = "You are not being carried at the moment.",
		successfully_uncarried = "Carry mode stopped successfully.",
		failed_uncarried = "Failed to stop carry mode.",

		uncarry_logs_title = "Carry Mode Stopped",
		uncarry_logs_details = "${consoleName} forced ${targetName} to stop carrying them.",

		failed_carry_npc = "Could not carry the NPC.",
		carry_npc_something_wrong = "An error occurred while trying to carry the NPC.",

		e_to_struggle = "Press E to Struggle",
		cant_struggle_dead = "You cannot struggle while unconscious.",
		struggle_to_quick = "You are too exhausted to struggle again right now. Wait for a moment and try again.",
		struggle_logs_title = "Broke Free",
		struggle_logs_details = "${consoleName} broke free from ${targetName} who was carrying them.",

		ragdolled_player = "Made ${displayName} fall to the ground."
	},
	...
	admin = {
		...
		spawned_item_details = "${consoleName} ने अपने लिए ${amount}x ${itemLabel} उत्पन्न किया।",
		spawned_item_for_player_title = "Spawned Item For Player",
		spawned_item_for_player_details = "${consoleName} ने ${targetConsoleName} के लिए ${amount}x ${itemLabel} उत्पन्न किया।",
		spawned_item_for_everyone_title = "Spawned Item For Everyone",
		spawned_item_for_everyone_details = "${consoleName} ने सभी के लिए ${amount}x ${itemLabel} उत्पन्न किया।",
		received_spawned_item_logs = "उत्पन्न आईटम प्राप्त किया",
		received_spawned_item_logs_details = "${targetConsoleName} को ${consoleName} से उत्पन्न आईटम (${amount}x ${itemLabel}) प्राप्त हुआ।",
		...
		snapshot_completed = "${amount} खिलाड़ियों का स्नैपशॉट आपकी क्लिपबोर्ड पर कॉपी किया गया।",
	...
	anti_cheat = {
		...
		clear_tasks_ban = "This is not a Jedi mind trick training centre. Your efforts to influence the free will of others has been noted... and rejected.",
		...
		illegal_event_usage_ban = "अस्तित्व का ताना-बाना एक क्षण के लिए कांपा - जैसे कि बुरी तरह से सिले हुए रजाई के किनारे उलझते हुए। लेकिन चिंता मत करो, हमने उस छोटे से विसंगति को ठीक कर दिया है... सुई को हटा कर।",
		...
		type_illegal_event_usage = "अवैध कार्यक्रम का उपयोग",
	...
	commands = {
		...
		snapshot_command = "स्नैपशॉट",
		snapshot_command_help = "आपके चारों ओर एक निश्चित रेंज में मौजूद सभी लोगों का स्नैपशॉट लें।",
		snapshot_command_parameter_radius = "रेडियस",
		snapshot_command_parameter_radius_help = "जिस रेडियस का स्नैपशॉट लेना है।",
		...
		-- game/boomboxes
		boomboxes_mute_command = "बूमबॉक्स म्यूट",
		boomboxes_mute_command_help = "बूमबॉक्स को म्यूट करें।",
		...
		cinemas_disable_command = "सिनेमा डिसेबल",
		cinemas_disable_command_help = "सिनेमाघर की स्क्रीन को बंद करें।",
		cinemas_disable_command_substitutes = "",

		cinemas_mute_command = "cinemas_mute",
		cinemas_mute_command_help = "Cinema screens ko mute karein.",
		...
		shuffle_inventory_command_help = "Ek specified inventory ko shuffle karein.",
		shuffle_inventory_command_parameter_inventory = "inventory",
		shuffle_inventory_command_parameter_inventory_help = "Jo inventory aap shuffle karna chahte hain.",
		shuffle_inventory_command_substitutes = "",

		dementia_mode_command = "dementia_mode",
		dementia_mode_command_help = "Aapke ya kisi dusre player ke liye dementia mode ko toggle karein.",
		dementia_mode_command_parameter_server_id = "server id",
		dementia_mode_command_parameter_server_id_help = "The server ID of the player for whom you want to toggle dementia.",
		...
		model_view_command_parameter_padding_help = "Additional distance padding.",
		...
		share_phone_number_command_help = "Shares your mobile number with everyone around you (< 1.5m).",
		...
		pool_debug_command_help = "टोगल करता है पूल (गेम) डिबग व्यू।",
		...
		spawn_prop_command_parameter_network_help = "क्या आप प्रॉप को नेटवर्क करना चाहेंगे? यह केवल उन प्रॉप्स के लिए सक्षम करने की सिफारिश की जाती है जो हिलने-डुलने में सक्षम होनी चाहिए। सभी प्रॉप्स को हिलाया नहीं जा सकता। (`1` सक्षम करने के लिए या `0`अक्षम करने के लिए)",
		spawn_prop_command_parameter_restricted = "restricted",
		spawn_prop_command_parameter_restricted_help = "इस प्रॉप को केवल सुपर एडमिन द्वारा उठाने की अनुमति दें। (`1` सक्षम करने के लिए या `0`अक्षम करने के लिए)",
		spawn_prop_command_parameter_culling = "culling",
		spawn_prop_command_parameter_culling_help = "कुलिंग रेडियस जिस पर प्रॉप स्पवन/डिस्पॉन किया जाता है। डिफ़ॉल्ट रेडियस 200 मीटर है, केवल बड़े प्रॉप्स के लिए इसे बढ़ाएं जो दूर से दिखाई देने चाहिए। (`0` या `false` का उपयोग करने के लिए डिफ़ॉल्ट)",
		spawn_prop_command_parameter_persistent = "स्थायी",
		spawn_prop_command_parameter_persistent_help = "क्या प्रॉप पुनरारंभ के दौरान बना रहेगा? इसका सीमित उपयोग करें क्योंकि यह सभी के गेम पर प्रभाव डालेगा। (`1` सक्षम करने के लिए या `0` निष्क्रिय करने के लिए)",
		...
		-- game/rockstar
		rockstar_editor_command = "रॉकस्टार_एडिटर",
		rockstar_editor_command_help = "रॉकस्टार एडिटर का उपयोग करने के लिए उपयोग में आसानी का आदेश।",
		rockstar_editor_command_parameter_action = "कार्य",
		rockstar_editor_command_parameter_action_help = "आप जिस कार्य को करने का प्रयास कर रहे हैं। कार्य हो सकता है `रिकॉर्ड`, `सहेजें`, `फेंक दें` या `खोलें`।",
		...
		smile_command = "smile",
		smile_command_help = ":)",
		smile_command_parameter_server_id = "सर्वर आईडी",
		smile_command_parameter_server_id_help = "लक्ष्य सर्वर आईडी।",
		...
		trains_debug_command_help = "सभी ट्रेनों का डिबग करें।",
		...
		define_points_command_help = "एक श्रृंखला के समन्वय/बिंदुओं को परिभाषित करें।",
		...
		draw_bus_route_command_help = "अपने GPS पर एक विशिष्ट बस मार्ग खींचें।",
		...
		license_give_command_parameter_license_help = "The licence you wish to give. You can list the available licenses using `/license_list`.",
		...
		license_remove_command_parameter_license_help = "The licence you wish to remove. You can list the available licenses using `/license_list`.",
	...
	users = {
		...
		user_does_not_have_sent_character_loaded = "The user does not have the sent character loaded.",
		user_has_no_character_loaded = "The user does not have any character loaded.",
		user_already_has_character_loaded = "User already has a character loaded.",
		user_not_found = "The sent user was not found on the server.",
		...
		custom_phone_number = "Custom mobile Number",
		reskin = "Reskin",
		...
		the_camera_has_been_updated = "The gameplay camera has been refreshed.",
		not_able_to_use_on_developer = "You are not allowed to use this route on developers.",
		the_spectator_camera_has_been_updated = "The spectator camera has been refreshed.",
	...
	airports = {
		...
		illegal = "Illegal",
		illegal_license_success = "Successfully hacked the FAA database, your licence is now valid for 5 days.",
		failed_illegal_license = "Failed to get illegal licence.",
	...
	animals = {
		...
		description_pigeon_unnamed = "A ${gender} pigeon, ${age} years old and weighing ${weight}, soaring through life with an effortless charm. With an undying passion for ${food}, this winged wanderer flits between rooftops and pavements, always in search of the next great meal—or perhaps a philosophical moment atop a lamppost.",
		description_pigeon_named = "${name}, the ${gender} pigeon, ${age} years into this sky-bound tale, weighs ${weight} and carries an unshakable love for ${food}. Whether gracefully gliding through city streets or strutting with quiet confidence, ${name} is a feathered enigma, equal parts urban survivor and poet of the skies.",
		...
		description_seagull_named = "${name}, the ${gender} seagull, ${age} years into this salty, sunlit adventure, weighing ${weight} and ruled by an insatiable hunger for ${food}. With wings built for the open skies and an eye for the perfect spot to scavenge, ${name} is a relentless explorer of tides, winds, and forgotten sandwich crusts.",

		description_crow_unnamed = "A ${gender} crow, ${age} years old and weighing ${weight}, a shadow in the sky with intelligence as sharp as its beak. Drawn to the mystery of ${food}, this enigmatic trickster observes, learns, and acts with an eerie precision, weaving through life like a living riddle.",
		description_crow_named = "${name}, the ${gender} crow, ${age} years into the vast narrative of the wild, weighing ${weight} and driven by a fascination with ${food}. Every glint in ${name}'s eyes hides a secret, every call is a whisper of untold stories, proving that some of the wisest souls have feathers instead of words.",

		feed = "[${InteractionKey}] खिला रहे हैं",
	...
	attachments = {
		...
		attachments_logs_details = "${consoleName} ने अपने ${itemLabel} में संशोधन किए: ${modifications}.",
	...
	battle_royale = {
		...
		picked_up_item_logs = "BR आइटम उठाया",
		picked_up_item_logs_details = "${consoleName} ने एक Battle Royale मैच के दौरान एक ${itemLabel} उठाया."
	},
	...
	brochure = {
		...
		getting_started_2 = "If you don't fancy driving you can also walk, get a friend to pick you up or call a taxi using your mobile. You can access your mobile by flexing your \"P\" muscle.",
		getting_started_3 = "Most vehicles have trunks which you can put not only items but also other people in. You can /carry someone, then walk up to a boot, open it (/door) and put them in. The same way you can also get them back out. If you've flipped your vehicle you can /flip it back onto its wheels.",
		...
		where_now_2 = "Once you've stocked up on supplies, you should head to the courthouse and pickup a citizen card. This will act as your ID, drivers licence and weapons licence.",
		...
		getting_a_job_2 = "The trucker job requires you to deliver goods to various locations. You have to first purchase a lorry from the trucker hq for $2,000.",
		...
		getting_a_job_4 = "You can also become a waste collector. At the waste collector hq you can pickup a garbage lorry and start collecting trash.",
	...
	cinema = {
		...
		already_have_a_key = "पहले ही एक कुंजी है:",
		already_have_a_key_1 = "अगर आपके पास पहले से एक कुंजी है जिसका आप इस्तेमाल करना चाहते हैं, तो आप इसे यहाँ डाल सकते हैं.",
		already_have_a_key_2 = "यह उपयोगी है अगर आप चाहते हैं कि दो टीवी एक ही स्ट्रीम दिखाएं.",
		already_have_a_key_3 = "Please note, this will significantly increase bandwidth usage.",
		already_have_a_key_4 = "It will cause lag if you do too many.",

		cinemas_disabled = "Cinemas have been disabled.",
		cinemas_enabled = "Cinemas have been enabled.",
		cinemas_muted = "Cinemas have been muted.",
		cinemas_unmuted = "Cinemas have been unmuted."
	},
	...
	crafting = {
		...
		deconstruct_phone = "Deconstruct mobile",
		press_deconstruct_phone = "[${SeatEjectKey}] Deconstruct mobile",
		failed_deconstruct_phone = "Failed to deconstruct mobile.",
	...
	daily_activities = {
		...
		buy_weazel_news = "Purchase a Weazel News edition.",
	...
	elevators = {
		...
		out_of_service_help = "This lift is currently out of service.",
	...
	gun_trader = {
		...
		slogan_4 = "A gun in the hand is better than a cop on the mobile.",
	...
	halloween = {
		...
		answer_the_phone = "Answer the mobile.",
	...
	hud = {
		...
		toggle_phone_gps_off = "Toggled the mobile gps off.",
		toggle_phone_gps_on = "Toggled the mobile gps on.",
	...
	identification = {
		...
		bar_license = "Bar/Law Licence",
		bar_license_details = "Bar/Law Licence | ${firstName} ${lastName} | Citizen ID: ${characterId}",
	...
	inventory = {
		...
		gas_station_backdoor = "Petrol Pump Backdoor",
		...
		shredded_logs_details = "${consoleName} has shredded: ${shredded}.",
		...
		shuffle_inventory_failed = "इंवेंटरी को शफल करने में विफल।",

		failed_toggle_dementia = "डिमेंशिया को टॉगल करने में विफल।",
		toggled_dementia_on = "${displayName} के लिए डिमेंशिया चालू कर दिया।",
		toggled_dementia_off = "${displayName} के लिए डिमेंशिया बंद कर दिया।",
		...
		irish_pub_counter = "आइरिश पब काउंटर",
		vanilla_unicorn_counter = "वेनिला यूनिकॉर्न काउंटर",
		...
		citizen_card = "Citizen Card",
		citizen_card_description = "Acts as identification, a firearm licence and driving licence.",
		driver_license = "Driver's Licence",
		...
		tablet = "Tablet",
		tablet_description = "Very big mobile.",
		wallet = "Wallet",
		...
		weapon_license = "Weapons Licence",
		weapon_license_description = "A weapons licence for posessing and carrying higher class weaponry.",
		mining_license = "Mining Licence",
		...
		cleaning_kit_description = "Perfect to clean your vehicle, or the blood stains you've been letting dry in the back of your boot.",
		...
		deck_ems_description = "Pay homage to emergency responders with the Red Line Deck. Ideal for EMS personnel who want to skate with pride and honour their heroic work.",
		...
		raw_ruby = "Raw Ruby",
		raw_ruby_description = "Rich and deep in colour, this raw ruby holds fierce beauty within its rugged exterior. A gem that symbolizes passion and power, it awaits transformation into a piece that truly commands attention.",
		...
		sapphire_dust_description = "An exquisite blue powder created by grinding high-quality sapphires into a fine dust. The mesmerizing, deep blue colour of this pigment is reminiscent of clear skies and majestic oceans, making it an ideal choice for projects that demand a regal and sophisticated touch. When paired with other colors that evoke the spirit of a certain star-spangled banner, the result is truly breathtaking.",
		...
		sapphire = "Sapphire",
		sapphire_description = "A symbol of wisdom and nobility, this polished sapphire dazzles with its royal blue brilliance. Its hardiness and luster make it a favourite for both everyday wear and ceremonial attire.",
		emerald = "Emerald",
		emerald_description = "Polished to reveal a vibrant green that rivals spring's vitality, this emerald is a testament to nature's splendor. Cherished for its rich colour and clarity, it’s a staple in any gem collection.",
		opal = "Opal",
		...
		bacon_burger_description = "A classic favourite, this bacon cheeseburger combines juicy, grilled beef with crisp bacon and melted cheese. Each bite delivers a perfect blend of savory flavors, making it a timeless choice for burger enthusiasts.",
		...
		bell_pepper_description = "Vibrant and sweet, this whole red bell pepper adds a pop of colour and a crunch to any dish. Perfect for stuffing, slicing, or snacking, it's a versatile kitchen favourite.",
		...
		pizza_margherita_description = "Indulge in the simplicity of a classic Margherita pizza, with a golden crust topped with rich tomato sauce, creamy mozzarella, and a hint of fresh basil. This timeless favourite delivers a taste of Italy with every savory slice.",
		...
		pizza_pepperoni_description = "A hot twist on a classic favourite! This spicy pepperoni pizza is baked to perfection, featuring crispy crust, molten cheese, and pepperoni with a fiery kick. Not for the faint of heart, this pizza brings the heat!",
		...
		lemon = "Lemon",
		lemon_description = "A vibrant and zesty lemon, bursting with tangy flavor and a bright yellow hue. Perfect for adding a refreshing twist to your favourite dishes and drinks. Each bite delivers a citrusy punch that wakes up your taste buds.",
		...
		blood_test_kit = "ब्लड टेस्ट किट",
		blood_test_kit_description = "एक सुविधाजनक ब्लड टेस्ट किट जो आपके नसों में क्या बह रहा है, यह जानने में मदद करती है। कुछ बूँदों और थोड़े धैर्य के साथ, आप अपने रक्त समूह का रहस्य जान सकते हैं - चिकित्सा तैयारी के लिए या अजीब क्विज़ प्रतियोगिताएं जीतने के लिए एकदम सही।",
		...
		mini_police = "नन्हा पुलिस कार",
		mini_police_description = "एक छोटे आकार का कानून प्रवर्तन वाहन जो हाथों-हाथ प्रशिक्षण के लिए डिज़ाइन किया गया है। यह उच्च जोखिम वाले परिदृश्यों में सही स्थिति, दृष्टिकोण कोण और सामरिक चालों को सिखाने के लिए उपयोग किया जाता है। यह भले ही छोटा हो, लेकिन यह अधिकारियों को असली स्थिति के लिए तैयार करने में एक बड़ा भूमिका निभाता है।",
		mini_car = "नन्हा नागरिक कार",
		mini_car_description = "एक मानक नागरिक वाहन का छोटे पैमाने का प्रतिकृति, प्रशिक्षण परिदृश्यों और सामरिक प्रदर्शनों के लिए उपयुक्त। चाहे आप ट्रैफिक स्टॉप, सड़क अवरोध या पीछा करने की तकनीक का अभ्यास कर रहे हों, यह छोटी कार अधिकारियों को अपने कदमों की योजना बनाने में मदद करती है—बिना किसी वास्तविक टकराव के जोखिम के।",
		...
		pigeon_0 = "Pigeon",
		pigeon_0_description = "A street-smart pigeon with dubious morals and an unshakeable love for crumbs. Rescued from the wild, this feathered freeloader will accompany you wherever you go, silently judging your life choices while scheming its next snack heist.",

		seagull_0 = "Seagull",
		seagull_0_description = "A loud, audacious seagull with a knack for stealing and zero respect for personal space. Whether it’s eyeing your food, squawking aimlessly, or just chilling on your shoulder, this feathery nuisance is always up to no good.",

		crow_0 = "Crow",
		crow_0_description = "A highly intelligent crow known for its curious interest in shiny objects and observing human behavior. Whether it's up to some scheming or just picking up small trinkets, this clever bird is always several steps ahead.",
		...
		rusty_tank_shell_description = "This here rusty ol' tank shell's been through more dirt 'n' grime than a redneck's pickup lorry! Dug up from the bowels of history, it’s a good ol' piece of the past, y'all. Perfect for sittin' on the porch and spinnin' war stories with the boys!",
		...
		dab_pen = "Penjamin",
		dab_pen_description = "Yo, this Penjamin? Hits like a lorry, dude. Three solid blinks, and you're gone. Once it flashes, it’s game over. No refills, just ride the high while you can.",
		...
		studio_light_description = "A professional-grade studio light that transforms any space into a beautifully lit masterpiece. Whether you're capturing the ideal shot, filming an intense scene, or just wanting to look far better than reality, this powerful light makes sure you're always in the limelight.",
		yoga_mat = "Yoga Mat",
		...
		parasol = "Parasol",
		parasol_description = "Shade yourself from the sun's rays with this colorful parasol. A delightful accessory for sunny days, it provides instant relief from the heat while adding a splash of colour to your setup. Can be placed anywhere in the world.",
		...
		pigeon_statue_description = "A quirky, slightly unsettling pigeon statue that seems to have misplaced its head. Whether it’s modern art, a factory defect, or some kind of cursed relic, one thing’s for sure—this bird isn’t going anywhere.",
		wheel = "Spare Wheel",
		...
		chili = "Chili Peppers",
		chili_description = "These fiery little peppers pack a punch! Whether you're adding a bit of zing to your salsa or turning up the heat in your favourite dish, these vibrant chilis are your go-to for a spicy kick. Handle with care unless you want your fingers to tingle and your taste buds to dance!",
		...
		spring_onions_cut_description = "These freshly cut spring onions are all set to enhance your culinary creations. Perfect for garnishing or blending into dishes, their bright, peppery notes add both flavor and a pop of colour, making every meal both tastier and more visually appealing.",
		tofu = "Tofu",
		tofu_description = "This versatile block of tofu is a staple for healthy and creative cooking. Made from soybeans, it's a mild-flavored favourite that absorbs flavors wonderfully, making it perfect for everything from stir-fries to smoothies.",
		...
		uncooked_ramen_description = "Your DIY ramen kit, ready for you to transform into a steaming bowl of deliciousness. Just add hot water and your favourite toppings, and you'll have a quick and tasty meal in no time!",
		ramen = "Ramen",
		ramen_description = "A bowl of pure comfort, packed with noodles, savory broth, and all your favourite toppings. Whether you're slurping at home or on the go, this ramen is a hug in a bowl.",
		...
		mochi_mango_description = "A tropical mango mochi bursting with the sweet, juicy flavor of ripe mangoes. Wrapped in a soft, sticky shell, it’s a mini holiday for your taste buds.",
	...
	items = {
		...
		changing_license_plate = "Changing licence Plate",
	...
	miscellaneous = {
		...
		bad_phone_message = "Attempted to create a possibly inappropriate phone message: \"${message}\"",
	...
	overview = {
		...
		minigame_colors_text = "Change the colors of certain minigames to make items more visible and easier to spot. This may not apply to all minigames, but it works for a select few.",
	...
	oxy = {
		...
		accidental_call_6_part_2 = "Your dad's on the mobile bro, your dad's on the mobile.",
		...
		start_5_part_6 = "So I'ma send you the thing on the mobile bro, Love for that.",
		...
		start_6_part_5 = "The oxy, yeah yeah, of course you do. Ay, basically I'm gonna send you the thing on the mobile.",
		...
		start_last_fail_part_4 = "Ay, basically I'm gonna send you the thing on the mobile.",
		...
		start_on_timer_8_part_7 = "The mobile just pinged aswell bro, you're finished bro! I got someone else on this thing bro.",
		...
		still_pressing_e_1_part_2 = "Stop comin' back to the spot bro. Bro I sent you the ping, check your mobile my guy.",
		...
		still_pressing_e_2_part_3 = "Check that mobile bro, fuck off bro!",
		...
		tutorial_1_part_9 = "Yeah I'ma send you the details on the mobile though so just check your GPS and all of that bro I got you bro..",
		...
		tutorial_2_part_7 = "Yeah I'ma send you the details on the mobile though, so just check your GPS and all of that bro, I got you bro.",
	...
	panel = {
		...
		no_permissions = "You do not have permission to view the regular admin panel.",
		panel_unavailable = "The regular admin panel is currently unavailable.",
	...
	phone_numbers = {
		...
		invalid_format = "The set mobile number was of invalid format.",
		invalid_length = "The set mobile number was of invalid length.",
		...
		phone_number_taken = "The mobile number `${phoneNumber}` is taken.",
		...
		phone_number_is_available = "The mobile number `${phoneNumber}` is available.",
		phone_number_is_not_available = "The mobile number `${phoneNumber}` is not available.",

		no_phone = "You don't have a mobile.",
		nobody_nearby = "Nobody close enough to share your number with.",
		shared_number = "${fullName} shared their mobile number with you. Use /yes to accept it and create a new contact or /no to decline.",
		shared_number_expired = "The number share request has expired.",
		shared_number_declined = "You declined the number share request.",
		failed_to_share = "Failed to share your mobile number.",
		number_share_timeout = "You just shared your mobile number. Please wait a moment before trying again.",
		phone_number_shared = "Successfully shared your mobile number with ${nearby} nearby player(s)."
	},
	...
	rockstar = {
		...
		keybind_record = "RE: Recording shuru karo",
		keybind_save = "RE: Recorded clip ko save karo",
		keybind_discard = "RE: Recorded clip ko discard karo",
		keybind_open = "RE: Editor kholne ke liye",

		record = "Recording shuru karta hai.",
		save = "Recording ko rokti hai aur recorded clip ko save karti hai.",
		discard = "Recording ko rokti hai aur recorded clip ko discard karti hai.",
		open = "Rockstar editor kholta hai (aur aapko disconnect kar deta hai)."
	},
	...
	screenshots = {
		...
		screenshot_failed = "Screenshot lene me kuch galat hua.",
	...
	smile = {
		failed_smile = "Kuch galat ho gaya hai.",
		smile_success = "Successfully triggered smile for ${displayName}.",

		smile_logs_title = "Triggered Smile",
		smile_logs_details = "${consoleName} ne ${targetName} ke liye smile trigger kiya."
	},
	...
	staff_pm = {
		...
		sent_important_pm = "${displayName} ko mahatvapurn staff PM bheja.",
	...
	teleporters = {
		...
		enter_phone_tower = "Enter Mobile Tower",
		enter_phone_tower_interact = "[${InteractionKey}] Enter Mobile Tower",

		exit_phone_tower = "Exit Mobile Tower",
		exit_phone_tower_interact = "[${InteractionKey}] Exit Mobile Tower"
	},
	...
	test_server = {
		...
		settings = "Settings",
		settings_description = "Testing menu ke liye vibhinn settings ko adjust karein.",
		phasing = "Phasing",
		phasing_description = "Nasdik ke gaadiyon ke beech se guzarne ke liye vehicle phasing ko enable ya disable karein.",
		infinite_ammo = "Anant Ammo",
		infinite_ammo_description = "अनलिमिटेड गोला-बारूद बिना स्टॉक किए, लेकिन फिर भी रीलोड करना आवश्यक है।",
		fixed_time = "स्थिर समय",
		fixed_time_description = "समय को सुबह, दोपहर, शाम, या मध्यरात्रि में लॉक करें, केवल आप पर असर डालता है।",
		always_morning = "सुबह",
		always_noon = "दोपहर",
		always_evening = "शाम",
		always_night = "मध्यरात्रि",

		vehicles = "Vehicle Options",
		vehicles_description = "आपके वर्तमान वाहन में संशोधन और इंटरैक्ट करें।",
		spawn_car = "Spawn Car",
		spawn_car_description = "पूर्व-निर्धारित चयन से एक वाहन उत्पन्न करें।",
		upgrade_vehicle = "Upgrade Vehicle",
		upgrade_vehicle_description = "अपने वाहन के प्रदर्शन को अपग्रेड के साथ सुधारें।",
		break_windows = "Break Windows",
		break_windows_description = "Break all windows of your current vehicle.",
		pop_tires = "Pop Tires",
		pop_tires_description = "Deflate all tyres of your current vehicle.",
		detach_doors = "Detach Doors",
		detach_doors_description = "Completely remove all doors of your vehicle.",
		damage_vehicle = "Damage Vehicle",
		damage_vehicle_description = "Deal damage to your vehicle until the engine starts smoking.",
		repair_vehicle = "Repair Vehicle",
		repair_vehicle_description = "Fully restore your vehicle to top condition.",
		delete_vehicle = "Delete Vehicle",
		delete_vehicle_description = "Remove your current vehicle completely.",
		...
		teleport_to = "TP To",
		teleport_to_description = "Choose a destination from the available teleport locations.",
		...
		actions = "Actions",
		actions_description = "Execute various actions related to players.",
		jail_self = "Jail Yourself",
		jail_self_description = "Send yourself to jail immediately.",
		unjail_self = "Unjail Yourself",
		unjail_self_description = "Free yourself from jail immediately.",
		wander_around = "Wander Around",
		wander_around_description = "Make your character move aimlessly on foot or in a vehicle.",
		speed_around = "Speed Around",
		speed_around_description = "Drive dangerously at high speeds while ignoring traffic regulations.",
		clear_tasks = "Clear Tasks",
		clear_tasks_description = "Clear all actions and tasks assigned to your character.",
	...
	trains = {
		debug_enabled = "Train debugging enabled.",
		debug_disabled = "Train debugging disabled.",
	...
	tuner_shop = {
		no_vehicle = "No vehicle at this location.",
		near_label = "${label} | ₹$${price}",
		purchase_label = "[${SeatEjectKey}] Purchase ${label} for $${price}",
		purchase_label_timer = "[${timer}] Buy ${label} for ₹$${price}",
		purchased_vehicle = "Successfully bought ${label}.",
		failed_vehicle_spawn = "Vehicle spawn failed. The vehicle will still be accessible from your garage.",
		...
		purchase_active = "Someone is already in the process of purchasing a vehicle, please wait for a moment.",
	...
	voice = {
		...
		set_player_radio_frequency_successfully = "Player radio frequency set successfully.",
	...
	wizard = {
		...
		play_sound_phone_call = "Mobile Call",
	...
	medical = {
		...
		using_test_other = "Testing Nearby Player's Blood",
		failed_blood_test = "Failed to conduct blood test.",
		waiting_results = "Waiting for Test Results",
		failed_test_results = "Test results couldn't be retrieved.",
	...
	state = {
		...
		gave_license_logs = "Granted License",
		gave_license_details = "${consoleName} granted character #${characterId} the `${license}` license.",
		removed_license_logs = "Revoked License",
		removed_license_details = "${consoleName} revoked the `${license}` license from character #${characterId}.",
	...
	tasks = {
		...
		task_take_out_trash = "Empty out dustbin.",
		task_take_out_trash_near = "Press ~INPUT_DETONATE~ to empty out the dustbin.",
		task_take_out_trash_active = "Emptying dustbin",
	...
	car_wash = {
		...
		air_unit_purchase_cleaning_kit = "Press ~g~${+inventory_toggle} ~w~to buy a Cleaning Kit.",
	...
	fuel = {
		...
		purchase_jerry_can = "Press ~g~${+inventory_toggle} ~w~to buy a Jerry Can.",
		gas_station = "Petrol Pump",
	...
	redline = {
		engine_blowout = "Your engine has blown due to excessive stress."
	},
	...
	alpha = {
		...
		thanks_for_loot = "You were robbed while unconscious. Some items might be missing. Rumour has it was Nancy.",
