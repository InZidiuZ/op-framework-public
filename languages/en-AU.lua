...
OP.Global.Locales.Languages["en-AU"] = {
	...
	emotes = {
		...
		put_bicycle_in_trunk = "Press ~INPUT_ENTER~ to chuck the bike in the boot.",
		cant_put_bicycle_in_trunk = "You can't stash the bike in this boot.",
	...
	ledges = {
		no_ledge = "You're not close to a ledge.",
	...
	admin = {
		...
		can_not_trigger_remotely_without_staff = "You need to be staff to trigger this command remotely.",
		...
		repaired_player_vehicle_logs_details = "${consoleName} fixed the vehicle ${targetConsoleName} was in.",
		...
		no_serial_number = "Can't register a weapon without a serial number.",
		unknown_character_id = "Unfamiliar character ID.",
	...
	anti_cheat = {
		...
		handling_field_ban = "Seems like you tried to give the laws of physics a bit of a boost. Good try, but in this world, we like to keep our wheels firmly planted in reality.",
		teleported_ban = "Blink and you’re gone? Not in this dimension, traveller.",
	...
	bans = {
		...
		you_stopped_streaming = "You stopped livestreaming."
	},
	...
	commands = {
		...
		chair_offset_command_help = "Determine the offset of a nearby chair of a specific model.",
		chair_offset_command_parameter_model_name = "model name",
		chair_offset_command_parameter_model_name_help = "The model name of the chair to determine the offset of.",
		...
		set_metadata_command_parameter_key_help = "The metadata key ya wanna set.",
		set_metadata_command_parameter_value = "value",
		set_metadata_command_parameter_value_help = "The metadata value ya wanna set. (Empty to delete a key)",
		...
		ridealong_command = "tagalong",
		ridealong_command_help = "Toggles if you are able to hop in NPC's vehicles.",
		ridealong_command_substitutes = "",

		kill_ped_command = "carkill",
		kill_ped_command_help = "Takes out the bloke with the given network id.",
		kill_ped_command_parameter_network_id = "network id",
		kill_ped_command_parameter_network_id_help = "The network id of the bloke to bring down.",
		...
		-- base/points
		points_command = "score",
		points_command_help = "Display the amount of OP Points you've got.",
		points_command_substitutes = "",

		use_points_command = "spend_points",
		use_points_command_help = "Cash in points. This is used when a server offers special perks they charge for manually. Only use if directed as it will deduct your points without a second thought!",
		use_points_command_parameter_amount = "amount",
		use_points_command_parameter_amount_help = "The amount of points the server should try to take from you.",
		...
		report_command_parameter_message_help = "The message you'd like to send. A brief summary of what you're reporting (e.g., \"I just got RDMed, their ID was...\").",
		...
		registration_lookup_command_help = "Look-up an aircraft's registration.",
		registration_lookup_command_parameter_registration = "registration",
		registration_lookup_command_parameter_registration_help = "The aircraft's registration (e.g. VH-OQF).",
		registration_lookup_command_substitutes = "rego",
		...
		animal_sound_command_help = "Play an animal noise.",
		...
		battle_royale_toggle_command_parameter_max_teammates = "max mates",
		battle_royale_toggle_command_parameter_max_teammates_help = "The maximum amount of allowed teammates per team. Default is 4. Minimum is 1 and maximum is 10.",
		...
		containers_command_help = "Check out and manage your rented storage containers.",
		containers_command_substitutes = "storage facilities",
		...
		-- game/debug
		debug_command = "debug",
		debug_command_help = "Turn the debugger on or off. This will display basic info about you and the world and show entities you are looking at.",
		debug_command_parameter_minimal = "minimal",
		debug_command_parameter_minimal_help = "Only show basic info (reduces native calls).",
		debug_command_substitutes = "",

		entity_debug_command = "entity_debug",
		entity_debug_command_help = "Toggle the entity debugger. This will display basic info about the entity you are examining.",
		...
		random_position_command_parameter_server_id_help = "The server ID of the player you want to transport.",
		...
		find_native_toggles_command_help = "This will help you find potential 'toggle' natives for certain behaviour by checking a bunch of natives every tick. It will log whenever some of these change.",
		find_native_toggles_command_parameter_extreme = "extreme",
		find_native_toggles_command_parameter_extreme_help = "Also include all unknown natives that have no parameters.",
		...
		effect_zones_debug_command_help = "Debug what effect zones ya currently in.",
		...
		callsign_command_parameter_callsign_help = "Your callsign or blank to reset.",
		...
		fortune_cookie_command_help = "Spawn a fortune cookie with a set message.",
		fortune_cookie_command_parameter_fortune = "fortune",
		fortune_cookie_command_parameter_fortune_help = "The message you want on the fortune.",
		...
		cpr_command = "cpr",
		cpr_command_help = "Administer CPR on the nearest NPC or player.",
		...
		indestructibility_command_parameter_server_id_help = "If you're wanting to toggle someone else's indestructibility, insert their server id here.",
		...
		dementia_mode_command_help = "Toggle dementia mode for yourself or another player.",
		...
		check_jail_command_help = "Determine how much time a player has left in the slammer.",
		...
		modify_jail_command_help = "Adjust a player's time in jail.",
		...
		modify_jail_parameter_amount_help = "The amount of time you want to add or remove in minutes. Can't be more than 5 minutes at a time.",
		...
		fake_lag_command_parameter_spike_help = "Randomly slow down your frames per second (sorry).",
		...
		create_magazine_command_help = "Spawn a magazine of a certain issue of a certain series.",
		...
		create_magazine_command_parameter_issue_id_help = "The issue number you want to spawn.",
		...
		skip_minigames_command_help = "Switch skipping of minigames.",
		...
		power_generators_disable_command_help = "Deactivate all Pacific Bank power generators. This is the same as successfully deactivating each one that wasn't already deactivated.",
		...
		rock_paper_scissors_command_parameter_what_help = "What you wanna play. Valid values are `rock`, `paper` and `scissors`. (Random if left blank)",
		...
		ped_spawn_command_parameter_invincible_help = "If the ped should be unbreakable. (default: no).",
		...
		ped_attack_command_help = "Makes the closest bloke attack a certain player.",
		ped_attack_command_parameter_target = "target",
		ped_attack_command_parameter_target_help = "The player you want the closest bloke to attack.",
		...
		share_phone_number_command_help = "Shares your mobile number with everyone around ya (< 1.5m).",
		...
		spawn_prop_command_parameter_culling_help = "Culling radius at which distance the prop is spawned/despawned. Default radius is 200m, only increase this for large props that should be visible from a distance. (`0` or `false` to use default)",
		...
		weather_command_parameter_weather_help = "The name of the weather you want to set. Valid weather names are EXTRASUNNY, CLEAR, CLOUDS, SMOG, FOGGY, OVERCAST, RAIN, THUNDER, CLEARING, NEUTRAL, SNOW, BLIZZARD, SNOWLIGHT, XMAS, HALLOWEEN, RAIN_HALLOWEEN, and SNOW_HALLOWEEN.",
		...
		tp_to_player_command_parameter_server_id_help = "The server id of the player you wish to teleport to.",
		...
		tracker_command_parameter_break_help = "Break your tracker and send a dispatch notification about it. Type `yes` or `y` to break your tracker. (Can't be re-enabled until 20min have passed)",
		...
		taze_player_command_help = "Tases a player.",
		...
		taze_player_command_substitutes = "stun, zap",
		...
		start_bus_route_command_help = "Begin a specific bus route.",
		start_bus_route_command_parameter_route = "route",
		start_bus_route_command_parameter_route_help = "The name of the route you wish to commence.",
		...
		draw_bus_route_command_parameter_route_help = "The name of the route you wish to draw.",
		draw_bus_route_command_substitutes = "",

		-- jobs/dealership
		set_pdm_slot_command = "set_pdm_slot",
		set_pdm_slot_command_help = "Set the vehicle in the specified slot at PDM.",
		set_pdm_slot_command_parameter_slot = "slot",
		set_pdm_slot_command_parameter_slot_help = "The slot you wish to set the vehicle in. (1 - 8)",
		set_pdm_slot_command_parameter_model_name = "model name",
		set_pdm_slot_command_parameter_model_name_help = "The model name of the vehicle you wish to set.",
		...
		create_vehicle_hold_command_help = "Creates a vehicle hold. This will Police impound the vehicle for an extended period of time. (Note: Any already withdrawn vehicles will continue to exist)",
		...
		create_vehicle_hold_command_parameter_plate_help = "The number plate of the vehicle.",
		...
		remove_clothing_command_parameter_type_help = "The type of clothing you want to remove. Can be `mask`, `sunnies`, `cap` or `gloves`.",
		...
		job_command_help = "Update someone's job based on a shortcut or toggle the job UI.",
		...
		set_fuel_command_parameter_server_id_help = "If you want to set the fuel for another bloke. Leaving this blank will auto-select yourself.",
		...
		garage_vehicle_command_parameter_repair_help = "Whether the vehicle should be repaired before being stored.",
		...
		remove_garage_command_parameter_garage_id_help = "The ID of the temporary garage you'd like to remove.",
		...
		give_key_command_parameter_server_id_help = "The bloke's server ID you would like to give the key to. This can be left blank (or at 0) to give it to the nearest bloke.",
		...
		wheel_offset_command_parameter_value_help = "The amount you would like it to be modified. This can be anywhere from -0.25 to 0.2, with 0 being the default.",
		...
		suspension_height_command_parameter_value_help = "The amount you would like it to be modified. This can be anywhere from -0.2 to 0.1, with 0 being the default.",
		...
		reset_plate_command_help = "Reset your vehicle's plate (if it has a custom plate that does not match the regular format).",
		...
		-- vehicles/vehicles
		flip_command = "flip",
		flip_command_help = "Roll over a flipped vehicle or shopping trolley.",
		...
		wipe_throwables_command_help = "Clears all chucked weapons within the specified radius.",
		wipe_throwables_command_parameter_radius = "radius",
		wipe_throwables_command_parameter_radius_help = "The radius to clear chucked weapons in (default: 5).",
	...
	steam = {
		no_steam_allowed = "Before joining, you must completely close Steam and then start FiveM."
	},
	...
	users = {
		...
		user_does_not_have_character = "The user does not have a character with the provided character ID.",
		...
		the_command_has_been_run = "The command has been executed.",
	...
	vpn = {
		vpn_not_allowed_for_new_players = "The use of a VPN is not allowed for players with less than 24 hours of gameplay."
	},
	...
	admin_features = {
		...
		brighter_nights_feature = "Thicc nights",
		ridealong_feature = "Ridealong",
		broadcast_all_feature = "Broadcast To Everyone",
	...
	airports = {
		...
		illegal = "Dodgey",
		illegal_license_success = "Successfully dodged the coppers, your license is now valid for 5 days.",
		failed_illegal_license = "Failed to get dodgy licence.",
		spawned_vehicle = "Spawned vehicle.",
		spawned_vehicle_large = "Spawned massive vehicle. A marker to it has been set on your map.",
		...
		vehicle_no_free_seat = "No spare seats available on this vehicle.",
		press_to_enter_aircraft = "Press ~INPUT_ENTER~ to hop on the aircraft.",
		no_aircraft_to_enter = "No aircraft available to hop on.",
		helipad = "Heliport",
		looking_up = "Checking Out Registration",
		registration_not_found = "The rego couldn't be found.",
		registration_lookup = "Aircraft registration number `${registration}` was last borrowed by ${fullName} #${characterId}.",
	...
	animals = {
		...
		not_enough_space = "You don't have enough room to pick up this animal.",
		...
		description_cat_unnamed = "A ${gender} feline wandering through life with an air of mystery, ${age} old and weighing ${weight}. With an insatiable weakness for ${food}, this whiskered wanderer could be plotting world domination one moment and curl up for a kip the next. Every whisker tells a yarn, every glance holds a secret.",
		description_cat_named = "${name}, the ${gender} cat, is a ${age} old mate who carries the wisdom of countless sunlit naps and midnight escapades. Weighing ${weight} and with a deep love for ${food}, ${name} moves through the world like a living enigma—part noble diplomat, part cunning street philosopher.",

		description_dog_unnamed = "A ${gender} doggo, ${age} old and weighing ${weight}, with a spirit as vast as the horizon. Completely dedicated to ${food} and with a heart full of unrestrained enthusiasm, this fluffy mate turns every moment into a possible adventure, every stroll into an epic journey.",
		description_dog_named = "${name}, the ${gender} dog, ${age} into this grand tale of companionship, weighing ${weight} and radiating an energy that could light up the darkest room. Completely enamoured with ${food}, ${name} lives by a simple creed: every day is a gift, every mate a treasure, every moment an opportunity for joy.",
		...
		description_hen_unnamed = "A ${gender} hen, ${age} old and strutting at ${weight}, who moves with the confidence of a farmyard philosopher. Fueled by an unexpected craving for ${food}, this feathered mate transforms ordinary moments into epic narratives of poultry prowess.",
		description_hen_named = "${name}, the ${gender} chook, ${age} wise and weighing ${weight}, clucks with the authority of a seasoned storyteller. Obsessed with ${food} and masters of the unexpected, ${name} proves that true charisma knows no species.",
		...
		description_pigeon_unnamed = "A ${gender} pigeon, ${age} years old and weighing ${weight}, soaring through life with an effortless charm. With an undying passion for ${food}, this winged wanderer flits between rooftops and footpaths, always in search of the next great meal—or perhaps a philosophical moment atop a lamp post.",
		description_pigeon_named = "${name}, the ${gender} pigeon, ${age} in this sky-bound tale, weighs ${weight} and carries an unshakable love for ${food}. Whether gracefully gliding through city streets or strutting with quiet confidence, ${name} is a feathered enigma, equal parts urban survivor and poet of the skies.",

		description_seagull_unnamed = "A ${gender} seagull, ${age} years old and weighing ${weight}, a true master of the coast and conqueror of snacks. Whether calling out over crashing waves or locked in an epic struggle for ${food}, this feathered opportunist thrives where sky meets sea, forever chasing the next great feast.",
		description_seagull_named = "${name}, the ${gender} seagull, ${age} into this salty, sunlit adventure, weighing ${weight} and driven by an insatiable hunger for ${food}. With wings built for the open sky and an eye for the perfect scavenging spot, ${name} is a relentless explorer of tides, winds, and forgotten sandwich crusts.",

		description_crow_unnamed = "A ${gender} crow, ${age} years old and weighing ${weight}, a shadow in the sky with intelligence as sharp as its beak. Drawn to the mystery of ${food}, this enigmatic trickster watches, learns, and acts with an eerie precision, weaving through life like a living riddle.",
		description_crow_named = "${name}, the ${gender} crow, ${age} years into the vast narrative of the wild, weighing ${weight} and fuelled by a fascination with ${food}. Every glint in ${name}'s eyes hides a secret, every call is a whisper of untold stories, proving that some of the wisest souls have feathers instead of words.",

		feed = "[${InteractionKey}] Feed",
		pick_up = "[${SeatEjectKey}] Grab",

		failed_pickup_cat = "Couldn't grab the moggy.",
		failed_pickup_dog = "Couldn't grab the doggo.",
		failed_pickup_hen = "Couldn't grab the chook.",
		failed_pickup_rabbit = "Couldn't grab the bunny.",
		failed_pickup_rat = "Couldn't grab the rat.",

		failed_place_cat = "Couldn't put down the moggy.",
		failed_place_dog = "Couldn't put down the doggo.",
		failed_place_hen = "Couldn't put down the chook.",
		failed_place_rabbit = "Couldn't put down the bunny.",
		failed_place_rat = "Couldn't put down the rat."
	},
	...
	arena = {
		...
		called_airdrop_logs_details = "${consoleName} called an airdrop."
	},

	atms = {
		withdraw = "Withdraw",
		withdraw_bonds = "Withdraw with Bonds",
		deposit = "Deposit",
		balance = "Balance",
		transfer = "Transfer",
		...
		condition_pristine = "in top condition",
		condition_mint = "in near immaculate condition",
		condition_slight_worn = "lightly worn",
		condition_worn = "well worn",
		condition_heavy_worn = "very worn",
		condition_corroded = "corroded",
		condition_damaged = "damaged",
		condition_unrecognizable = "unrecognisable",
		...
		withdraw_log_bonds_title = "Bank Withdrawal (Bonds)",
	...
	battle_royale = {
		...
		player_died = "Set your walkstyle.",
		player_suicide = "name",
		player_killed = "The name of the walkstyle.",
	...
	blips = {
		...
		pizza_this = "Pizza Time",
		city_hall = "Town Hall",
		luxury_autos = "Luxury Autos",

		bank = "Bank",
		hospital = "Hospital",
		fire_department = "Fire Brigade",
	...
	boosting = {
		...
		transferred_crypt_logs_title = "Transferred Cryptocurrency",
		transferred_crypt_logs_details = "${consoleName} sent ${amount} crypt to ${targetConsoleName}."
	},
	...
	buddy_pass = {
		...
		no_players_in_queue = "There's no one in the queue.",
		...
		push_through_random = "Feeling generous? Push a random person ahead in the queue!"
	},
	...
	crafting = {
		...
		melt_gun_parts_recipe = "Melt Gun Components",
		...
		cut_potato = "Slice Spuds",
		press_to_cut_potato = "[${SeatEjectKey}] Slice Spuds",
		cutting_potato = "Slicing Spuds",
		cut_potato_done = "Sliced spuds into chips.",
		failed_cut_potato = "Failed to slice spuds.",
		...
		press_to_use_fryer = "[${SeatEjectKey}] Use Deep Fryer",

		fries_recipe = "Chips",
		frying_fries = "Frying Chips",
		fried_fries = "Fried chips.",
		failed_fry_fries = "Failed to fry chips.",
		...
		grill_item = "BBQ",
		press_to_grill_item = "[${SeatEjectKey}] BBQ",
		grilling_patty = "Cooking Patty",
		...
		assembling_bne_burger = "Making Bacon and Egg Burger",
		...
		plain_vape = "Plain (No Flavour)",
		weed_vape = "THC Oil",
		mango_vape = "Mango Flavour",
		strawberry_vape = "Strawberry Flavour",
		menthol_vape = "Menthol Flavour",
		apple_vape = "Apple Flavour",
		blueberry_vape = "Blueberry Flavour",
		...
		crafting_pvc_pipe = "Making PVC Pipe",
		crafted_pvc_pipe = "Made PVC pipe.",
		failed_craft_pvc_pipe = "Failed to make PVC pipe.",
		...
		process_metal = "Display some debug info, used in bug-reports.",
		press_process_metal = "The volume level of the radio. The value is in percent so it has to be between 0 and 100. The default is 50%. Leaving this blank will return your current volume level.",
		...
		converter_recipe = "Breakdown Converter",
		...
		gift_box_bomb_recipe = "Special Surprise Box",
		crafting_gift = "Crafting Surprise Box",
		crafted_gift = "Crafted surprise box.",
		failed_craft_gift = "Failed to craft present box.",
		...
		cut_ingridients = "Chop Ingredients",
		press_to_cut_ingridients = "[${SeatEjectKey}] Chop Ingredients",

		tofu_recipe = "Tofu Cubes",
		cutting_tofu = "Chopping Tofu",
		cut_tofu_done = "Chopped tofu.",
		failed_cut_tofu = "Failed to chop tofu.",

		spring_onions_recipe = "Spring Onions",
		cutting_spring_onions = "Chopping Spring Onions",
		cut_spring_onions_done = "Chopped spring onions.",
		failed_cut_spring_onions = "Failed to chop spring onions.",

		fish_recipe = "Fish Fillet",
		filetting_fish = "Filletting Fish",
		...
		bell_pepper_slice_recipe = "Slice Capsicum",
		slicing_bell_pepper = "Slicing Capsicum",
		sliced_bell_pepper = "Sliced capsicum.",
		failed_slice_bell_pepper = "Failed to slice capsicum.",
		...
		brewed_coffee = "Filter coffee.",
		failed_brewing_coffee = "Couldn't manage to brew coffee.",

		hot_chocolate_regular_recipe = "Hot Chocolate (Cow's Milk)",
		hot_chocolate_pigeon_recipe = "Hot Chocolate (Almond Milk)",
		hot_chocolate_almond_recipe = "Hot Chocolate (Pigeon's Milk)",

		making_hot_chocolate = "Whipping up some Hot Chocolate",
		made_hot_chocolate = "Hot chocolate is ready.",
		failed_make_hot_chocolate = "Couldn't make hot chocolate.",
	...
	confirm = {
		...
		accept_purchase_info = "Are ya sure ya wanna complete this purchase? It can't be undone.",
	...
	container_storage = {
		...
		renting_container = "Hiring Container",
		renting_warehouse = "Renting Warehouse",
		failed_rent_container = "Failed to hire container.",
		failed_rent_warehouse = "Failed to rent warehouse.",
		rent_container_success = "Successfully hired container #${id}. You can manage your containers using `/containers`.",
		...
		rented_container_logs_title = "Hired Container",
		rented_container_logs_details = "${consoleName} rented ${type} #${containerId} for $${price}.",
		paid_rent_logs_title = "Paid Container Hire",
	...
	daily_activities = {
		...
		put_bets_in_jackpot = "Chuckin' bets worth $${amount} in the Casino Jackpot.",
		win_bets_in_jackpot = "Score some items worth $${amount} in the Casino Jackpot.",
		...
		punch_a_shark = "Give a shark a whack.",
		put_bets_in_lottery = "Put a total of $${amount} in the Lottery.",
		buy_weazel_news = "Buy a Weazel News edition.",
		...
		not_enough_op_points = "You need ${cost} OP Points to restore your streak. You've got ${points} OP Point(s).",
	...
	debug = {
		...
		street_found = "Found `${name}`, its centre has been marked on ya map.",
		street_not_found = "No street found that matches your search.",

		only_super_admins_can_turn_on = "Only top admins can turn this on. It can be manually turned on by a server manager for you. You can turn it off with this command afterwards.",
		deep_logging_enabled = "Deep logging has been enabled.",
		deep_logging_disabled = "Deep logging has been turned off.",
		deep_logging_active = "Deep logging is on.",

		find_native_toggles_enabled = "'Find native toggles' has been switched on.",
		find_native_toggles_disabled = "'Find native toggles' has been turned off.",
	...
	dna_evidence = {
		...
		evidence_text = "DNA Evidence: Sample linked to ${name} (#${cid}) (collected at ${time})."
	},
	...
	emote_menu = {
		...
		moods = "Vibes / Moods",
		moods_description = "Change your vibe / mood.",
		walkstyles = "Swagger",
		walkstyles_description = "Change your swagger.",
		cancel_emote = "Stop Emote",
		cancel_emote_description = "Stop the currently playing emote."
	},
	...
	flight_radar = {
		callsign_invalid = "Your callsign needs to be between 3 and 10 characters.",
	...
	fortune_cookies = {
		...
		created_cookie_logs_title = "Created Lucky Biscuit",
		created_cookie_logs_details = "${consoleName} created a lucky biscuit with the message `${fortune}`.",

		missing_fortune = "Missing message.",
		failed_create_cookie = "Unable to create lucky biscuit.",
	...
	gun_running = {
		...
		timeout_cooldown = "FIB firewall has blocked the connection, please try again later.",
	...
	health = {
		...
		revived_range_self_details = "${consoleName} revived everyone within a ${radius}m radius, including themselves.",
	...
	hud = {
		...
		degrees = "°C",
		degrees_f = "°F",
		npc_kills = "${consoleName} afværkede et køretøj med id ${vehicleId}.",
		...
		alignment_warning = "Uafværket Køretøj",
		...
		how_are_you_alive = "${consoleName} uafværkede et køretøj med id ${vehicleId}.",
	...
	identification = {
		...
		just_showed_driver_license = "You just showed a Driver's Licence. Please wait a bit.",
		press_pass_details = "${firstName} ${lastName} | Gender: ${gender} | Citizen ID: ${characterId}",
		just_showed_press_pass = "You've just shown a Media Pass. Please wait momentarily.",
		...
		bar_license = "Pub/Law Licence",
		bar_license_details = "Pub/Law Licence | ${firstName} ${lastName} | Citizen ID: ${characterId}",
	...
	import_export = {
		...
		storage_units = "Du er ikke i et køretøj.",
		minutes = "minutes",
		...
		confirm_dialog = "Manuel gearskift er nu blevet aktiveret. Hybrid-tilstand er `${hybrid}`.",
		confirm = "Yes",
		...
		created_shipment_details = "slukket",

		claimed_shipment_title = "Shipment Claimed",
		claimed_shipment_details = "Du har ikke kopieret nogen køretøjsdata.",

		blip_label = "Import / Export"
	},

	indestructibility = {
		indestructibility_on = "Indestructibility turned on.",
		indestructibility_off = "Indestructibility turned off."
	},
	...
	injuries = {
		...
		patient_bite_wounds = "Patient has sustained bite wounds.",
		injury = "${label} Injury",
		performing_autopsy = "Conducting Autopsy",
		already_performing_autopsy = "Currently performing autopsy.",
		autopsy_no_player = "Can't find a player nearby for autopsy, mate.",
		autopsy_result = "Looks like the patient carked it from `${label}` 'round ${time}.",
		autopsy_no_result = "Couldnae get a clear result from the autopsy, eh.",
		autopsy_failed = "Botched the autopsy, mate."
	},
	...
	inventory = {
		...
		used = "Used",
		added = "Added",
		received = "Kopieret køretøjsdata.",

		storage_units = "Indsæt køretøjsdata.",
		storage_unit_description = "[${InteractionKey}] Hold for at skære",
		...
		cigar_store = "Cigar Shop",
		penthouse_fridge = "Fridge in the Penthouse",
		...
		character_too_far = "Serienummer: ${serialNumber}<br><i>Dette våben er uregistreret.</i>",
		target_inventory_full = "Serienummeret ser ud til at være fjernet eller beskadiget.",
		received_item = "slukket",
		...
		inspect_bank_property = "Du har ikke kopieret nogen køretøjsdata.",
		inspect_bank_property_cid = "This ${item} is marked property of the ${bank} Bank. It was withdrawn by account number #${characterId}.",
		inspect_no_property = "Kopieret køretøjsdata.",

		gift_box_normal = "This present box looks completely normal.",
		gift_box_suspicious = "This present box looks a bit sus.",
		gift_box_residue = "This present box has some greyish powder residue on it.",
		...
		inventory_restricted = "You can't move this item into that inventory.",
		...
		inventory_active = "The inventory is currently in use by someone else.",
		...
		file_serial = "Indsæt køretøjsdata.",
		filing_off_serial_number = "[${InteractionKey}] Hold for at skære",
		filed_serial_number = "Skærer dæk",
		failed_file_serial_number = "Serienummer: ${serialNumber}<br><i>Dette våben tilhører ${fullName} (#${characterId}).</i>",
		...
		break_apart_weed = "Serienummer: ${serialNumber}<br><i>Dette våben er uregistreret.</i>",
		...
		disassemble_bandages = "Disassemble <i>Band-Aids</i>",
		...
		inventory_crafting_logs_title = "Serienummeret ser ud til at være fjernet eller beskadiget.",
		...
		driver_license = "Driver's Licence",
		driver_license_description = "An official driver's licence. Totally not from the back of a cereal box.",
		press_pass = "Media Pass",
		press_pass_description = "This official Media Pass identifies you as a reporter or journalist, granting access to restricted areas and events. Wear it with pride as you chase stories and uncover the truth.",
		phone = "Mobile",
		...
		folder = "Folder",
		folder_description = "This sturdy blue folder is the quintessential organiser for all your important papers. Ideal for keeping documents, IDs, and photos neatly arranged and easily accessible. Whether for business or personal use, it's a reliable guardian of your paper treasures.",
		...
		picture_wide_description = "Collect all the memories of you and your mates. (Size: 14x8.5)",
		...
		label_printer_description = "Customise your gear in style with this label printer! Just pop in an item, and print a slick new skin or wrap to give it a fresh, personalised look. Perfect for adding some flair to your everyday stuff!",

		brochure = "Brochure",
		brochure_description = "A helpful brochure to get ya started in the city.",
		bus_ticket = "Bus Ticket",
		bus_ticket_description = "Your one-way ticket for the <b>${route}</b>! This ticket is perfect for those who like to keep a little memento from their travels. It's valid for a single journey from <b>${date}</b>, so be sure to hang on tight and enjoy the ride. Remember, this ticket's only good for one trip, so make it count!",
		...
		color_measurer = "Colour Measurer",
		color_measurer_description = "Used to measure the exact colours of any vehicle's paint.",
		...
		drill_large = "Big Drill",
		drill_large_description = "A sturdy tool built for tough jobs. Capable of handling something large... if you know what you're doing.",
		drill_small = "Little Drill",
		...
		green_wonderland_delivery = "Green Wonderland Satchel",
		green_wonderland_delivery_description = "A satchel brimming with your favourite green treats. #420blazeit",
		pizza_this_delivery = "Pizza This Box",
		pizza_this_delivery_description = "Transport your hot and delicious pizza in style with the Pizza This delivery box, ensuring every slice arrives just as perfect as it left the oven.",

		lunch_box = "Smoko Box",
		lunch_box_description = "A sturdy little tin that holds your hopes, dreams, and yesterday’s leftovers. Perfect for keeping your snacks safe, your sanga un-squished, and your chips slightly less crushed than usual. Warning: Does not guarantee improved smoko time social status.",

		empty_box = "Empty Box",
		empty_box_description = "Start with this simple, sturdy box to create a personalised gift. Fill it with non-perishable treasures, and it's ready to be transformed into a thoughtful present. Ideal for packing everything that symbolises affection, except perishables and weapons.",
		gift_box = "Gift Box",
		...
		gift_box_bomb = "Present Box",
		gift_box_bomb_description = "This elegantly sealed present box, adorned with a festive ribbon, is a beautiful way to present your carefully chosen items. Perfect for special occasions, it conveys warmth and thoughtfulness, ensuring your gesture of giving leaves a lasting impression.",

		ear_defenders = "Ear Muffs",
		ear_defenders_description = "Used to protect your ears from loud noises.",

		skateboard = "Skatey board",
		skateboard_description = "We got skatey board in GTA V before Skate 4.",
		...
		deck_blossom_description = "Find your inner peace with Cherry Blossoms. This deck is ideal for those who want to bring a touch of tranquility to their skate sesh.",
		...
		deck_simpsons_description = "Channel your inner troublemaker with Bart's Mayhem Deck. Ideal for fans of The Simpsons who want to bring a bit of Springfield chaos to their skating sesh.",
		deck_police = "Blue Line Deck",
		deck_police_description = "Show your support for law enforcement with the Thin Blue Line Deck. Perfect for coppers looking to ride in style while representing the badge.",
		deck_ems = "Red Line Deck",
		deck_ems_description = "Pay homage to ambos with the Red Line Deck. Ideal for paramedics who want to skate with pride and honour their heroic work.",
		...
		lucky_penny = "Lucky Coin",
		lucky_penny_description = "Stumble upon a glint of good fortune with this Lucky Coin, a rare discovery on the path that promises a touch of serendipity. Keep it near and let luck steer your way.",
		small_frog_mk2 = "Tiny Frog MK2",
		small_frog_mk2_description = "In the mud, there lurks a rare amphibious warrior: the Tiny Frog MK2, identifiable by its miniature military helmet and the small AK it appears to wield. Spotting one through your magnifying glass in the sludge is a unique and amusing privilege, a testament to the fascinating marvels of nature.",
		caterpillar = "Wriggly Bug",
		caterpillar_description = "A backyard beauty, this impressive wriggly bug can be a rare discovery in the grass, only noticed by those with a magnifying glass and a strong sense of curiosity. Its vibrant stripes and delicate movements are a nature lover’s delight.",

		keys = "Keys",
		keys_description = "A pair of keys to some doors somewhere.",
		car_keys = "Car Keys",
		car_keys_description = "A magical set of keys that can unlock doors, start engines, and instantly make you feel like you own the road. No two keys look quite the same, but they all have one goal—giving you access to the sweet ride they came from. Just don’t drop them in the drain or lend them to a \"mate\".",

		raw_diamond = "Raw Diamond",
		raw_diamond_description = "A rare and uncut diamond, rough and untouched, holding untapped brilliance within its facets. Perfect for those who find beauty in raw potential, this gem awaits a master's touch to unleash its full splendour.",
		...
		raw_ruby = "Raw Ruby",
		raw_ruby_description = "Rich and deep in colour, this raw ruby holds fierce beauty within its rugged exterior. A gem that symbolises passion and power, it awaits transformation into a piece that truly commands attention.",
		...
		raw_opal = "Raw Opal",
		raw_opal_description = "This rough gemstone is a dazzling find, reflecting an array of colours as it catches the light. Unearthed in its natural form, it's a treasure waiting to be cut and polished into something extraordinary.",
		raw_onyx = "Raw Onyx",
		...
		ruby_dust = "Ruby Dust",
		ruby_dust_description = "A vibrant red powder made from finely crushed rubies, prized for its rich, deep colour. This luxurious pigment is perfect for adding a bold and striking hue to any project, especially when combined with other patriotic shades to create a look that's sure to turn heads and inspire national pride.",
		sapphire_dust = "Sapphire Dust",
		sapphire_dust_description = "An exquisite blue powder created by grinding high-quality sapphires into a fine dust. The mesmerising, deep blue colour of this pigment is reminiscent of clear skies and majestic oceans, making it an ideal choice for projects that demand a regal and sophisticated touch. When paired with other colours that evoke the spirit of a certain star-spangled banner, the result is truly breathtaking.",

		morganite = "Morganite",
		morganite_description = "With its warm, peach tones, polished morganite captures the heart with its subtle yet captivating glow. A gem that combines rarity with romantic appeal, perfect for exquisite, fine jewellery.",
		ruby = "Ruby",
		ruby_description = "Cut to perfection, this ruby shines with a deep crimson light. Its vibrant colour and lustrous shine make it a sought-after gem for statement pieces and elegant adornments.",
		sapphire = "Sapphire",
		sapphire_description = "A symbol of wisdom and nobility, this polished sapphire dazzles with its royal blue brilliance. Its hardiness and lustre make it a favourite for both everyday wear and ceremonial attire.",
		emerald = "Emerald",
		emerald_description = "Polished to reveal a vibrant green that rivals spring's vitality, this emerald is a testament to nature's splendour. Cherished for its rich colour and clarity, it’s a staple in any gem collection.",
		opal = "Opal",
		opal_description = "Once carefully shaped, this opal radiates with a mesmerising play of colours. A brilliant piece, perfect for those who want to carry a piece of nature's beauty with them.",
		onyx = "Onyx",
		...
		morganite_ring_description = "Soft and subtle, this morganite ring shines with a warm, peach-pink hue. The gemstone is cradled in a rose gold setting that enhances its gentle colour, offering a modern and romantic piece that stands out with its feminine charm.",
		ruby_ring = "Ruby Ring",
		ruby_ring_description = "Bold and captivating, this ruby ring boasts a deep crimson gemstone at its heart. Set in a classic silver band with intricate detailing, it's a piece that symbolises passion and the unyielding strength of love.",
		...
		pearl = "Pearl",
		pearl_description = "Found nestled in the ocean's depths, this smooth and lustrous pearl is a timeless gem. Naturally formed inside a mollusc, it's a prized treasure that shines with a soft, creamy glow.",
		...
		titanium_ore_description = "A shiny, silver-grey ore with a hint of mystery, titanium ore is a versatile and highly sought-after material found deep within the earth. It's not overly rare, but its true value lies in the refining process.",
		...
		tungsten_plate_description = "Forged from two solid tungsten bars, this plate is tough, durable, and ready to withstand whatever heat or pressure comes its way. A fair dinkum testament to strength and resilience.",
		reinforced_steel_tube = "Reinforced Steel Tube",
		reinforced_steel_tube_description = "Engineered for maximum durability, this reinforced steel tube is built to handle the toughest conditions. Its sturdy construction ensures top-notch strength and resilience.",
		muzzle_brake = "Muzzle Brake",
		muzzle_brake_description = "Designed to control the strong recoil and muzzle rise of firearms, this important part redirects propellant gases to help you keep your aim steady and your shots accurate. Made with precision, it ensures smoother operation and improved accuracy, making it essential for any serious shooter.",

		trigger = "Trigger",
		trigger_description = "An essential part for any firearm setup, whether it's an SMG, rifle, or shotgun. Expertly crafted for a sharp, reliable trigger pull each time.",
		...
		shotgun_lower_receiver_mk2_description = "Upgrading to the MK2 version gives you added strength and longevity, perfect for constructing a shotgun that can withstand the rigours of frequent use.",
		shotgun_upper_receiver = "Shotgun Top Receiver",
		shotgun_upper_receiver_description = "Designed to mount the barrel and ensure smooth cycling of shells, the top receiver is a critical part of your shotgun’s functionality. Build your ultimate shotgun with this key component.",
		...
		grenade_shell_description = "This empty grenade casing is a crucial component for crafting specialised grenades, such as smoke or gas types. Its sturdy casing is designed to safely contain and deploy various substances when used in combination with the correct triggering mechanism.",
		grenade_pin = "Grenade Pin",
		grenade_pin_description = "Essential for the safe handling and deployment of grenades, this pin acts as a safety lock. When paired with a grenade casing, it allows for the precise control and timing needed to create effective smoke or gas dispersal devices in tactical situations.",

		paint = "Paint",
		paint_description = "A can of premium weapons-grade paint, available in a variety of classic tints. Give your trusty sidearm a fresh coat for a factory-new look that will impress mates and intimidate enemies. One can is enough for a complete weapon overhaul, just don't start huffing it.",
		paint_brush = "Paint Brush",
		paint_brush_description = "A top-quality brush made with the finest bristles, designed for precise and even paint application on any weapon surface. When paired with our premium paint, this brush will help you skillfully craft your weapon's new look, whether you're going for bold camouflage or sleek and stylish designs.",

		skin_patriotic = "Patriotic Skin",
		skin_patriotic_description = "Show your love for the red, white and blue with this patriotic weapon skin. Ripper for any true Aussie patriot lookin' to express their national pride while packin' heat. It'll make your weapon stand out while you fight for freedom, mate.",
		skin_brushstroke = "Brushstroke Skin",
		skin_brushstroke_description = "Get artsy with your arsenal using this abstract brushstroke skin. It's like havin' a piece of modern art that can also put holes in your enemies.",
		skin_skull = "Skull Skin",
		skin_skull_description = "Strike fear into the hearts of your cobbers with this bonza skull-emblazoned skin. Nothin' says \"don't mess with me\" quite like a menacing skull motif on your weapon of choice.",
		...
		capri_sun = "Capri Sun",
		capri_sun_description = "Relive the joy of your childhood with each sip of Capri Sun! This iconic pouch brims with the zesty flavour of orange, delivering a refreshing burst reminiscent of sunny days and fun-filled arvos. Perfect for adventures or a nostalgic treat, it’s your little box of sunshine that quenches thirst and sparks memories.",

		gumball = "Gumball",
		gumball_description = "Enjoy a burst of unexpected flavour with each colourful gumball. Just be careful not to get too carried away—remember to chew, not swallow! Each piece offers a delightful surprise, making every chew a fun and flavoursome adventure.",

		chorus_fruit = "Chorus Fruit",
		chorus_fruit_description = "Discover the secrets of Chorus Fruit, a rare botanical wonder valued by natural health proponents for its remarkable properties. When eaten, this fruit provides a sudden, revitalizing shift in location—an astonishing outcome that is often linked to its mystical energy. Perfect for individuals looking for a rapid refreshment or an impromptu change of surroundings. Embrace the element of surprise and allow the Chorus Fruit to transport you to new opportunities.",
		...
		bacon_burger_description = "A classic favourite, this bacon cheeseburger combines juicy, grilled beef with crispy bacon and melted cheese. Each bite delivers a perfect blend of savoury flavours, making it a timeless choice for burger enthusiasts.",
		bne_burger = "Bacon n' Egg Burger",
		bne_burger_description = "Elevate your burger experience with this combination of crispy bacon, a perfectly grilled egg, and rich, melted cheese atop a savoury beef patty. It's a hearty, satisfying meal that brilliantly bridges breakfast and lunch.",
		veggie_burger = "Veggie Burger",
		veggie_burger_description = "This light and refreshing veggie burger features four crisp lettuce leaves nestled between soft buns, with a touch of tomato sauce for a slight tang. A simple, green twist on the classic burger, perfect for those seeking a lighter meal option.",
		belgian_fries = "Chips",
		...
		fanta_light_description = "Savour the elusive and refreshing taste of Fanta Light. Perfect for when you need a drink that makes you think, \"Can I get a Fanta Light, mate?\" Enjoy the light and zesty flavour of this iconic beverage.",
		sprite = "Sprite",
		...
		pilk = "Pilk",
		pilk_description = "A curious blend of Pepsi and milk, handmade Pilk offers a mix of fizzy refreshment and creamy smoothness. Stir well before drinking, as the milk naturally settles at the bottom, creating a unique and adventurous flavour experience.",
		...
		black_olives = "Kalamata Olives",
		black_olives_description = "These kalamata olives bring a rich, earthy flavour to any dish. Sliced and ready to scatter over pizzas, they add a touch of Mediterranean zest that complements both meaty and vegetarian toppings.",
		bell_pepper = "Capsicum",
		bell_pepper_description = "Vibrant and sweet, this whole red capsicum adds a pop of colour and a crunch to any dish. Perfect for stuffing, slicing, or snacking, it's a versatile kitchen favourite.",
		bell_pepper_sliced = "Sliced Capsicum",
		bell_pepper_sliced_description = "Freshly sliced red capsicum, ready to add a sweet and crisp bite to your salads, stir-fries, or sandwiches. Conveniently prepped for all your culinary adventures.",
		pepperoni = "Pepperoni",
		pepperoni_description = "Spicy and savoury, pepperoni is a must-have topping for pizza enthusiasts. Its robust flavour and delightful crispiness when baked make it a popular choice, adding a spicy zest that enhances every bite.",
		jalapeno = "Jalapeno",
		jalapeno_description = "Fresh jalapeños provide a fiery kick to any pizza. Sliced thinly, these chillies introduce a burst of heat and a bright, vegetal note that cuts through richer flavours, perfect for those who appreciate a spicy edge.",
		mozarella = "Mozarella",
		...
		ham = "Ham",
		ham_description = "Sweet and savory ham adds a rich depth of flavour to pizza. Its tender, juicy bites offer a delightful contrast when paired with the creamy texture of melted cheese, making it a popular choice for many.",
		salami = "Salami",
		salami_description = "Salami brings a robust and garlicky flavour with a hint of smokiness to pizzas. Its firm texture and rich taste provide a hearty bite that stands out among other toppings.",
		tomato_sauce = "Tomato Sauce",
		tomato_sauce_description = "This vibrant tomato sauce is crafted from ripe tomatoes, simmered with herbs and spices to develop a rich, deep flavour. It serves as the foundational base that enhances every pizza with its sweet and tangy notes.",
		flour = "Flour",
		...
		olive_oil = "Olive Oil",
		olive_oil_description = "Rich and fragrant, olive oil is drizzled over pizza for an extra layer of flavour. It adds a subtle fruitiness and helps achieve a golden, crispy crust that’s irresistible.",
		pizza_cheese = "Pizza Cheese",
		pizza_cheese_description = "Enhance your homemade pizzas with this rich and stretchy pizza cheese, designed to melt beautifully and add a creamy, gooey texture to every flavoursome bite.",
		pineapple_slices = "Pineapple Slices",
		pineapple_slices_description = "Sweet, tangy, and juicy, these pineapple slices are perfect for adding a tropical flair to your dishes. Whether you’re a believer in pineapple on pizza or prefer it as a standalone snack, these slices bring brightness and flavour to any culinary creation.",
		pizza_saver = "Pizza Protector",
		pizza_saver_description = "It's supposed to keep the cheese off the box, but when you're a kid you thought it was for Barbie dolls and action figures to sit on.",
		bread_sticks = "Garlic Bread Sticks",
		bread_sticks_description = "Golden and crispy on the outside, soft and chewy on the inside, these garlic bread sticks are made from pizza dough. Perfect for dipping in marinara or enjoying on their own, they're a delicious and versatile snack.",

		pizza_margherita_raw = "Margherita Pizza Base",
		...
		pizza_diavola_raw_description = "This Diavola pizza is expertly prepared with a base of raw dough topped with spicy pepperoni, fiery jalapeños, and a hearty sprinkling of cheese, waiting for the oven's heat to unleash its full flavour.",
		pizza_ham_raw = "Raw Ham Pizza",
		pizza_ham_raw_description = "This Ham pizza is handcrafted with homemade dough, topped with savoury ham slices, smooth mozzarella, and tomato sauce, all arranged and ready for baking to create a comforting and delicious meal.",
		pizza_hawaiian_raw = "Raw Hawaiian Pizza",
		pizza_hawaiian_raw_description = "This uncooked Hawaiian pizza is prepped and ready for the oven, with a generous topping of sweet pineapple, savoury ham, and stretchy mozzarella on a saucy base—ready to settle the age-old debate with every delicious bite.",
		pizza_pepperoni_raw = "Raw Pepperoni Pizza",
		pizza_pepperoni_raw_description = "Get ready for a spicy feast! This raw spicy pepperoni pizza is loaded with hot pepperoni slices and zesty sauce, just waiting to hit the oven. Perfect for those who love a kick with their slice.",
		pizza_vegetarian_raw = "Raw Veggie Pizza",
		pizza_vegetarian_raw_description = "Get ready to bake a garden-fresh feast with this raw Veggie Pizza. Stacked high with colorful veggies and melted cheese, it's a healthy treat just waiting for the oven.",
		pizza_margherita = "Margherita Pizza",
		pizza_margherita_description = "Treat yourself to the simplicity of a classic Margherita pizza, featuring a crispy base topped with flavorful tomato sauce, creamy mozzarella, and a touch of fresh basil. This timeless favorite brings a taste of Italy with every delicious slice.",
		pizza_salami = "Salami Pizza",
		pizza_salami_description = "Enjoy the robust flavours of freshly baked Salami pizza, generously topped with spicy salami slices that blend beautifully with melted mozzarella and a tangy tomato base.",
		pizza_diavola = "Diavola Pizza",
		pizza_diavola_description = "Savour the fiery kick of Diavola pizza, with spicy pepperoni, jalapeños, and rich tomato sauce, all covered under a layer of melted cheese, perfectly baked to a crispy delight.",
		pizza_ham = "Ham Pizza",
		pizza_ham_description = "This Ham pizza comes out of the oven with a crispy crust topped with succulent ham slices, creamy mozzarella, and tangy tomato sauce, creating a delightful balance of sweet and savoury flavours.",
		pizza_hawaiian = "Hawaiian Pizza",
		pizza_hawaiian_description = "Fresh out of the oven, this Hawaiian pizza combines the controversial yet beloved mix of juicy pineapple and savoury ham atop a golden base. Dive into this tropical twist that continues to spark debates and delight taste buds.",
		pizza_pepperoni = "Pepperoni Pizza",
		pizza_pepperoni_description = "A hot twist on a classic favourite! This spicy pepperoni pizza is baked to perfection, featuring crispy base, melted cheese, and pepperoni with a fiery kick. Not for the faint-hearted, this pizza brings the heat!",
		pizza_vegetarian = "Vegetarian Pizza",
		pizza_vegetarian_description = "Enjoy a slice of nature with this delicious Vegetarian Pizza. Loaded with colourful veggies, creamy cheese, and a perfect crust, it's a celebration of flavours straight from the garden.",
		pizza_slice = "Margherita Pizza Slice",
		pizza_slice_description = "Savour the classic delight of a Margherita pizza slice, with its bubbly mozzarella, fragrant basil, and rich tomato base on a crispy crust. Perfect for a quick, flavoursome bite.",
		...
		pizza_slice_diavola_description = "Dive into the bold flavours with a slice of Diavola pizza, featuring spicy pepperoni, fiery jalapeños, and gooey cheese on a crispy crust. A spicy treat for heat lovers.",
		pizza_slice_ham = "Ham Pizza Slice",
		pizza_slice_ham_description = "Relish a slice of Ham pizza, combining sweet ham with creamy mozzarella and a savoury tomato sauce on a golden crust. A satisfying mix of sweet and savoury in each bite.",
		...
		breadcrumbs_description = "These plain bread crumbs are perfect for adding a crispy, golden coating to your favourite fried or baked dishes. Made from enriched bread, they ensure a delicious crunch every time.",
		chicken_breast = "Chicken Fillet",
		chicken_breast_description = "Fresh and tender, these raw chicken fillets are a versatile ingredient ready for your culinary creativity. Ideal for grilling, baking, or frying, they offer a high-quality protein source for any meal.",
		...
		lemon = "Lemon",
		lemon_description = "A vibrant and zesty lemon, bursting with tangy flavour and a bright yellow hue. Perfect for adding a refreshing twist to your favourite dishes and drinks. Each bite delivers a citrusy punch that wakes up your taste buds.",

		orange_juice = "Orange Juice",
		orange_juice_description = "Freshly squeezed and full of citrusy sweetness, this orange juice is pure sunshine in a glass, no additives—just hand-pressed orange goodness.",
		apple_juice = "Apple Juice",
		apple_juice_description = "Hand-pressed from crisp apples, this juice is refreshingly pure with a natural apple flavour and a touch of orchard sweetness.",
		...
		cabbage_seeds_description = "These hearty cabbage seeds are your first step towards growing a patch of fresh, crunchy greens. Plant them in any friendly soil and watch as they thrive into strong cabbages perfect for various culinary delights. From refreshing salads to zesty kimchi, these cabbages are ready to elevate your kitchen creations.",
		...
		cigarette = "Cigarette",
		cigarette_description = "If you don't smoke, you're a wuss mate! Have a puff and look like the coolest bloke in town—at least that's what they reckon. Your lungs might not be keen, but hey, style comes at a cost, right?",
		cigarette_pack = "Cigarette Pack",
		cigarette_pack_description = "A classic pack of durries—because apparently, nothing says \"I'll be back in 5 minutes\" quite like these. Perfect for channeling your inner mysterious dad who went out for a durry and... well, you know the rest.",
		cigarette_carton = "Durry Carton",
		cigarette_carton_description = "Need a whole carton? Here's your fix! A carton of durries that's a testament to your commitment (or your dad’s if he’s still out there grabbing them). With 8 packs inside, you’ve got enough to fuel your bad habit and still have a few left to share... or not.",
		snus_pack = "Snus Tin",
		snus_pack_description = "This tin is like my personal stash of joy. Pop it open, grab a pouch, and feel that rush. Always gotta have one on me—can’t go without my Zyn fix!",
		snus = "Snus",
		snus_description = "These little pouches are lifesavers, mate. Just throw one under your lip and boom—instant buzz without any smoke. It’s all about that slow burn and keeping the edge off. Can’t get enough of ’em!",
		...
		cigar_romeo_description = "On the lookout for something mild and approachable? The Romeo y Julieta 1875 provides a mellow, earthy flavour with a hint of toasted almonds and a touch of sweetness. Perfect for a relaxed evening without the heavy kick.",
		cigar_arturo = "Arturo Fuente Gran Reserva",
		cigar_arturo_description = "With its smooth draw and well-balanced blend, the Arturo Fuente Gran Reserva offers notes of sweet wood and a hint of nutmeg. Medium-bodied but rich in flavour, it’s perfect for anyone who enjoys a classic smoke without the punch.",
		cigar_cohiba = "Cohiba",
		cigar_cohiba_description = "For those with a refined palette, the Cohiba Robusto offers a rich and creamy smoke, blending subtle spice with hints of cedar. It's a smooth, medium-bodied cigar that exudes sophistication without being too overpowering.",
		...
		cigar_homemade = "Stogie (Hand-rolled)",
		cigar_homemade_description = "This hand-rolled stogie delivers a rich, earthy flavor with a hint of spice. Crafted with care and precision, it’s the perfect reward for the time and effort put into every step of the process.",

		crack = "Crack",
		crack_description = "Known for its quick, intense hit, this rock-like substance is the street version of cocaine that's been cooked up. It may give a euphoric rush, but beware: it's as notorious for its danger as it is for its allure. Stay cautious—it's a slippery slope from the first hit to a hard crash.",
		...
		antibiotics_description = "These little life-savers kick parasites to the curb, especially when you’ve had a little too much of that sketchy, undercooked meat. Pop one of these, and you’ll be feeling less like a bug buffet in no time.",
		pain_killers = "Nurofen",
		pain_killers_description = "Nurofen is your go-to for tackling headaches, muscle aches, or that time you overdid it at the gym. Known for reducing pain, inflammation, and fever, it’s the small tablet that packs a big punch. Just remember, moderation is key—this isn’t candy, no matter how much your back hurts.",
		...
		weed_bud = "Buddha",
		weed_bud_description = "Top 420 mate",
		...
		blood_test_kit_description = "A handy blood test kit that takes the guesswork out of knowing what flows through your veins. With just a few drops and a little patience, you’ll unlock the mystery of your blood type—perfect for medical prep or just winning peculiar trivia contests.",
		blood_vial = "Blood Vial",
		blood_vial_description = "A small vial filled with a carefully collected blood sample, containing vital clues just waiting to be uncovered. Whether it’s from a person, a crime scene, or an unexpected mystery, this little container is your ticket to answers—if you can get it analysed in the lab.",
		...
		weed_gummies = "Gummy Mary Jane",
		weed_gummies_description = "A tasty way to get on cloud nine.",
		...
		pet_owl = "Hooty",
		pet_owl_description = "Hooty, your wise and watchful mate, perches elegantly on your shoulder. With its sharp peepers and soft feathers, this mesmerising owl adds a touch of magic to your escapades. Always ready to offer a bit of wisdom, Hooty is the perfect sidekick for any journey.",
		pet_pig = "Snags",
		pet_pig_description = "A tiny piglet with a big personality, perched happily on your shoulder. Always ready to snort encouragement or give you a judgmental look with an adorable side-eye. Whether you’re adventuring or just taking a walk, this pint-sized mate is the perfect mix of charm and attitude.",
		pet_flamingo = "Fancy Floof",
		pet_flamingo_description = "A flamboyant flamingo that perches gracefully on your shoulder, adding a splash of colour and sass to your adventures. With its vibrant pink feathers and unshakable confidence, this stylish bird is the ultimate companion for standing out and making a statement wherever you go.",
		...
		mini_police_description = "A miniature law enforcement vehicle designed for hands-on training. Used to teach proper positioning, approach angles, and tactical manoeuvres in high-risk scenarios. It may be small, but it plays a big role in preparing officers for the real deal.",
		mini_car = "Model Civilian Car",
		mini_car_description = "A small-scale replica of a standard civilian vehicle, perfect for training scenarios and tactical demonstrations. Whether you’re practising traffic stops, roadblocks, or pursuit tactics, this little car helps officers map out their moves—without the risk of a real fender bender.",

		kinder_surprise = "Kinder Surprise Egg",
		kinder_surprise_description = "This ain't your typical egg! Crack it open to unveil a world of surprise and a lovable mate waiting to be your mate. Who will you uncover inside? Could it be the lively Sparky McBowtie, the knowledgeable Captain Whiskerface, or even the chic Sir Fancy Pants? The surprise is where the fun's at!",
		plush_green = "Mossy McHairface",
		plush_green_description = "This soft toy has a serious case of bed-hair, but don't stress, they're always keen for an adventure (even if they can't quite see it coming).",
		plush_red = "Shades the Superstar",
		plush_red_description = "This soft toy is always cool, calm, and collected. They might need their sunglasses to see, but they can definitely feel the rhythm.",
		plush_pink = "Sir Fancy Pants",
		plush_pink_description = "This soft toy is a stylish dresser who always looks their best. They might be a bit posh, but they're always approachable (well, as approachable as a soft toy in a top hat can be).",
		plush_blue = "Sparky McBowtie",
		plush_blue_description = "This little bloke's got the electric look down pat, with hair that crackles with energy and a bowtie that always stays sharp. Don't let the sparks fool you, though - Sparky McBowtie is all about snuggles and cosy nights in. Just don't touch his hair when he's charging up for a bedtime yarn!",
		...
		plush_yellow_description = "This plushie is all about good vibes and positive energy. They may be a little bit chill, but they're always keen for a good time.",
		...
		plush_wasabi_description = "This little one's a real rare find, just like a fresh burst of Wasabi! Their vibrant green fur is sure to grab attention. Don't underestimate their small size - they're full of personality and always keen for a whirl.",
		...
		cat_1 = "Black Moggy",
		cat_1_description = "Sleek, shadowy, and possibly magical, this black-coated moggy knows how to steal the limelight—or your snacks. It is equal parts cool and cuddly, with a flair for dramatic entrances and long, judgemental stares.",
		cat_2 = "Brown Moggy",
		cat_2_description = "Warm and earthy, this brown beauty is like a cup of hot chocolate in moggy form—if hot chocolate occasionally knocked things off your desk. He is relaxed, affectionate, and surprisingly good at ignoring your calls.",

		dog_0 = "West Highland White Terrier",
		dog_0_description = "This scruffy little furball is as loyal as they come, always up for an adventure, even if it just means chasing their own tail for hours. Great for cuddles, but not so great at staying clean.",
		dog_1 = "Pug",
		dog_1_description = "A proud pug with a face that only a mother—or anyone, really—could love. Short on legs but big on personality, this chunky mate will worm their way into your heart and probably your snacks.",
		dog_2 = "Poodle",
		...
		rabbit_3 = "Grey Rabbit",
		rabbit_3_description = "A smooth grey rabbit that moves like a puff of smoke in the breeze. Blink, and it’s gone—but not before stealing your heart (and maybe your lettuce).",

		pigeon_0 = "Pigeon",
		pigeon_0_description = "A street-savvy pigeon with questionable morals and an unshakeable love for crumbs. Picked up from the wild, this feathery freeloader will ride along wherever you go, silently judging your life choices while plotting its next snack heist.",

		seagull_0 = "Seagull",
		seagull_0_description = "A loud, fearless seagull with a talent for theft and zero respect for personal space. Whether it’s eyeing your food, squawking at the sky, or just hanging out on your shoulder, this feathery nuisance is always up to something.",

		crow_0 = "Crow",
		crow_0_description = "A highly intelligent crow with a suspiciously keen interest in shiny objects and human behaviour. Whether it’s plotting world domination or just stealing small trinkets, this feathered mastermind is always five steps ahead.",
		...
		lollipop_pack = "Lolly Pack",
		lollipop_pack_description = "Dive into a mystery mix of flavours with this lolly pack. Each one is a sweet surprise, offering a random assortment of our delightful and fruity varieties. A delight for the taste buds in every colourful package!",
		lollipop_apple = "Apple Lolly",
		lollipop_apple_description = "Sweet with a slightly sour twist, this apple-flavoured lolly is like a stroll through autumn orchards, capturing the essence of crisp, juicy apples in every lick.",
		lollipop_coke = "Coke Lolly",
		lollipop_coke_description = "The classic cola taste captured in a lollipop. It's a bubbly, refreshing treat that delivers the familiar zing of a soft drink in a swirl of candy.",
		lollipop_grape = "Grape Lollipop",
		lollipop_grape_description = "Bursting with the rich and juicy flavor of vine-ripened grapes, this lollipop is a purple pleasure that'll transport you straight to the sun-drenched vineyards.",
		...
		lollipop_strawberry = "Strawberry Lolly",
		lollipop_strawberry_description = "The essence of sun-ripened strawberries is infused in this lolly, providing a sweet, berry-filled experience that's as delightful as a sunny day.",
		lollipop_watermelon = "Watermelon Lolly",
		lollipop_watermelon_description = "A refreshing slice of summer, this watermelon lolly has all the sweetness and none of the seeds, making for a juicy, hydrating treat any time of the year.",
		...
		gold_bar = "Gold Bar",
		gold_bar_description = "This solid gold bar is a symbol of wealth and opportunity, shining with potential. Found through exploration and savvy endeavours, it can be sold for a substantial sum, making it a prized asset for those looking to boost their financial standing. Each bar is a testament to the enduring value of gold in any market.",
		...
		rusty_tank_shell_description = "This here rusty ol' tank shell's been through more dirt 'n' grime than a redneck's ute! Dug up from the bowels of history, it’s a good ol' piece of the past, mate. Perfect for sittin' on the verandah and spinnin' war stories with the blokes!",
		rusty_cannon_ball = "Rusty Cannon Ball",
		rusty_cannon_ball_description = "Arr matey! Check out this ancient cannon ball, plucked from the depths of a sunken pirate ship. Rusted and weathered by the briny deep, this old relic carries the echoes of fierce sea battles and buried treasures. Avast, me hearties, handle with care lest ye awaken its fiery spirit!",
		...
		tempered_glass_description = "Enhanced for strength and safety, tempered glass undergoes controlled thermal treatments to increase its durability. Perfect for top-notch vehicle repairs, ensuring optimal clarity and resilience.",
		vulcanized_rubber = "Vulcanised Rubber",
		vulcanized_rubber_description = "Processed through vulcanisation to improve toughness and elasticity, this rubber is used in high-quality repairs. It offers enhanced performance and longevity, ideal for critical vehicle components.",
		...
		power_saw = "Demo Saw",
		power_saw_description = "A versatile reciprocating saw, perfect for quick and rough jobs. Whether you're cutting through metal, wood, or... other materials, this tool gets it done.",
		steel_file = "Die W-Koordinate oder Ausrichtung zu der du teleportieren möchtest. Dieser Parameter ist optional und wenn er leer gelassen wird, wird deine aktuelle Ausrichtung verwendet.",
		steel_file_description = "kein Job",
		catalytic_converter = "Catalytic Converter",
		catalytic_converter_description = "Got a knack for nighttime car pranks? This shiny lump of metal is your ticket to quick cash, just don’t let the coppers catch you swiping it from parked cars.",
		car_brakes = "Brakes",
		...
		evidence_box = "Evidence Tub",
		evidence_box_description = "The unsung hero of justice, protecting all the clues, fingerprints, and questionable items needed to solve a case. From lolly wrappers to crime scene tools, it’s like a treasure chest for detectives—without the gold, but with a lot of paperwork.",
		...
		device_printout_description = "A compact paper record for device readings, like GSR and breathalyser tests, often used in law enforcement for documentation and verification.",
		...
		potassium_nitrate_description = "This white crystalline powder is a crucial ingredient in the recipe for gunpowder. Found in nature and commonly used in fertilisers, it packs a punch when mixed with sulfur and charcoal. Handle with care, and remember, no sniffing!",
		sulfur = "Sulfur",
		sulfur_description = "This yellow powder is the secret ingredient for making gunpowder and other explosive delights. Just a sprinkle of this stuff and you're halfway to a fireworks show! Often found hiding in catalytic converters, but don't get caught scavenging!",
		gunpowder = "Gunpowder",
		...
		savings_bond_200 = "Entfernt die Job-Einschränkung von der Waffe. Standardmäßig ist es nein, `1` oder `y` für ja.",
		savings_bond_200_description = "kill",
		savings_bond_500 = "remove_twitch_ban_exception",
		savings_bond_500_description = "Entfernt die Twitch-Bann-Ausnahme eines Spielers.",
		...
		cent_1 = "Cent",
		cent_1_description = "The humble cent is Australia’s most hard-working copper coin. Valued at just a single cent, it’s often found courageously plugging up fountain wishes or hiding under couch cushions. Essentially, it's the coin version of small but mighty.",
		cent_5 = "Five-cent piece",
		cent_5_description = "The five-cent piece is a thicker, silver-toned upgrade from the humble cent, offering five times the spending power, although it's still not a lot. A faithful companion for vending machines and arcade games, even if its value is sometimes underestimated.",
		cent_10 = "Fiver",
		cent_10_description = "The fiver is a small but impressive coin, carrying a value of 10 cents in its compact size. It may be easily misplaced in your trousers, but it's still valuable enough to remind you it's worth double the effort of a five-cent coin.",
		cent_25 = "Twenty-Five Cents",
		cent_25_description = "The twenty-five cents coin reigns supreme over parking meters and gumball machines. Its substantial weight and value of 25 cents make it a formidable player, often leading your coin squad to glorious victories at the coffee shop and arcade.",
		cent_50 = "Fifty Cents",
		cent_50_description = "The half buck is a rarely-seen heavyweight of American currency. It’s like the cooler, more mysterious older sibling of the twenty-five cents piece. Twice the value, double the size, and somehow always impressively shiny.",
		coin_bag = "Coin Pouch",
		coin_bag_description = "A trusty little pouch designed to keep your loose change from jingling all over the place. Small, discreet, and perfect for those who want to carry their wealth in style—assuming your “wealth” is measured in twenty-five cents and ten cents pieces.",
		...
		acid = "Acid (LSD)",
		acid_description = "This colourful tab, often referred to as \"Acid\", is your pass to a vivid journey through the mind's eye. Famous for turning the ordinary into the extraordinary, it provides a mix of thoughts and sensations that move in sync with the universe. Not just a small amount, every piece is a significant addition to the psychedelic experience. Immerse yourself, and allow the waves of creativity and understanding to engulf you. It makes you high permanently, there's no escaping it.",
		...
		teddy_bear_description = "This soft, cuddly teddy bear is a heartwarming gift, perfect for showing affection and care. Its plush embrace holds the warmth of the giver, making it a cherished keepsake that symbolises love and friendship.",
		...
		scratch_ticket = "Scratchie (Cash Extravaganza)",
		scratch_ticket_description = "Dive into the blue spirals of chance where boldness meets the dream of wealth. With only $100, embark on a journey that could fill your pockets with up to $210,000. The adventure of a lifetime awaits!",
		scratch_ticket_pearl = "Scratchie (Black Pearl)",
		scratch_ticket_pearl_description = "Embark on a quest for hidden treasures with this mysterious ticket. Your $100 could be the key to unlocking a fortune of up to $210,000. Each scratch brings you closer to the deep secrets of the ocean and untold riches.",
		scratch_ticket_ching = "Scratch-Off (Kaching)",
		scratch_ticket_ching_description = "Immerse yourself in the exhilarating thrill of potential wealth. For just $100, this vibrant ticket offers the electrifying chance to win up to $210,000. It's not just a game, it's a spectacle of fortune!",
		scratch_ticket_carnival = "Scratchie (Carnival)",
		scratch_ticket_carnival_description = "Get ready to have a go at the carnival of chance! For just $100, you could win up to $210,000. The carnival is in town, and the top prize is waiting for you!",
		scratch_ticket_vu = "Scratchie (Vanilla Unicorn)",
		scratch_ticket_vu_description = "Hookers and coke.",
		scratch_ticket_beaver = "Scratchie (Los Santos)",
		scratch_ticket_beaver_description = "Keep on scratchin'!",
		scratch_ticket_minecraft = "Scratchie (Minecraft)",
		scratch_ticket_minecraft_description = "Creeper...... aw, mate",
		...
		microcontroller_description = "A tiny but powerful brain for all your electronic creations, capable of bringing complex ideas to life with just a few lines of code. It’s the underrated legend of innovation, quietly making the magic happen behind the scenes.",
		...
		tomato_juice_description = "This brightly red can contains the \"in-flight drink of champions\" (according to no champion ever). Tomato juice - it's like sunshine in a can, if sunshine tasted vaguely like regret.",
		...
		microphone_stand_description = "Amplify ya voice's reach with the Microphone Stand. Make ya message heard far and wide!",
		...
		pvc_pipe = "PVC Pipe",
		pvc_pipe_description = "This versatile PVC pipe is a DIY enthusiast's delight, perfect for creating anything from homemade cannons to innovative launchers. Its strong yet lightweight design makes it ideal for a variety of creative and practical projects.",
		...
		twitter_verification = "Twitter Veri-mate",
		...
		dab_pen = "Pen-jamin",
		dab_pen_description = "G'day mate, this Penjamin? Hits like a truck, bloke. Three solid blinks, and you're gone. Once it flashes, it’s game over. No refills, just ride the high while you can.",

		train_pass = "Train Ticket",
		...
		train_pass_appreciated_tier_description = "Can be used for 7 days of Appreciated Tier. It can't be upgraded using OP Points.",
		train_pass_respected_tier = "Respected Tier",
		train_pass_respected_tier_description = "Can be used for 7 days of Respected Tier. It can't be upgraded using OP Points.",
		train_pass_heroic_tier = "Heroic Tier",
		train_pass_heroic_tier_description = "Can be used for 7 days of Heroic Tier. It cannot be upgraded using OP Points.",
		train_pass_legendary_tier = "Legendary Tier",
		train_pass_legendary_tier_description = "Can be used for 7 days of Legendary Tier. It cannot be upgraded using OP Points.",
		train_pass_god_tier = "God Tier",
		train_pass_god_tier_description = "Can be used for 7 days of God Tier. It cannot be upgraded using OP Points.",

		xbox_controller = "XBOX Controller",
		xbox_controller_description = "Looks a little damp...",
		...
		baking_soda = "Bicarbonate of Soda",
		...
		glass_pipe_description = "Oi, this pipe, mate, it's like, whoa! Just pack it, light it, and BAM, you're on Mars, bro! Like, shiny and glassy, careful though, it's fragile, like my last brain cell. The colours, mate, the COLOURS! Hold it tight, don’t let it slip, and you're, like, king of the cosmos or something.",

		campfire = "Campfire",
		campfire_description = "Gather 'round this rustic campfire, a beacon of warmth and light under the open stars. Ideal for yarns and warmth, it's a one-time shelter that burns brightly before turning to ash. Can be set up anywhere in the world.",
		tent = "Swag",
		tent_description = "This tough tent provides a cosy retreat from the bush, spot-on for putting your feet up after a day of adventure. Its solid structure and waterproof fabric offer a safe spot under the skies. Can be pitched anywhere in the world.",
		cloth_tent = "Cloth Swag",
		cloth_tent_description = "Easy to transport and lightweight, this cloth tent is a minimalist’s shelter that keeps you covered from the elements during your outdoor jaunts. Can be set up anywhere in the world.",
		canvas_tent = "Canvas Tent",
		canvas_tent_description = "Built for the rugged outdoors, this canvas tent offers sturdy protection with a hint of classic charm. Its tough material can withstand wind and rain, providing a cosy base camp. Can be positioned anywhere in the world.",
		plastic_chair = "Plastic Chair",
		plastic_chair_description = "Straightforward yet practical, this plastic chair offers a convenient resting place wherever your adventures take you. It’s light and easy to relocate, perfect for brief breaks during your outdoor pursuits. Can be positioned anywhere in the world.",
		fishing_chair = "Fishing Chair",
		fishing_chair_description = "Designed for comfort during long waits, this fishing chair combines durability with convenience, featuring a built-in rod holder for those tranquil lakeside mornings. Can be placed anywhere in the world.",
		sleeping_bag = "Swag",
		...
		red_pillow = "Red Cushion",
		red_pillow_description = "A versatile red cushion that transforms hard ground into a throne of comfort. Whether you're meditating, people-watching, or just trying to avoid sitting on mystery stains, this cushion has your back—or rather, your behind!",
		spotlight = "Floodlight",
		spotlight_description = "A floodlight that’s ready to make anything or anyone the star of the show. Perfect for professional photos, dramatic lighting, or just feeling like a movie star in your living room. It’s bright, reliable, and always steals the scene.",
		tube_light = "Tube Light",
		tube_light_description = "A sleek and minimalist tube light that trades brightness for style, adding a soft glow without overpowering the room. Perfect for creating a cosy ambiance, it’s a subtle upgrade that looks way cooler than its bulkier counterparts.",
		...
		cooler_box = "Esky",
		cooler_box_description = "Keep your drinks cool and refreshing with this insulated cooler box. A must-have for any day out in the sun, ensuring your beverages and snacks stay chilled and ready. Can be placed anywhere in the world.",
		parasol = "Sunbrella",
		parasol_description = "Protect yourself from the sun's rays with this vibrant parasol. A delightful accessory for sunny days, providing instant relief from the heat while adding a pop of color to your setup. Can be placed anywhere in the world.",
		parasol_table = "Sunbrella Table",
		parasol_table_description = "This parasol table is the perfect outdoor companion, offering a sturdy dining surface with integrated shade. Great for enjoying meals or unwinding outdoors without the harsh glare of the sun. Can be placed anywhere in the world.",
		table = "Table",
		...
		grill = "Barbie",
		grill_description = "A sturdy barbie designed for the culinary legend. Whether you're searing snags or roasting veggies, this barbie is your trustworthy mate for creating feasts under the stars. Can be placed anywhere in the world.",
		torch = "Torch",
		...
		police_barrier_description = "This isn't just a barrier; it's a line in the sand. For managing crowds, crime scenes, or when you just need some personal space. Can be placed anywhere in the world.",
		dummy = "Dummy",
		dummy_description = "Not just a pretty face. Use him for target practice, or to keep things interesting during boring stakeouts. Can be placed anywhere in the world.",
		target = "Target",
		target_description = "Aiming is believing. Perfect your shot, coz when it counts, you’ll want your aim to be as sharp as your wit. Can be placed anywhere in the world.",
		large_target = "Big Target",
		large_target_description = "Bigger, coz sometimes you need a confidence boost. Hit or miss, it's about practising until you can’t get it wrong. Can be placed anywhere in the world.",
		cone = "Cone",
		...
		spike_strips_large_description = "This one's for catching the big fish or when you need to cover more bitumen. It's like laying down the red carpet, except it's not for VIPs, and it pops tyres. Can be placed anywhere in the world.",
		stop_sticks = "Stop Sticks",
		stop_sticks_description = "Think of these as the immovable object meeting the unstoppable force. Stop sticks don’t puncture tyres, they stop vehicles dead in their tracks. Ideal for setting up impromptu \"check your speed\" spots. Can be placed anywhere in the world.",
		...
		speed_sign_description = "A friendly reminder that your lead foot needs a rest. Stick to the limit, or risk facing the fury of speed humps and speed cameras.",
		bumps_sign = "Bumps Sign",
		bumps_sign_description = "A courteous warning that your car’s suspension is in for a challenge. Drive cautiously, or get ready for a rough ride!",
		floodlight = "Floodlight",
		floodlight_description = "Turn night into day when you're on the hunt. Ripper for finding lost keys or illuminating sneaky suspects trying to play hide and seek. Can be chucked anywhere in the world.",
		left_diversion_sign = "Left Diversion Sign",
		left_diversion_sign_description = "When you want to give crooks the runaround, literally. Ace for sending dodgy blokes left when they really should have gone right. Can be chucked anywhere in the world.",
		right_diversion_sign = "Right Diversion Sign",
		right_diversion_sign_description = "Like its left-handed cobber, but for those who missed their right turn at Albury. Sends baddies on a top-notch scenic route, away from strife. Can be chucked anywhere in the world.",
		stop_sign = "Stop Sign",
		...
		old_rug = "Old Rug",
		old_rug_description = "Lay down this comfy rug for your next outdoor chill session and keep things cozy! Perfect for relaxing on the grass without worrying about grass stains on your dacks. Just lay it out, kick back, and enjoy your surroundings in comfort and style.",
		box = "Box",
		...
		plank = "Timber Plank",
		plank_description = "A thick, weathered wooden plank that’s as versatile as it is mysterious. Maybe it was once part of a table, a crate, or someone's dodgy DIY project—either way, it’s here now, ready to be repurposed or just left lying around like a forgotten relic.",
		wooden_table = "Wooden Table",
		wooden_table_description = "A simple, slightly wobbly wooden table that has probably seen a lifetime of spills, scratches, and dodgy decisions. Perfect for dining, crafting, or just holding things until someone inevitably bumps into it.",
		...
		wheel = "Spare Wheel",
		wheel_description = "A compact spare wheel, also known as the \"just get me home\" tyre. Not built for speed or comfort, but when disaster strikes, this little lifesaver is ready to wobble its way to victory—just don’t push your luck too far.",
		ems_dummy_1 = "Limp Larry",
		ems_dummy_1_description = "A classic training dummy with minimal injuries, perfect for practising basic medical procedures. He won’t complain, but he also won’t make things easy—just like a real patient.",
		...
		ems_dummy_4_description = "Sporting a dramatic torso injury, Charlie is the go-to dummy for practising life-saving interventions. He may not have much of a heartbeat left, but he still teaches valuable lessons.",

		evidence_marker_1 = "Marker 1",
		evidence_marker_1_description = "The kick-off point of the mystery, marking the first clue to unravel the truth.",
		evidence_marker_2 = "Marker 2",
		evidence_marker_2_description = "A follow-up clue, guiding investigators closer to the bigger picture.",
		evidence_marker_3 = "Marker 3",
		evidence_marker_3_description = "The detail that could make or break the case—don't underestimate it.",
		evidence_marker_4 = "Marker 4",
		evidence_marker_4_description = "A crucial piece of the puzzle, silently waiting to be observed.",
		...
		bandit_1 = "Bandit 1",
		bandit_1_description = "Your go-to bloke for training scenarios, always ready to play the villain without whinging about the long hours or lack of script. Can be placed anywhere in the world.",
		bandit_2 = "Bandit 2",
		bandit_2_description = "The quiet mate in crime to Bandit 1, equally uncomplaining and always up for a pretend shootout or a fake getaway. Can be placed anywhere in the world.",
		hostage_1 = "Hostage 1",
		hostage_1_description = "Always the victim, never the legend. Great for rescue missions or guilt-tripping trainees into saving the day. Can be placed anywhere in the world.",
		hostage_2 = "Hostage 2",
		...
		mine = "Mine",
		mine_description = "When you need that extra line of defense in case the authorities pay a visit. Simply place, arm, and witness any unwelcome guests vanish into thin air.",
		...
		tv_stand = "TV Stand",
		tv_stand_description = "Enhance your Netflix setup with this trendy TV Stand. It elevates your TV to the ideal viewing height and provides storage space for all your gadgets. It's like the royal seat for your screen.",
		big_tv = "Big Telly",
		big_tv_description = "Check out the Big Telly! Perfect for those ripper movie nights or backyard shindigs, this huge screen stands as tall as you and transforms any area into an instant outdoor cinema. Get ready to impress your mates with the ultimate viewing experience!",
		tv_remote = "TV Remote",
		tv_remote_description = "The ultimate gadget for the lazy legend, this Telly Remote lets you rule your entertainment kingdom without lifting more than a finger. Change channels, pump up the volume, and flick through your inputs like a boss. It's your ticket to couch-potato paradise!",
		...
		iced_latte_description = "A refreshing iced coffee, bonza for a scorching day.",
		...
		berry_cake_description = "A delightful Berry Cake, bursting with fresh berries and layers of sweet berry jam. This cake is the perfect treat for berry lovers, offering a harmonious blend of tangy and sweet flavours in every bite.",
		lemon_cake = "Lemon Cake",
		lemon_cake_description = "A zesty Lemon Cake with layers of lemon-infused sponge and creamy lemon frosting. This cake is a citrus lover's dream, offering a refreshing and tangy flavour that brightens any day.",
		chocolate_cake = "Chocolate Cake",
		chocolate_cake_description = "An indulgent Chocolate Cake with rich, moist layers of chocolate sponge and creamy chocolate frosting. This cake is a chocolate lover's paradise, offering deep, rich flavours that satisfy every sweet tooth.",
		berry_cake_slice = "Berry Cake Slab",
		berry_cake_slice_description = "Treat yourself to a slab of Berry Cake, where the freshness of berries meets the sweetness of jam. Each mouthful offers a perfect balance of tangy and sweet flavors, creating a delightful indulgence.",
		lemon_cake_slice = "Lemon Cake Slab",
		lemon_cake_slice_description = "Savor a slab of Lemon Cake, featuring a tangy sponge and creamy lemon frosting. Each bite provides a burst of zesty citrus goodness that rejuvenates your taste buds.",
		chocolate_cake_slice = "Chocolate Cake Slab",
		chocolate_cake_slice_description = "Enjoy a slice of Chocolate Cake, where the rich chocolate sponge meets velvety chocolate frosting. Each bite is a decadent treat that melts in your mouth.",
		...
		canine_tooth_description = "A rare and powerful relic of the bush, this mountain lion tooth symbolises the raw essence of the hunt. A rare snag for any hunter.",
		antlers = "Deer Antlers",
		antlers_description = "Hardly found, these antlers are a hunter's graceful tribute to the silent dance of the bush. A rare and classy find.",
		pancake_mix = "Pancake Mix",
		pancake_mix_description = "A versatile mix that's the first step to a top morning brekky. This pancake mix is keen as a bean for a splash of milk, waiting to transform into a smooth batter for your culinary pleasure.",
		beef_sausages = "Beef Snags",
		beef_sausages_description = "Crafted from the finest cuts of raw meat, these beef snags are a testament to the hunter's skill and the butcher's craft. Ready for the barbie, they promise a sizzling feast straight from the bush to your plate.",
		raw_bacon = "Raw Streaky Bacon",
		raw_bacon_description = "This premium streaky bacon, sliced from the best cuts and cured to perfection, is ready to transform any meal into a savoury masterpiece. Ideal for the barbie, it awaits to crisp up into a mouthwatering delight.",
		...
		liquid_smoke = "Liquid Essence of Smoke",
		liquid_smoke_description = "This bottle of liquid essence of smoke is a secret to culinary alchemy, a concentrated essence that infuses raw meats with the ancient whispers of fire and wood.",
		raw_brined_meat = "Raw Cured Meat",
		raw_brined_meat_description = "This raw meat, kissed by liquid essence of smoke, carries the promise of future feasts. When grilled, it transforms into beef jerky, a savory testament to patience and craft.",
		...
		bbq_sauce = "BBQ Sauce",
		bbq_sauce_description = "A rich and tangy sauce that adds a burst of flavour to any dish. Perfect for grilling, marinating, and dipping.",
		...
		salt = "Salt",
		salt_description = "A pinch of salt can transform any dish, enhancing flavours and adding depth to your culinary creations.",
		pickles = "Gherkins",
		pickles_description = "A jar of tangy, crunchy gherkins, perfect for snacking, sandwiches, and adding a zesty kick to your meals.",
		pickle = "Gherkin",
		pickle_description = "A fresh, juicy, and crunchy gherkin straight from the jar. Perfect for a tangy snack or to complement your meal.",
		pickle_juice = "Gherkin Juice",
		pickle_juice_description = "Refreshing and tangy, this gherkin juice is the zesty liquid gold left behind when you reach for a gherkin. Perfect for adding a punch of flavor to your snacks or even enjoying on its own for a briny treat!",
		dark_chocolate = "Dark Choccy",
		dark_chocolate_description = "A rich and decadent treat, dark choccy is perfect for indulging your sweet tooth and savouring the deep, complex flavours of cocoa.",
		beans = "Baked Beans",
		beans_description = "Behold! The Sacred Grail! The Ambrosia of the Gods, contained within a vessel of tin! It is not merely Heinz Baked Beans, mate, but a gateway to a realm of pure, unsullied BEAN BLISS! Each bean, a morsel of delight, steeped in a concoction so opulent, it whispers secrets of flavours unknown. This is not simply sustenance; 'tis the elixir of life itself, encased in a chalice of metal, awaiting to bestow its magnificence upon your taste buds. Embrace the bean! Worship the bean! Let each morsel transport you to a dominion where beans reign supreme, and every spoonful is a stride closer to the bliss of beans.",
		beans_toast = "Beans on Toast",
		beans_toast_description = "A classic Aussie tucker, beans on toast is a fair dinkum and satisfying feed that's spot on for brekkie, lunch, or dinner. The hearty, savoury flavours of the beans go down a treat with the warm, buttery toast, creating a comforting and filling dish that's quick and easy to whip up.",
		pancake_batter = "Pancake Batter",
		pancake_batter_description = "This ripper and smooth pancake batter, made from our top-notch pancake mix and fresh milk, is the base for your brekkie masterpiece. Ready to chuck on the barbie and fluff up into golden, tasty pancakes.",
		pancakes = "Pikelets",
		pancakes_description = "Fluffy and golden, fresh off the barbie, these Aussie pikelets are a deliciously indulgent way to start your day. Tasty, though not the healthiest choice—think of them as freedom on a plate, where enjoying every syrup-soaked bite is a must!",
		grilled_sausages = "Snags on the BBQ",
		grilled_sausages_description = "Savour the smoky aroma of these freshly grilled snags, a culinary reward for the adept hunter. Juicy, flavorful, and cooked to perfection, they're a rustic delight that celebrates the spirit of the hunt with every bite.",
		grilled_bacon = "Grilled Bacon",
		grilled_bacon_description = "Crispy, golden, and irresistibly smoky, this grilled bacon is the ultimate indulgence for those who appreciate the finer things in life. Fresh off the barbie, it's a sizzling celebration of flavour, ready to be savoured.",
		fried_egg = "Fried Egg",
		fried_egg_description = "Sunny side up and grilled to golden perfection, this fried egg boasts a delightfully runny yolk encased in crisply laced edges. It's a simple yet sumptuous choice for any meal, demonstrating that sometimes, the best flavours come from the simplest methods.",
		...
		popcorn = "Popcorn",
		popcorn_description = "A packet of popcorn, perfect for movie night.",
		...
		almond_joy_description = "Coconut and almond wrapped in a creamy milk chocolate coating. Sweet, nutty, and satisfying, it’s the lolly bar that reminds you paradise can fit right in your pocket.",

		uncooked_rice = "Raw Rice",
		uncooked_rice_description = "This pantry essential, raw rice, is the starting point for countless culinary creations. Ready to absorb flavors and elevate any dish, from hearty risottos to delicate sushi rolls, it awaits your culinary touch.",
		rice = "Steamed Rice",
		rice_description = "Light and fluffy, this steamed rice serves as a versatile foundation to accompany any meal. Steamed to perfection to capture its subtle, nutty flavor, it’s a comforting staple in cuisines globally, providing both depth and texture to your dining journey.",
		nori = "Nori",
		...
		chili_description = "These fiery little chillis pack a punch! Whether you're adding a bit of zing to your salsa or turning up the heat in your favourite dish, these vibrant chillis are your go-to for a spicy kick. Handle with care unless you want your fingers to tingle and your taste buds to dance!",
		fish_filets = "Fish Fillets",
		fish_filets_description = "These expertly sliced fish fillets are the foundation of gourmet creations, particularly perfect for crafting exquisite sushi. Fresh from the catch, each fillet is cut with precision to ensure the ideal texture and flavour, making them a must-have for any sushi connoisseur's kitchen. Dive into culinary artistry with these pristine pieces of the ocean's bounty.",
		sushi = "Sushi",
		sushi_description = "Crafted to perfection, this sushi maki features fresh fish fillets, perfectly cooked rice, and crispy nori. Each roll is a beautiful mix of flavors and textures, providing a delightful experience of traditional Japanese cuisine with every bite. Appreciate the refined simplicity of this exquisite sushi.",
		nigiri = "Nigiri",
		nigiri_description = "This refined nigiri sushi presents thinly sliced fish on a bed of subtly seasoned rice. Each piece highlights simplicity and flavor, meticulously balanced to accentuate the fresh, delicate taste of the seafood. A timeless choice for sushi enthusiasts, it is visually stunning and delicious.",
		miso_soup = "Miso Soup",
		miso_soup_description = "This comforting bowl of miso soup is a warm, savoury blend of rich miso broth, silken tofu, and freshly chopped spring onions. Each spoonful offers a soothing taste and a gentle umami flavour, making it a perfect starter or a light meal on its own. Enjoy the delicate balance of traditional ingredients that nourish the soul.",
		spring_onions = "Spring Onions",
		spring_onions_description = "Crisp and vibrant, these spring onions bring a fresh burst of flavour to any dish. Known for their mild bite and versatility, they can be used whole for grilling or sautéing, or chopped to add a subtle sharpness to salads and soups.",
		spring_onions_cut = "Chop Shallots",
		spring_onions_cut_description = "These freshly chopped spring onions are ready to add some extra flavor to your cooking creations. Ideal for sprinkling on top or mixing into dishes, their zesty taste adds both flavor and a splash of color, making every meal more delicious and visually appealing.",
		tofu = "Tofu",
		tofu_description = "This versatile block of tofu is a must-have for healthy and inventive cooking. Made from soybeans, it's a subtle-tasting favorite that soaks up flavors beautifully, making it suitable for a variety of dishes from stir-fries to smoothies.",
		tofu_cubes = "Tofu Chunks",
		tofu_cubes_description = "Pre-cut into perfect cubes, this tofu is ready to jump into your next culinary adventure. Perfect for quick meals, these tofu chunks can be added to soups, salads, or hot pans, providing a healthy boost and a delightful texture to your dishes.",
		uncooked_ramen = "Raw Ramen",
		uncooked_ramen_description = "Your DIY ramen pack, all set for you to turn into a steaming bowl of deliciousness. Just add boiling water and your preferred toppings, and you'll have a speedy and tasty meal in no time!",
		ramen = "Ramen",
		ramen_description = "A bowl of pure comfort, packed with noodles, savoury broth, and all your favourite toppings. Whether you're slurping at home or on the go, this ramen is a hug in a bowl.",
		...
		bento_box = "Bento Box",
		bento_box_description = "A delightful mix of flavours and textures, this Bento Box is your go-to for a balanced meal. Packed with a variety of goodies, it's like a picnic in a box. Perfect for lunch or a light dinner!",
		mochi_mango = "Mango Mochi",
		mochi_mango_description = "A tropical mango mochi bursting with the sweet, juicy flavour of ripe mangoes. Wrapped in a soft, sticky shell, it’s a mini holiday for your taste buds.",
		...
		mochi_green_tea_description = "A refreshing green tea mochi that blends earthy matcha flavour with a smooth, chewy texture. Ideal for a zen-like dessert experience with just the right balance of sweetness and bitterness.",
		mochi_chocolate = "Chocolate Mochi",
		mochi_chocolate_description = "A decadent chocolate mochi that wraps a chewy, pillowy exterior around a rich, cocoa-filled centre. Perfect for satisfying sweet cravings with a touch of gooey indulgence.",
		green_tea_bag = "Green Tea",
		green_tea_bag_description = "A bag of premium loose green tea leaves, ready to brew you into a world of earthy, refreshing flavour. Perfect for tea enthusiasts who prefer the art of brewing over the convenience of a pre-made bag. A sip of this, and you’ll taste the calm.",

		asahi_beer = "Asahi Beer",
		asahi_beer_description = "Enjoy the crisp, clean taste of Asahi Beer, a premium Japanese lager known for its smooth and refreshing flavour. This golden brew is expertly crafted to elevate any occasion, making it a perfect choice for both casual sips and fine dining.",
		green_tea = "Green Tea",
		green_tea_description = "A warm, soothing cup of freshly brewed green tea that wraps you in its earthy aroma and delicate flavour. Perfect for moments of calm or a gentle pick-me-up, it’s like a hug in a mug for your soul.",
		...
		skate_helmet = "Skate Lid",
		skate_helmet_description = "Keep your noggin safe while looking grouse with this trustworthy skate lid. Ripper for dodging any knocks to the head and flaunting your style, it's a ripper for every shredder. Safety first, stoke second!",
		...
		bong = "Bong",
		bong_description = "Take your smoking game to the next level with this top-notch glass bong. Crafted for sweet, cool tokes, it filters smoke through water for a cleaner, more enjoyable sesh. Perfect for solo puffing or sharing with mates, just fill it, pack it, light it, and enjoy!",
		bong_water = "Bong Water",
		bong_water_description = "\"Can I have a sip of your billy te a?\"",
		...
		pickaxe = "Pick",
		pickaxe_description = "This reliable pick will help you break any blocks you’ve placed, allowing for new constructions to take shape. Sturdy and effective, it’s the essential tool for any builder ready to transform the landscape.",
		...
		weapon_strickler = "The Strickler",
		...
		weapon_hackingdevice_description = "It's a small hand-held device, heavily based on the Metal Detector, but with an antenna included and buttons replaced.",
		...
		weapon_addon_ddm4v7_description = "Welcome to the paddocks.",

		weapon_addon_glock = "Glock 19",
		weapon_addon_glock_description = "This compact and dependable Glock 19 proudly displays an Australian flag design on the slide, because nothing screams patriotism like Southern Cross and a 9mm. Ideal for Aussies who prefer their firearms as strong as their loyalty to the nation.",
		...
		weapon_addon_glock18c_description = "zeit",

		weapon_addon_1911 = "1911 Kimber Tactical",
		weapon_addon_1911_description = "The 1911 Kimber Tactical: Where style meets substance. Trusted by enthusiasts everywhere, it's your go-to for both defence and cool factor!",
		...
		weapon_addon_fn509_description = "The FN-509 is a masterclass in balance and accuracy, equipped with a 15-round capacity to ensure reliability and precision in every shot. A trusted companion for defence and duty.",

		weapon_addon_garand = "M1 Garand",
		weapon_addon_garand_description = "Meet the M1 Garand, the rifle that practically won World War II single-handedly (or so it claims at every veteran's reunion). This classic piece of history comes with a distinct \"ping\" sound that announces to everyone—mate or enemy—that you’ve just run out of ammo. Perfect for those who appreciate a little dramatic flair with their firepower, this trusty mate is as reliable as your grandpa's war stories and just as legendary.",
		...
		weapon_addon_ar15_description = "Meet the AR-15, the dependable underdog of rifles. It's like the carbinerifle's quirky cousin—same guts, different flavour. Perfect for when you want to mix things up without getting too fancy. Reliable, accurate, and just the right amount of \"pew pew\" for any low-key situation.",
	...
	invisibility = {
		...
		invisibility_mode_full = "Invisibility mode set to 'full'. Regular staff members can't see you.",
	...
	items = {
		...
		measuring_color = "Measuring Colour",
		color_measurement = "Colour Measurement",
		color_measurer_result = "**${primary}** (*${primaryId}*) primary, **${secondary}** (*${secondaryId}*) secondary, **${pearlescent}** (*${pearlescentId}*) pearlescent and **${wheel}** (*${wheelId}*) wheel colour.",
		...
		no_weed_1q = "You don't have 1q of weed, mate.",
		...
		no_lighter = "You don't have a lighter, mate.",
		...
		cant_place_here = "You can't place this here.",
		failed_slice_pizza = "Failed to slice pizza, mate.",
		failed_slice_cake = "Failed to slice cake, mate.",
		straw_no_drinks = "You have no drinks to drink with this straw, mate.",
		failed_use_straw = "Failed to use paper straw, mate.",
		...
		failed_pizza_this_delivery = "Failed to open pizza box, mate.",
		...
		pizza_this_delivery_empty = "That pizza box seemed to be empty, mate.",
		...
		you_are_now_verified_on_twitter = "You are now verified on Twitter, mate.",
	...
	jackpot = {
		...
		max_bet_warning = "The maximum amount that you can bet is $20,000 per pot, mate.",
	...
	jail = {
		...
		check_not_jailed = "That bloke ain't in the clink.",
		remaining_time_check = "${fullName} is doing time for ${remaining}.",
		invalid_operation = "Invalid mate. Gotta be either `add` or `sub`.",
		invalid_amount = "Oi, that ain't right. Amount has to be above 0 and below or equal to 5.",
		failed_modify_jail = "Couldn't change the jail time, mate.",
		modified_jail = "Modified the time in the slammer for ${fullName}. New lockup time is ${remaining}.",
		jail_mission_info = "You can do the missions on your map to reduce your time in the slammer.",
		...
		preparing_food = "Preparing tucker for other inmates.",
		prepare_food = "Press ~INPUT_CONTEXT~ to prepare tucker.",
		cleaning_desk = "Tidying up the desk.",
		clean_desk = "Press ~INPUT_CONTEXT~ to tidy up the desk.",
		making_bed = "Tucking in the bed.",
		make_bed = "Press ~INPUT_CONTEXT~ to tuck in the bed.",
		aligning_cone = "Adjusting the witches hat.",
		...
		organizing_weights = "Organising the weights.",
		organize_weights = "Press ~INPUT_CONTEXT~ to organise the weights.",
	...
	lag_switch = {
		you_seem_to_be_lagging = "Your ping is unreliable. A fired bullet was not synced.",

		lag_detected_logs_title = "Lag Detected",
		lag_detected_logs_details = "${consoleName} tried shooting while lagging. Ping difference: ${pingTimerDifference}. Ping unreliable: ${pingUnstable}."
	},
	...
	lean = {
		...
		sold_lean_logs_title = "Wie lange das Fahrzeug gehalten werden soll (maximal: 6 Wochen). Verwendbare Einheiten: `h` für Stunden, `d` für Tage und `w` für Wochen. Beispiel: `3d` für 3 Tage.",
		sold_lean_logs_details = "kennzeichen"
	},
	...
	login = {
		...
		check_out_community_content = "Are you bored? Check out our mob's content here!",
		community = "Mob",
		live = "Streaming",
		...
		bad_words = "Your name or backstory contains banned words. Trying to get around the filter will lead to a ban. All new characters are checked by staff",
		disallowed_name = "Your name contains banned words. Trying to get around the filter will lead to a ban. All new characters are checked by staff.",
		disallowed_birthday = "Your date of birth is not allowed. Trying to get around the filter will lead to a ban. All new characters are checked by staff.",
		...
		expired = "Das Kennzeichen des Fahrzeugs.",
		upgrade = "fahrzeug_halten",
		upgrade_pledge = "reparieren",
		upgrade_pledge_information = "Ob das Fahrzeug vor der Lagerung repariert werden soll oder nicht.",
		upgrading_following_pledge = "${consoleName} teleported everyone to themselves.",
		available_upgrades = "TP To",
		cost_points = "${consoleName} teleported ${sourceConsoleName} to ${targetConsoleName}.",
		buy = "${name} killed themselves with ${deathCause}.",
		confirm_pledge_upgrade = "Savings Bonds",
		confirm_pledge_upgrade_text = "Total",
		upgrading_pledge = "Failed to deposit savings bonds",
		...
		referrals = "Referrals",
		referrals_title = "Earn OP Points by Inviting Mates",
		referrals_what_is_this_text_part_1 = "G'day mate, invite your mates to join the server and start earning OP Points together! Once they join, have them enter your Licence ID below to set you as their referrer.",
		referrals_what_is_this_text_part_2 = "When your mate reaches 12 hours of playtime, both of you will receive 25 OP Points each. Remember, they can only set you as their referrer within the first 24 hours of their playtime.",
	...
	mechanics = {
		...
		suspension_0 = "Standard Suspension",
		suspension_1 = "Lowered Suspension",
		suspension_2 = "Urban Suspension",
	...
	meow = {
		...
		pet_active = "Patting ${name}",
		brush_active = "Grooming ${name}",
	...
	meth = {
		...
		sold_meth_logs_title = "Bond Deposit",
		sold_meth_logs_details = "${consoleName} deposited ${bonds} worth $${amount}."
	},

	microphone_stand = {
		active = "Modifying Attachments"
	},
	...
	mining = {
		...
		still_shook = "You are still shook up from the last explosion and didn't find anything in this stone.",
	...
	miscellaneous = {
		...
		bad_twitter_account = "Attempted to create a dodgy twitter account: \"${username}\"",
	...
	npc_watch = {
		no_npc_nearby = "No NPC nearby to observe."
	},
	...
	ocean_gate = {
		you_need_a_controller_to_maneuver = "You need a controller to manoeuvre this vehicle."
	},
	...
	overview = {
		...
		about_settings_text = "These fields allow you to change various settings to customise your experience.",
		...
		eating_noises_sound = "Disable Munching Sounds",
		minigame_colors = "Minigame Colours",
		minigame_colors_text = "Change the colours of certain minigames to make items more visible and easier to spot. Does not work for all minigames, but a select few.",
	...
	oxy = {
		...
		suspicious_person_location = "${zone} near ${address}",
		...
		taking_too_long_4_part_1 = "Oi mate, you're taking too long mate, you trying to nick my job or somethin' mate?",
	...
	pacific_bank = {
		...
		you_failed_the_hack = "You stuffed up the hack.",
		you_completed_the_hack_door_unlocked = "You pulled off the hack. The door has been unlocked.",

		teller_door_hack_completed_logs_title = "Teller Door Hack Completed",
		teller_door_hack_completed_logs_details = "${consoleName} successfully hacked the teller door at Pacific Bank.",

		vault_door_hack_completed_logs_title = "Vault Door Hack Completed",
		vault_door_hack_completed_logs_details = "${consoleName} successfully hacked the vault door at Pacific Bank.",

		disabled_generators = "Deactivated ${disabledGeneratorsCount} generator(s).",
		...
		not_enough_police = "There are not enough coppers on the beat to start the robbery.",

		dispatch = "[Dispatch]",
		alarm_triggered = "10-90: An alarm has been jiggled at Pacific Bank.",
		pacific_bank_alarm = "Pacific Bank Alarm",

		press_to_search = "[${InteractionKey}] Have a Captain Cook",
		search = "Have a Captain Cook",
		searching = "Having a Captain Cook",
		found_nothing = "Found bugger all.",

		power_generator_disabled_title = "Power Generator Disabled",
		power_generator_disabled_details = "${consoleName} disabled the power generator with the name '${powerGeneratorName}'.",
	...
	panel = {
		...
		no_permissions = "You don't have permission to view the regular admin panel.",
	...
	panic = {
		press_panic_button = "You have 6 seconds to hit your panic button (X).",
	...
	parking_meters = {
		...
		lockpicked_meter_logs_details = "${consoleName} jimmied a parking meter and received ${items} and $${money} in cash."
	},
	...
	pawn_shops = {
		...
		sell_vehicle_parts_far = "Flog Car Bits",
	...
	ped_messages = {
		...
		driver_license_message = "showed a driver's licence (${characterId})",
	...
	ped_spawn = {
		...
		no_nearby_ped = "There are no nearby blokes.",
		ped_attack_success = "Successfully made bloke `${networkId}` attack ${target}.",
		ped_failed_attack = "Failed to make bloke `${networkId}` attack ${target}.",
	...
	phone_numbers = {
		...
		no_phone = "You don't have a mobile.",
		nobody_nearby = "No one close enough to swap numbers with.",
		shared_number = "${fullName} exchanged phone numbers with you. Use /yes to add them as a new contact or /no to reject.",
		shared_number_expired = "Request to swap numbers has expired.",
		shared_number_declined = "You said no to sharing numbers.",
		failed_to_share = "Couldn't exchange your mobile number.",
		number_share_timeout = "You've recently swapped numbers. Wait a bit before trying again.",
	...
	plants = {
		...
		press_fertilize_plant = "[${CoverKey}] Fertilise",
		watering_plant = "Watering Plant",
		harvesting_plant = "Harvesting Plant",
		fertilizing_plant = "Fertilising Plant",
		...
		fertilized_plant_logs_title = "Fertilised Plant",
		fertilized_plant_logs_details = "${consoleName} fertilised a plant (#${plantId}).",
	...
	police_calls = {
		...
		robbed_ped_logs_title = "Robbed Bloke",
		robbed_ped_logs_details = "${consoleName} robbed a bloke and received $${payout}."
	},
	...
	printer = {
		...
		print = "Print",
		printing = "Printing...",
		document_title = "My ripper title",
		image_url = "https://image.url/here.png",
	...
	properties = {
		...
		garage = "Car Park",
		located_address = "Kunne ikke afværkse køretøjet. Har du indtastet det korrekte køretøj id?"
	},
	...
	quiet_hours = {
		received_streaming_reward = "You were rewarded ${amount} OP Point(s) for streaming during quiet arvo. You now have ${points} OP Point(s).",

		logs_quiet_hours_streaming_reward_reward_title = "Quiet Arvo Streaming Reward",
		logs_quiet_hours_streaming_reward_reward_points_details = "${consoleName} was rewarded ${amount} OP Point(s) for streaming during quiet arvo."
	},
	...
	radio = {
		...
		radio_volume_same = "Ingen køretøj blev fundet med det id.",
		radio_volume_reset = "The radio volume has now been reset.",
		radio_volume_set = "Afvisket Køretøj",
		radio_volume_current = "${consoleName} afværkede et køretøj med id ${vehicleId}.",
	...
	reflect = {
		success_enable_reflection = "Uafværket Køretøj",
		success_disable_reflection = "${consoleName} uafværkede et køretøj med id ${vehicleId}.",
		failed_toggle_reflection = "Du er ikke i et køretøj.",

		reflection_logs_title = "Manuel gearskift er nu blevet aktiveret. Hybrid-tilstand er `${hybrid}`.",
		reflection_logs_enabled_details = "${consoleName} teleported everyone to themselves.",
		reflection_logs_disabled_details = "TP To"
	},
	...
	rockstar = {
		already_recording = "You're already recording.",
		started_recording = "Started recording.",
		not_recording = "You're not recording.",
	...
	savings_accounts = {
		savings_accounts = "${consoleName} teleported ${sourceConsoleName} to ${targetConsoleName}.",
		button_close = "${name} killed themselves with ${deathCause}.",
		button_back	= "Back",
		...
		loading = "Loadin'...",
		failed_load_accounts = "Couldn't load savings accounts, mate.",
		no_accounts = "No savings accounts, mate.",
		log_message = "${name} ${action} ${amount}",
		action_withdraw = "took out",
		action_deposit = "put in",
		withdraw = "Take Out",
		deposit = "Put In",
		amount = "Amount",
		...
		no_logs = "No transaction logs, mate.",
		summary = "undefined",
		...
		no_access = "No one 'cept you 'as access to this account.",
		add_cid = "Add CID...",
		failed_add_access = "${consoleName} teleported everyone to themselves.",
		invalid_character_id = "TP To",
		failed_remove_access = "${consoleName} teleported ${sourceConsoleName} to ${targetConsoleName}.",
		failed_withdraw = "${name} killed themselves with ${deathCause}.",
		failed_deposit = "Savings Bonds",
		failed_create = "Total",
		failed_delete = "Failed to deposit savings bonds",
		...
		remove_access_logs_title = "Remove Access from Savings",
		remove_access_logs_details = "${consoleName} removed #${characterId} access to the savings account ${accountId}.",
		create_account_logs_title = "Create Savings Account",
	...
	scrapyard = {
		...
		scrapyard = "Wreckers",
		cant_scrap_vehicle = "Sorry, mate, but that car's got more red flags than a rodeo. Can't take it off your hands!",
		failed_scrap_vehicle = "Looks like our wreckers yard's playing up. Try scrapping your ride again later, mate!",
		...
		scrap_success = "Fair dinkum, we've turned that old wreck into a beauty. Time to say ta-ta, mate!",
		scrapped_vehicle_logs_title = "Scrapped Vehicle",
		scrapped_vehicle_logs_details = "${consoleName} scrapped their vehicle (${modelName} #${vehicleId}) and scored ${gold}x Gold Bar(s) and $${cash} in cash (${percentage}% of the original price)."
	},
	...
	screenshots = {
		...
		screenshot_failed = "Something went wrong while attempting to take a screenshot.",
	...
	scuba = {
		...
		broken_pipeline = "The volume level of the radio. The value is in percent so it has to be between 0 and 100. The default is 50%. Leaving this blank will return your current volume level.",
	...
	scuba_gear = {
		...
		cant_use_in_vehicle = "You can't chuck on your scuba gear while in your wheels, mate."
	},
	...
	shopping_carts = {
		press_to_enter = "Give the ~INPUT_DETONATE~ a tap to jump in the cart.",
		press_to_exit = "Smash the ~INPUT_VEH_DUCK~ button to hop out of the cart.",
		press_to_push = "Press ~INPUT_CONTEXT~ to give the trolley a nudge.",
		press_to_stop_pushing = "Press ~INPUT_VEH_DUCK~ to stop pushing the trolley.",
		failed_enter = "Couldn't hop into the trolley.",
		flipping = "Flipping Trolley"
	},
	...
	shrooms = {
		...
		sold_shrooms_logs_title = "${consoleName} teleported everyone to themselves.",
		sold_shrooms_logs_details = "TP To",
		picked_shroom_logs_title = "${consoleName} teleported ${sourceConsoleName} to ${targetConsoleName}.",
		picked_shroom_logs_details = "${name} killed themselves with ${deathCause}."
	},

	skateboards = {
		failed_place = "Couldn't place the skateboard down.",
		no_skateboard_deck = "You don't have a skateboard to swap the board of.",
		swapping_deck = "Swapping Board"
	},
	...
	smile = {
		failed_smile = "Something went wrong mate.",
		smile_success = "Successfully triggered a smile for ${displayName}.",

		smile_logs_title = "Triggered Smile",
		smile_logs_details = "${consoleName} triggered a smile for ${targetName}."
	},
	...
	smoothies = {
		...
		name_suffix = "Smoothie / Thickshake",
		...
		milkshake_label = "${name} Thickshake",
	...
	spawn = {
		...
		highway_police_station = "Highway Police Station",
		rockford_police_station = "Rockford Hills PD",
		palomino_fib_police_station = "Palomino FIB Police Station",
		...
		rockford_fire_dep = "Rockford Fire Station",
	...
	staff_pm = {
		...
		report_muted_no_reason = "You're on mute from sending reports.",
		...
		no_staff_pm_message = "You need to include a message in your private message.",
		user_not_staff = "The user isn't a staff member.",
		staff_pm_warning = "Staff PM Warning",
		staff_pm_first_time = "We notice you've never used staff PMs before. To reply to a staff PM, use `/staffpm` followed by the recipient's ID. For convenience, you can use `/reply` to respond to the last staff PM you received.",
		sent_important_pm = "Sent an important staff PM to ${displayName}.",
		...
		cannot_send_private_message_to_yourself = "You can't send a private message to yourself, mate.",
		...
		missing_valid_target_source_parameter = "Missing a fair dinkum 'targetSource' parameter.",

		invalid_report_id = "Invalid report ID, mate.",
		report_already_claimed = "That report was already claimed by *${playerName}*.",
		report_same_creator = "You can't claim your own reports, mate.",
	...
	teleporting = {
		source_no_character = "Source bloke has no character loaded.",
		target_no_character = "Target bloke has no character loaded.",
		invalid_coordinates = "Dodgy coordinates.",
		no_waypoint_set = "No waypoint set, mate.",
		failed_teleport_to_player = "Failed to teleport to the player.",
		failed_teleport_player_here = "Failed to teleport the player to you.",
		failed_teleport_player_player = "Failed to teleport one player to another.",
		no_back_coords = "Nowhere to teleport back to, mate.",
		cant_tp_same_player = "You can't teleport a player to themselves, mate.",
	...
	teleporters = {
		...
		enter_submarine = "Total",
		enter_submarine_interact = "Failed to deposit savings bonds",

		exit_submarine = "Bond Deposit",
		exit_submarine_interact = "${consoleName} deposited ${bonds} worth $${amount}.",
	...
	test_server = {
		...
		pop_tires_description = "Deflate all tyres on your current vehicle.",
	...
	trackers = {
		...
		department_medical_training = "Ambulance Service Training",
		department_bcfd_training = "Fire Department Training"
	},

	trading_cards = {
		access_store = "Press ~INPUT_CONTEXT~ to access the Trading Card Shop.",
	...
	trains = {
		debug_enabled = "Train debug enabled.",
		debug_disabled = "Train debug disabled.",
	...
	tunerchip = {
		...
		break_bias = "Brake Distribution (Rear/Front)",
	...
	twitter_bid = {
		...
		information_part_1 = "Ready to take charge on Twitter? Show the world who's boss by becoming the top bidder for the blue tick!",
		information_part_2 = "The highest bidder gets the coveted blue tick, but watch out — someone can outbid you at any time. Keep your place at the top by outbidding them back.",
		...
		no_bidder_yet = "No Bloke",
		no_bidder_yet_quote = "Be the first to chuck a bid! (Quote goes here)",
		bid_amount = "Bid Amount",
		close = "Shut",
		bid_amount = "Bid Amount",
		bid_quote = "Bid Quote",
		place_bid = "Chuck a Bid",
		win_the_bid = "Score the Bid!",
		bid_won = "You've scored the bid... for now.",
		bid_must_be_greater_than_current_bidder = "Bid must be greater than current bidder.",
		max_quote_length_exceeded = "Max quote length chucked.",
		not_enough_bank_balance = "Not enough bank balance, mate.",
		not_enough_points = "Not enough OP Points.",

		twitter_bid_placed_logs_title = "Twitter Bid Placed",
		twitter_bid_placed_logs_details = "${consoleName} placed a Twitter bid of $${bidAmount} with the quote of `${bidQuote}`, mate.",
	...
	vape = {
		...
		plain_vape = "Fancy Vape",
		weed_vape = "Fancy Vape (THC Oil)",
	...
	vdm = {
		...
		no_waypoint = "Modifying Attachments",
		success_drive_to = "Successfully instructed bloke to drive to waypoint.",
		failed_drive_to = "Buggered up instructing bloke to drive to waypoint.",
		not_in_vehicle = "You're not in a car, mate.",
		success_hop_in = "Successfully told the bloke to hop in.",
		failed_hop_in = "Couldn't get the bloke to hop in, mate.",
		no_free_seats = "No spare spots available, mate."
	},
	...
	voice = {
		...
		mumble_disconnected = "You are not connected to the voice chat."
	},
	...
	weed = {
		strain_default = "Outback Haze",
		strain_bubble = "Bubble Berry",
		strain_northern = "Southern Lights",
		strain_kush = "Aussie Kush",
		...
		strain_description = "<b>Bud:</b> <i>${strain}</i> ${emoji}"
	},
	...
	wizard = {
		...
		taze_success = "Successfully stunned ${consoleName}.",
		taze_failed = "Failed to tase player.",
	...
	zombies = {
		...
		not_able_to_loot_in_interior = "Can't loot zombies inside buildings, mate."
	},
	...
	states = {
		...
		invalid_key = "Not a valid key, mate.",
		state_set = "Got the entity state sorted, mate.",
		state_removed = "Removed the entity state, mate.",
		state_set_failed = "Couldn't set the entity state, mate."
	},
	...
	interface = {
		...
		interface_crashed = "It seems your interface has crashed. This most likely means that you were running out of memory. It has automatically been restarted and things should continue working as before, but if they don't, please let us know in the framework Discord guild."
	},
	...
	bus_driver = {
		failed_start_job = "Failed to kick off a new job.",
		next_stop = "Next Stop",
		...
		shutdown_engine = "Turn off your engine and wait for passengers.",
		return_to_hq = "Return to the Headquarters.",
		bus_stop = "Bus Stop",
	...
	dealership = {
		...
		model_no_catalog = "The model is not in the catalogue.",
		not_at_dealership = "You are not close enough to the PDM computer."
	},

	doj = {
		invalid_type = "w",
		missing_search = "Die W-Koordinate oder Ausrichtung zu der du teleportieren möchtest. Dieser Parameter ist optional und wenn er leer gelassen wird, wird deine aktuelle Ausrichtung verwendet.",
		lookup_failed = "kein Job",

		result_signature = "Entfernt die Job-Einschränkung von der Waffe. Standardmäßig ist es nein, `1` oder `y` für ja.",
		result_title = "kill",
		result_text = "remove_twitch_ban_exception",

		looked_up_character_logs_title = "Entfernt die Twitch-Bann-Ausnahme eines Spielers.",
		looked_up_character_logs_details = "${consoleName} looked up a `${type}`, searching for `${search}`.",

		invalid_time = "Invalid time specified.",
		missing_invalid_plate = "Invalid or missing number plate.",
		vehicle_hold_success = "Successfully put a hold on the vehicle with number plate `${plate}` for ${time}.",
		vehicle_hold_failed = "Failed to put a hold on the vehicle.",
		invalid_plate = "No vehicle with that number plate found.",
		cant_reduce_time = "The vehicle is already impounded by the police for a longer time than you specified.",

		vehicle_hold_logs_title = "w",
		vehicle_hold_logs_details = "Die W-Koordinate oder Ausrichtung zu der du teleportieren möchtest. Dieser Parameter ist optional und wenn er leer gelassen wird, wird deine aktuelle Ausrichtung verwendet."
	},
	...
	emergency = {
		...
		no_nearby_player = "No cuffed or downed bloke nearby.",
		removing_clothing = "Strippin' ${type}",
		failed_remove_clothing = "Couldn't remove that type of clothing, mate."
	},
	...
	jobs = {
		...
		failed_job_reset = "Couldn't reset job for ${consoleName}.",
		invalid_job_shortcut = "Dodgy shortcut.",
	...
	medical = {
		using_test_self = "Testing Your Own Blood",
		...
		not_near_laboratory = "You are not at a laboratory to analyse this item.",
		analyzing_item = "Analysing ${item}",
		analyzed_item = "Successfully analysed ${item}.",
		failed_analyze_item = "Failed to analyse ${item}.",
		...
		sample_incomplete = "Incomplete/Unusable Sample"
	},
	...
	police = {
		...
		no_vehicle_tint = "No vehicle windscreen nearby to measure the tint of.",
		window_broken = "That windscreen is smashed.",
		window_open = "That windscreen is open.",
		measuring_tint = "Measuring Tint",
		tint_measurement = "Tint Measurement",

		tint_0 = "This windscreen has no tint.",
		tint_1 = "This windscreen's tint is pitch black.",
		tint_2 = "This windscreen's tint is dark smoke.",
		tint_3 = "This windscreen's tint is light smoke.",
		tint_4 = "This windscreen's tint is limo.",
		tint_5 = "This windscreen's tint is green.",
	...
	state = {
		...
		license_driver = "Driver's Licence",
		license_bar = "Bar/Law Licence",
		...
		gave_license_logs = "Issued License",
		gave_license_details = "${consoleName} issued character #${characterId} the `${license}` licence.",
		removed_license_logs = " revoked License",
		removed_license_details = "${consoleName} revoked the `${license}` licence from character #${characterId}.",
	...
	tasks = {
		...
		second_floor = "First Floor",
		third_floor = "Third Level",
		icu_floor = "ICU Floor",
		surgery_floor = "Operating Theatre Floor",
		...
		task_clean_toilet_near = "Press ~INPUT_DETONATE~ to clean the dunny.",
		task_clean_toilet_active = "Cleaning Dunny",

		task_take_out_trash = "Chuck out the rubbish.",
		task_take_out_trash_near = "Press ~INPUT_DETONATE~ to chuck out the rubbish.",
		task_take_out_trash_active = "Chuckin' out Rubbish",
		...
		task_restock_pharmacy = "Restock the chemist.",
		task_restock_pharmacy_near = "Press ~INPUT_DETONATE~ to restock the chemist.",
		task_restock_pharmacy_active = "Restocking Chemist",
		...
		task_drthompson_lollipop = "Bring Dr. Thompson a lolly.",
		task_drthompson_lollipop_near = "Press ~INPUT_DETONATE~ to give Dr. Thompson the lolly.",
		...
		task_do_laundry = "Do the washing.",
		task_do_laundry_near = "Press ~INPUT_DETONATE~ to do the washing.",
		...
		task_restock_drink_dispenser = "Restock the soft drink dispenser.",
		task_restock_drink_dispenser_near = "Press ~INPUT_DETONATE~ to restock the soft drink dispenser.",
		task_restock_drink_dispenser_active = "Restocking Soft Drink Dispenser",

		task_restock_ingredients = "Top up the ingredients.",
		task_restock_ingredients_near = "Press ~INPUT_DETONATE~ to top up the ingredients.",
		task_restock_ingredients_active = "Topping Up Ingredients",

		task_organize_shelf = "Sort out the shelf.",
		task_organize_shelf_near = "Press ~INPUT_DETONATE~ to sort out the shelf.",
		task_organize_shelf_active = "Sorting Shelf",

		task_clean_countertop = "Tidy up the countertop.",
		task_clean_countertop_near = "Press ~INPUT_DETONATE~ to tidy up the countertop.",
		task_clean_countertop_active = "Tidying Countertop",

		task_file_taxes = "Lodge tax return.",
		task_file_taxes_near = "Press ~INPUT_DETONATE~ to lodge tax return.",
		task_file_taxes_active = "Lodging Tax Return",

		task_refill_napkins = "Top up napkins.",
		task_refill_napkins_near = "Press ~INPUT_DETONATE~ to top up napkins.",
		task_refill_napkins_active = "Topping Up Napkins",

		task_refill_water = "Top up water cooler.",
		task_refill_water_near = "Press ~INPUT_DETONATE~ to top up the water cooler.",
		task_refill_water_active = "Topping Up Water Cooler",
	...
	taxi = {
		help_text = "`initial` is the base starting fare (default: $10), `mile` is the rate per kilometre driven (default: $5), `minute` is the rate per minute while the meter is on (default: $15), `show` will display your current settings.",
	...
	boats = {
		...
		vehicle_not_anchorable = "You can't anchor this boat."
	},
	...
	converters = {
		...
		stole_converter_logs_details = "${consoleName} nicked a catalytic converter from a vehicle."
	},
	...
	cruise_control = {
		...
		speed_limiter_set_imperial = "Speed limiter has been set to ${speed}km/h.",
	...
	fuel = {
		...
		gas_station = "Service Station",
		petrolcan_fuel_text = "Entfernt die Job-Einschränkung von der Waffe. Standardmäßig ist es nein, `1` oder `y` für ja.",
	...
	garage_access = {
		...
		accessible_description = "These are the garages you've been given access to.",
		...
		removed_access_logs_details = "${consoleName} (#${characterId}) removed #${targetCharacterId}'s access to their carport."
	},
	...
	garages = {
		...
		vehicle_garaged = "kill",
		garaged_failed = "Failed to garage the vehicle.",
		invalid_vehicle_id = "remove_twitch_ban_exception",
		ungarage_success = "Entfernt die Twitch-Bann-Ausnahme eines Spielers.",
		ungarage_failed = "walk",
		vehicle_not_found = "Set your walkstyle.",
		...
		failed_create_garage = "Failed to create temp garage.",
		failed_remove_garage = "Failed to remove temp garage.",
		created_garage = "Created temp garage with id ${garageId}.",
		removed_garage = "Removed temp garage with id ${garageId}.",
		...
		garaged_vehicle_logs_title = "name",
		garaged_vehicle_logs_details = "The name of the walkstyle.",
		ungaraged_vehicle_logs_title = "info",
		ungaraged_vehicle_logs_details = "Display some debug info, used in bug-reports."
	},
	...
	keys = {
		...
		no_nearby_vehicle = "No nearby vehicle.",
		there_is_someone_in_the_driver_seat = "There is someone in the driver's seat.",
		the_driver_door_is_closed = "The driver's door is closed.",
	...
	modifications = {
		...
		not_in_a_car = "You're not driving a car, mate.",
	...
	oil = {
		...
		no_nearby_vehicle = "No nearby car, mate.",
		vehicle_has_no_engine = "The closest car doesn't have an engine, sorry.",
		check_oil = "Have a squiz here to check the oil level, mate",
		oil_level = "The car's oil level is sittin' at ${percentage}%, not bad.",
		checking_oil_level = "Having a look at the Oil Level"
	},
	...
	plates = {
		...
		vehicle_plate_not_custom = "The motor with ID `${vehicleId}` doesn't have a custom number plate, mate.",
		confirm_reset_plate = "Oi, are you fair dinkum about resetting the plate of this motor? It can't be undone, so watch ya step. Type `yes` to give it a burl or `no` to chuck it in the bin.",
	...
	redline = {
		engine_blowout = "Your engine blew up from excessive stress."
	},
	...
	sirens = {
		...
		sirens_on = "Wailers: ${count}",
		horns_on = "Hooters: ${count}"
	},
	...
	trailers = {
		cant_attach_trailer = "This vehicle has no towbar.",
		no_trailer_nearby = "No trailer nearby.",
		not_in_vehicle = "You are not behind the wheel of a vehicle.",
	...
	vehicles = {
		...
		not_in_vehicle = "The volume level of the radio. The value is in percent so it has to be between 0 and 100. The default is 50%. Leaving this blank will return your current volume level.",
		vehicle_locked = "The vehicle is locked.",
		...
		manual_gears_too_fast = "You can only toggle manual below 30km/h.",
		hybrid_off = "Failed to automatically generate translation.",
		...
		no_data_copied = "Failed to automatically generate translation.",
		copied_data = "Failed to automatically generate translation.",
		pasted_data = "Failed to automatically generate translation.",
	...
	wheel_slash = {
		hold_to_slash = "Failed to automatically generate translation.",
		slashing_tire = "Failed to automatically generate translation.",
	...
	alpha = {
		...
		thanks_for_loot = "You were mugged while unconscious. Some items may be missing. Rumour has it was Nancy.",
		guards_found_unconcious = "The guards found you unconscious and brought you to the prison hospital.",
		serial_number = "Failed to automatically generate translation.",
		serial_number_unknown = "Failed to automatically generate translation.",
		serial_number_removed = "Failed to automatically generate translation.",
		...
		driver_license_owner = "<i>This driver's licence belongs to <b>${fullName} (#${characterId})</b>.</i>",
		press_pass_owner = "<i>This press pass belongs to <b>${fullName} (#${characterId})</b>.</i>",
		has_portrait = "<i>It has a photo.</i>",
		...
		evidence_bag_clothing_empty = "Clothing Mate: Sample nabbed from a ${type} didn't match any records (grabbed at ${time} near ${location})."
	}
}
