...
OP.Global.Locales.Languages["pl-PL"] = {
	...
	jackpot = {
		...
		storage_fee_warning = "O godzinie 6:00 UTC każdego dnia, przedmioty o wartości >= 5% wartości Twojego całkowitego inwentarza zostaną usunięte jako 'opłata za magazynowanie'.",
