...
OP.Global.Locales.Languages["en-US"] = {
	...
	admin = {
		...
		job_no_character = "Target player does not have a character loaded.",
	...
	inventory = {
		...
		wallet = "Wallet",
		wallet_description = "For all your cash and cards.",
		...
		paper = "Photo Paper",
		paper_description = "A blank piece of paper for printing pictures. (Size: 1x1)",
		...
		power_saw = "Power Saw",
		power_saw_description = "Used for sawing things off of other things.",
	...
	twitter_bid = {
		...
		information_part_1 = "Want to let everyone know who's boss on Twitter? Be the biggest bidder on the verification mark!",
		information_part_2 = "Whoever pays the most amount of money gets to have the blue verification mark, until another person bids a higher sum.",
