...
OP.Global.Locales.Languages["es-MX"] = {
	...
	admin = {
		...
		important_staff_pm_title = "!STAFF MP Tú -> ${recipient}",
		...
		job_no_character = "Fucking upgrade",
	...
	commands = {
		...
		wipe_command_parameter_model_name_help = "Si deseas eliminar solo entidades de un nombre de modelo específico, ingresa el nombre del modelo aquí. De lo contrario, déjalo en blanco, en `false` o `0`. También puedes establecer esto como `vehículos`, `personas`, `objetos` o `puertas`.",
		...
		cache_join_toggle_command_help = "Activa la memorización automática de algunos recursos cada vez que te unes al servidor.",
		...
		polygon_command_help = "Crear un polígono en el espacio 2D.",
		...
		throwables_debug_command = "lanceros_debug",
		throwables_debug_command_help = "Depurar todos los lanzadores cercanos.",
	...
	proxy = {
		...
		proxied_via_logs_details = "${consoleName} fue proxyeado a través de `${serverName}`."
	},
	...
	admin_menu = {
		...
		tp_player_logs_title = "Teleportar Jugador",
		tp_player_logs_details = "${consoleName} se teletransportó a ${targetConsoleName}.",
		tp_here_logs_title = "Teleportar Aquí",
		tp_here_logs_details = "${consoleName} teletransportó a ${targetConsoleName} hacia sí mismo.",
		tp_everyone_logs_title = "Teleportar Aquí a Todos",
	...
	cache = {
		...
		join_cache_disabled = "Caché de conexión desactivado.",
		join_cache_enable = "Caché de conexión habilitado."
	},
	...
	exclusive_dealership = {
		...
		buyback_closed = "El intercambio está cerrado. Puedes vender tu vehículo a otro jugador con el tier correcto.",
	...
	golf = {
		pickup_ball = "[${TeclaInteracción}] Recoger",
	...
	login = {
		...
		exiting_login_ui = "Saliendo (Interfaz de inicio de sesión)"
	},
	...
	meow = {
		...
		check_up_active = "Checando a Maxwell",
		chill_active = "Relajándome con Maxwell",
		meditate_active = "Meditando con Maxwell",
		salute_active = "Saludando a Maxwell",
		stretch_active = "Estirándome con Maxwell",

		maxwell_appeared = "Maxwell ha aparecido cerca de ti.",
		maxwell_shot = "Disparando a Maxwell"
	},
	...
	twitter_bid = {
		...
		information_part_1 = "¿Quieres dejarle saber a todos quién manda en Twitter? ¡Sé el mayor postor por la marca de verificación!",
		information_part_2 = "Quien pague la cantidad más alta obtendrá la marca de verificación azul, hasta que otra persona haga una oferta más alta.",
		information_part_3 = "Si alguien te supera en la oferta, no recuperarás tu dinero.",
		information_part_4 = "Asegúrate de poner una cita deslumbrante para que la gente te odie.",
