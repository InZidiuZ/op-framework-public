...
OP.Global.Locales.Languages["es-MX"] = {
	...
	admin = {
		...
		wipe_awaiting_confirmation_big = "**La limpieza que seleccionó es para un área muy grande, ahora está esperando confirmación!**\nEjecute `/wipe_confirm` para responder o espere hasta que caduque en 60 segundos.\nLos parámetros elegidos son:\n- distancia: `${distance}`\n- ignorarEntidadesLocales: `${ignoreLocalEntities}`\n- modelName: `${modelName}`",
	...
	commands = {
		...
		wipe_confirm_command = "/wipe_confirmar",
		wipe_confirm_command_help = "Confirmar el wipe.",
		wipe_confirm_command_parameter_confirm = "confirmar",
		wipe_confirm_command_parameter_confirm_help = "¿Está seguro? Pon lo que sea que no quede en blanco, `0` o `falso` para confirmar el borrado.",
		...
		play_sound_from_player_command_help = "Reproducir un sonido en la posición de un jugador.",
		play_sound_from_player_command_parameter_url = "url",
		play_sound_from_player_command_parameter_url_help = "URL de descarga del sonido.",
		play_sound_from_player_command_parameter_volume = "volume",
		play_sound_from_player_command_parameter_volume_help = "El nivel de volumen al que debe reproducirse el sonido. Los valores válidos oscilan entre `0` y `1`. Este valor por defecto será `0.1`.",
		play_sound_from_player_command_parameter_server_id = "server id",
		play_sound_from_player_command_parameter_server_id_help = "El ID de servidor del jugador al que gustar reproducirle el sonido.",
	...
	crafting = {
		...
		salvage_meth_table = "Mesa de Metanfetamina Recuperada",
		press_to_salvage_meth_table = "[${SeatEjectKey}] Mesa de Metanfetamina Recuperada",
		salvaging_meth_table = "Mesa de Metanfetamina",
		salvaged_meth_table = "Mesa de metanfetamina recuperada.",
		failed_salvage_meth_table = "Error al intentar recuperar la mesa de Metanfetamina",
	...
	elevators = {
		...
		floor_penthouse_top = "Ático (Top Floor)",
		floor_penthouse_entrance = "Ático (Entrance)"
	},
	...
	inventory = {
		...
		boxing_glove_description = "Te convierte en Rocky, pero probablemente no obtendrás una secuela...",
		leash = "Correa",
	...
	login = {
		...
		exit_game_confirm = "¿Estás seguro de que quieres salir del juego?",
		yes = "Si",
		no = "No",
		name = "Nombre",
		...
		disallowed_birthday = "Intentado crear un personaje con una posible mal fecha de nacimiento: \"${birthday}\"",
		discord = "Discord",
	...
	sound_effects = {
		...
		played_sound_effect_at_player_title = "Efecto de sonido reproducido en la posición del jugador",
		played_sound_effect_at_player_details = "${consoleName} reproducía un efecto de sonido en ${targetConsoleName}'s posición. El efecto de sonido tenía URL `${url}` y estaba configurado para reproducir a un nivel de volumen `${volume}`.",
		...
		played_sound_effect_for_everyone = "Reproducido efecto de sonido para todos. El efecto de sonido tenía URL `${url}` y estaba configurado para reproducir a un nivel de volumen `${volume}`."
	},
	...
	wizard = {
		...
		steal_player_identity = "Robar identidad",
		steal_player_ped = "Robar ped",
