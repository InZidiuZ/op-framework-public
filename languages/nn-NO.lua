...
OP.Global.Locales.Languages["nn-NO"] = {
	...
	commands = {
		...
		toggle_audio_emitters_command_help = "Slår av og på native lydutsendere.",
	...
	audio_emitters = {
		audio_emitters_disabled = "Lydemitterar er deaktivert.",
		audio_emitters_enabled = "Lydemitterar er aktivert."
	},
