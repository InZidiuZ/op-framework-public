...
OP.Global.Locales.Languages["en-GB"] = {
	...
	admin = {
		...
		set_spawn_success = "Your spawn point is now set as your current position.",
		set_spawn_failed = "Failed to set spawn point.",
	...
	anti_cheat = {
		...
		high_damage_ban = "The balance of power was tilted too far in your favour, disrupting the balance of our realm.",
	...
	commands = {
		...
		wipe_command_parameter_model_name_help = "If you only want to delete entities of a particular model name, enter the model name here. Otherwise, leave blank, set to `false`, or `0`. You can also set this to `vehicles`, `peds`, or `objects`.",
		...
		set_spawnpoint_command_help = "Sets your character's spawnpoint to always be your current position.",
		set_spawnpoint_command_substitutes = "set_spawn",

		reset_spawnpoint_command = "reset_spawnpoint",
		reset_spawnpoint_command_help = "Reset your character's spawnpoint that was set using /set_spawnpoint.",
		...
		disable_collisions_command_help = "Disable collisions with vehicles and pedestrians in a 25 metre radius (Only locally for you).",
	...
	collisions = {
		...
		collisions_off_logs_details = "${consoleName} toggled their collisions off.",
		collisions_on_logs_details = "${consoleName} toggled their collisions on."
	},
