...
OP.Global.Locales.Languages["en-GB"] = {
	...
	inventory = {
		...
		raw_diamond_description = "A diamond in its natural form, fresh from the mine.",
		...
		grenade_pin_description = "Shouldn't this be in a grenade?",
		...
		sleeping_bag_description = "A portable bed for tired travellers, great for camping, hunting, and fishing!",
		yoga_mat = "Yoga Mat",
