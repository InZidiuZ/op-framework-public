...
OP.Global.Locales.Languages["en-GB"] = {
	...
	emotes = {
		...
		put_bicycle_in_trunk = "Press ~INPUT_ENTER~ to put the bicycle in the boot.",
		cant_put_bicycle_in_trunk = "You can't put the bicycle in this boot.",
	...
	admin = {
		...
		new_player_revive_logs_details = "Die W-Koordinate oder Ausrichtung zu der du teleportieren möchtest. Dieser Parameter ist optional und wenn er leer gelassen wird, wird deine aktuelle Ausrichtung verwendet.",
		...
		staff_pm_first_time = "We see you have never used staff PMs before. To respond to a staff PM, use `/staffpm` followed by the recipient's ID. For ease of use, you can use `/reply` to respond to the last staff PM you received.",
		reply_pm_not_found = "There is no staff message to reply to.",
		...
		no_serial_number = "kein Job",
		unknown_character_id = "Entfernt die Job-Einschränkung von der Waffe. Standardmäßig ist es nein, `1` oder `y` für ja.",
	...
	anti_cheat = {
		...
		bad_entity_spawn = "Ah, trying to summon the ancient artefact of `${modelName}`, were you? This isn't an episode of Antiques Roadshow, and that relic is staying in the vault.",
		...
		illegal_damage_ban = "The scales of power were tilted too far in your favour, disrupting the balance of our realm.",
		illegal_freeze_ban = "Whilst spirits may wander freely, we mere mortals are bound by the laws of physics. Sir Isaac Newton wouldn't have it any other way.",
		...
		invalid_health_ban = "Your health bar appears to be too high, resulting in removal from the server.",
		...
		semi_godmode_ban = "Your persistent desire for eternal youth seems to have disrupted the natural flow of time. Immortality isn't as enjoyable as it sounds.",
		...
		vehicle_spawn_ban = "Ah, dreaming of a joyride with `${modelName}`, were you? This isn't a showroom, and that particular model? It's on an eternal waiting list!",
		weapon_spawn_ban = "Yearning for the `${weaponName}`, were you? This isn't an armoury, and that piece? Still in the forge.",
		...
		illegal_local_vehicle_ban = "It appears you've stumbled upon the invisible mount of Lord Mirage! Unfortunately, this enchanting ride is reserved for the annual phantom procession.",
		handling_field_ban = "Looks like you tried to supercharge the laws of physics. Nice try, but in this world, we keep our wheels grounded in reality.",
		...
		type_distance_taze = "Long Range Taser",
	...
	authentication = {
		...
		global_ban = "You have been globally banned from all OP-FW servers.\n\nBan Hash: ${banHash}\nBan Reason: ${reason}\n\nIf you believe this to be a false ban, please join the OP-FW Discord server for information on how to appeal at ${frameworkDiscord}",
	...
	bans = {
		...
		you_stopped_streaming = "remove_twitch_ban_exception"
	},
	...
	commands = {
		...
		sit_command_parameter_variation_help = "Which sitting animation to play (1 - 6).",
		...
		-- animations/couches
		sleep_command = "sleep",
		sleep_command_help = "Attempt to sleep on a nearby sofa or the ground.",
		...
		couch_offset_command_help = "Copy the offset to a nearby sofa of a specific model.",
		couch_offset_command_parameter_model_name = "model name",
		couch_offset_command_parameter_model_name_help = "The model name of the sofa to copy the offset of.",
		...
		sit_ledge_command_parameter_variation_help = "Which sit animation to play (1 - 13).",
		sit_ledge_command_substitutes = "ledge",

		-- animations/walkstyles
		marathon_command = "marathon",
		marathon_command_help = "Toggle the 'marathon' debug feature to see which walkstyles need adjusting.",
		...
		report_command_parameter_message_help = "Entfernt die Twitch-Bann-Ausnahme eines Spielers.",
		...
		wipe_command_parameter_model_name_help = "If you want to only delete entities of a certain model name, insert a model name here. Otherwise leave blank, at 'false' or '0'. You can also set this to 'vehicles', 'peds', 'objects', 'doors', 'broken' or 'npcs'.",
		wipe_command_parameter_camera = "camera",
		wipe_command_parameter_camera_help = "Use your camera coordinates instead of your pedestrian's coordinates. The default is \"no\". Use `1` or `y` for \"yes\".",
		...
		toggle_vehicle_smoke_command_parameter_color_b = "coluor b",
		...
		set_identity_command_help = "Overrides a player's name.",
		...
		advanced_metagame_command_help = "Command to assist in enhancing your metagaming skills.",
		advanced_metagame_command_parameter_use_characters = "use characters",
		advanced_metagame_command_parameter_use_characters_help = "Specify character names instead of player names.",
		...
		ridealong_command_help = "Switches your ability to enter NPC vehicles on or off.",
		ridealong_command_substitutes = "",

		kill_ped_command = "kill_ped",
		kill_ped_command_help = "Eliminates the pedestrian with the specified network ID.",
		kill_ped_command_parameter_network_id = "network id",
		kill_ped_command_parameter_network_id_help = "The network ID of the pedestrian to eliminate.",
		...
		points_command_help = "Displays the number of OP Points you possess.",
		points_command_substitutes = "",

		use_points_command = "use_points",
		use_points_command_help = "Utilise points. This command is used when a server offers specific perks that require manual charging. Please do not use this unless directed as it will deduct your points without confirmation!",
		use_points_command_parameter_amount = "amount",
		use_points_command_parameter_amount_help = "The amount of points the server should attempt to deduct from you.",
		use_points_command_parameter_label = "label",
		use_points_command_parameter_label_help = "A label to be recorded alongside the point usage.",
		...
		playtime_command_parameter_total_playtime_help = "By default, the playtime actually played on characters will be used. Set this to `y` to use the total overall time on the server instead.",
		...
		registration_lookup_command_parameter_registration_help = "The aircraft's registration (e.g. N123AZ).",
		...
		pickup_bicycle_command_help = "Pick up the nearest bicycle.",
		pickup_bicycle_command_substitutes = "pb",

		-- game/bills
		create_bill_command = "create_bill",
		create_bill_command_help = "Send an invoice to another player for a specific amount of money.",
		create_bill_command_substitutes = "invoice, send_invoice",
		...
		share_outfit_command_parameter_hairstyle_help = "If you want to include the hairstyle and colour (`0` or `false` for no).",
		...
		move_entity_command_parameter_heading_help = "If the entity should be placed with the same orientation as you.",
		move_entity_command_substitutes = "mv",

		server_entity_command = "server_entity",
		server_entity_command_help = "Displays server information about an entity for debugging.",
		...
		rotate_marker_command_help = "Adjust the rotation of a marker.",
		...
		debug_info_command_help = "Retrieve some debugging information about a particular player.",
		debug_info_command_parameter_server_id = "server id",
		debug_info_command_parameter_server_id_help = "The player for whom you want to obtain debugging information.",
		debug_info_command_substitutes = "",

		where_is_street_command = "where_is_street",
		where_is_street_command_help = "Locate a particular street on the map.",
		...
		-- game/development
		toggle_developer_ambience_command = "Ihr HUD scheint teilweise vom Bildschirm abzurutschen (~${amount}px). Sie können dies korrigieren, indem Sie die \"*Sicherheitszone Größe*\" in Ihren \"*Anzeige*\"-Einstellungen verringern.",
		...
		effect_zones_debug_command_help = "Debug which effect zones you are currently in.",
		...
		walk_command = "Fehler beim Aufheben des Balls.",
		walk_command_help = "Fehler beim Platzieren des Balls.",
		walk_command_parameter_name = "ANLEITUNG",
		walk_command_parameter_name_help = "${kills} Einheimische getötet ~t~/~w~ ${ranOver} überfahren",
		...
		autopsy_command_help = "Perform a post-mortem examination on the closest player's body. (Will show you the last recorded cause of death)",
		...
		invisibility_command_parameter_server_id_help = "If you want to toggle someone else's invisibility.",
		...
		modify_jail_command_help = "Modify a player's jail time.",
		...
		modify_jail_parameter_operation_help = "The operation you want to perform. (add or subtract)",
		...
		fake_lag_command_parameter_spike_help = "Randomly decrease your fps (may cause irritation).",
		...
		set_podium_vehicle_command_help = "Set the podium vehicle that can be won at the casino.",
		set_podium_vehicle_command_parameter_model_name = "model name",
		set_podium_vehicle_command_parameter_model_name_help = "The model name of the vehicle you would like to change it to.",
		...
		create_magazine_command_help = "Spawn a magazine of a specific issue from a particular series.",
		...
		create_magazine_command_parameter_issue_id_help = "The issue ID you wish to spawn.",
		...
		info_command = "Ihr HUD scheint teilweise vom Bildschirm abzurutschen (~${amount}px). Sie können dies korrigieren, indem Sie die \"*Sicherheitszone Größe*\" in Ihren \"*Anzeige*\"-Einstellungen verringern.",
		info_command_help = "Bruder, wie zum Teufel bist du noch am Leben?",
		...
		model_view_command_parameter_components_help = "Weapon components (separated by commas).",
		...
		npc_watch_command_help = "Watch a random NPC going about their day.",
		...
		power_generators_disable_command_help = "Disable all power generators at Pacific Bank. Equivalent to successfully disabling each one that wasn't already disabled.",
		...
		-- game/prop_hide
		prop_hide_command = "Prop Hide",
		prop_hide_command_help = "Toggle prop hiding.",
		...
		race_delete_command_parameter_track_name_help = "The name of the circuit you want to delete.",
		race_delete_command_substitutes = "",

		race_list_command = "race_list",
		race_list_command_help = "List all your saved circuits.",
		race_list_command_substitutes = "",

		race_load_command = "race_load",
		race_load_command_help = "Load a circuit.",
		race_load_command_parameter_track_name = "track name",
		race_load_command_parameter_track_name_help = "The name of the circuit you want to load.",
		race_load_command_substitutes = "",

		race_start_command = "race_start",
		race_start_command_help = "Start a circuit.",
		...
		radio_volume_command_parameter_volume_help = "LAG",
		radio_volume_command_substitutes = "Sind Sie sicher, dass Sie ${total} Lag an $${price} versenden möchten? Dieser Versand kann nicht storniert werden.",

		-- game/reflect
		reflect_damage_command = "reflect_damage",
		reflect_damage_command_help = "Fehler beim Aufheben des Balls.",
		...
		explain_rule_command_help = "Show the explanation of a specific rule.",
		...
		savings_accounts_command = "Fehler beim Platzieren des Balls.",
		savings_accounts_command_help = "ANLEITUNG",
		savings_accounts_command_substitutes = "${kills} Einheimische getötet ~t~/~w~ ${ranOver} überfahren",
		...
		weather_command_parameter_weather_help = "The name of the weather you want to set. Valid weather names include EXTRASUNNY, CLEAR, CLOUDS, SMOG, FOGGY, OVERCAST, RAIN, THUNDER, CLEARING, NEUTRAL, SNOW, BLIZZARD, SNOWLIGHT, XMAS, HALLOWEEN, RAIN_HALLOWEEN, and SNOW_HALLOWEEN.",
		...
		-- game/train_pass
		train_passes_command = "train_tickets",
		train_passes_command_help = "Check the number of train tickets you have.",
		...
		vdm_command_parameter_network_id_help = "The network ID of the vehicle causing VDM (if empty, selects the closest vehicle to you).",
		...
		drive_to_command = "Bruder, wie zum Teufel bist du noch am Leben?",
		drive_to_command_help = "LAG",
		drive_to_command_parameter_network_id = "Sind Sie sicher, dass Sie ${total} Lag an $${price} versenden möchten? Dieser Versand kann nicht storniert werden.",
		drive_to_command_parameter_network_id_help = "Ya sea `number` o `twitter`.",
		drive_to_command_substitutes = "",

		hop_in_command = "hop_in",
		hop_in_command_help = "Makes the nearest NPC hop into your vehicle (if a seat is available).",
		...
		taze_player_command_substitutes = "stun, tase",
		...
		entity_states_command_parameter_network_id_help = "The network ID of the entity. If left blank or set to 0, it will select the vehicle you are in if you are in one and then your own player character.",
		...
		set_entity_state_command_help = "Sets an entity's state to the given value regardless of restrictions.",
		set_entity_state_command_parameter_network_id = "network id",
		set_entity_state_command_parameter_network_id_help = "The network ID of the entity. If left blank or set to 0, it will select the vehicle you are in if you are in one and then your own player character.",
		...
		remove_clothing_command_parameter_server_id_help = "The server ID of the player you want to remove the clothing from. If left empty, it will select the closest restrained or incapacitated player.",
		...
		job_command_parameter_shortcut_help = "The shortcut to the job you want to set. Leave this empty to toggle the job UI instead.",
		...
		set_marriage_command_help = "Set the marital status between two characters.",
		...
		set_fuel_command_parameter_server_id_help = "If you wish to set the fuel for another player. Leaving this blank will automatically select yourself.",
		...
		give_key_command_parameter_server_id_help = "The player's server ID you wish to give the key to. This can be left blank (or set to 0) to give it to the nearest person.",
		...
		grab_keys_command_help = "Take the keys from the vehicle you are currently driving.",
		...
		wheel_offset_command_parameter_value_help = "The amount by which you want it to be modified. This can range from -0.15 to 0.2, with 0 as the default.",
		...
		reset_plate_command_help = "Reset your vehicle's number plate (if it has a custom plate that does not match the regular format).",
		...
		-- vehicles/vehicles
		flip_command = "flip",
		flip_command_help = "Roll over a flipped vehicle or trolley.",
		...
		fill_ammo_command_parameter_server_id = "player_id",
		fill_ammo_command_parameter_server_id_help = "The player ID of the player you wish to fill the ammo for.",
	...
	steam = {
		no_steam_allowed = "Before joining, you must fully close Steam and then start FiveM."
	},

	twitch = {
		streaming_state_already_set_to_target = "The user's streaming state is already set to the target state provided.",
		streaming_state_changed = "The user's streaming state has been changed to the target state provided.",
	...
	users = {
		...
		unloaded_character_for_everyone_no_reason_logs_details = "Ungültiger oder fehlender Typ.",

		unloaded_character_for_user = "Unloaded character ${characterFullName} (${characterId}) for ${consoleName}.",
		unloaded_character_for_everyone = "Suchparameter fehlt.",
	...
	admin_features = {
		...
		fortnite_feature = "Battle Royale",
		reflection_feature = "Damage Reflect",
		stable_cam_feature = "Stable Camera",
		super_jump_feature = "Mega Jump",
		server_id_hidden_feature = "Hidden Server ID",
		fake_disconnect_feature = "Simulated Disconnect",
		brighter_nights_feature = "Brighter Evenings",
		ridealong_feature = "Passenger Seat",
	...
	airports = {
		...
		illegal_license_success = "Successfully breached the FAA database, your licence is now valid for 5 days.",
		failed_illegal_license = "Failed to obtain an illegal licence.",
		spawned_vehicle = "Spawned vehicle.",
		spawned_vehicle_large = "Large vehicle spawned. A marker has been set on your map.",
		...
		vehicle_no_free_seat = "There are no free seats available on this vehicle.",
		press_to_enter_aircraft = "Press ~INPUT_ENTER~ to enter the aircraft.",
		no_aircraft_to_enter = "There are no aircraft to enter.",
		helipad = "Helipad",
		looking_up = "Searching for Registration",
	...
	animals = {
		...
		description_cat_named = "${name}, the ${gender} cat, is a ${age} old companion who carries the wisdom of countless sunny naps and midnight adventures. Weighing ${weight} and harbouring an unshakeable passion for ${food}, ${name} moves through the world like a living riddle—part royal dignitary, part mischievous street philosopher.",
		...
		description_dog_named = "${name}, the ${gender} dog, is ${age} in this wonderful tale of friendship, weighing ${weight} and emanating an energy that could illuminate the darkest room. Completely captivated by ${food}, ${name} lives by a simple motto: every day is a blessing, every friend a treasure, every moment an opportunity for happiness.",

		description_rabbit_unnamed = "This ${gender} rabbit, ${age} young and weighing ${weight}, hops through life with the zest of a natural explorer. Fueled by an unexpected fondness for ${food}, its ears are always alert, its spirit irresistibly lively—a tiny heart pulsating with endless curiosity.",
		description_rabbit_named = "${name}, a ${gender} rabbit aged ${age} on this wild journey of life, weighs ${weight} and carries an infectious zest that belies its size. Utterly devoted to ${food}, ${name} turns every hop into a declaration of joy, every nibble into an adventure.",

		description_hen_unnamed = "A ${gender} hen, ${age} years old and strutting at ${weight}, who moves with the confidence of a farmyard philosopher. Fueled by an unexpected craving for ${food}, this feathered friend transforms ordinary moments into epic narratives of poultry prowess.",
		...
		description_rat_named = "${name}, a ${gender} rat aged ${age}, embarking on life's grand experiment, weighing ${weight} and brimming with personality. With an unbreakable bond to ${food}, ${name} encapsulates the essence of curiosity—small in stature, boundless in spirit.",
	...
	arena = {
		...
		assist = "Assist",
		battle_royale_win = "Victory in Battle Royale",
	...
	attachments = {
		...
		attachment_label_armor_piercing = "Armour Piercing Rounds",
	...
	audio_emitters = {
		audio_emitters_disabled = "Audio emitters have been deactivated.",
		audio_emitters_enabled = "Audio emitters have been activated."
	},
	...
	bicycles = {
		...
		failed_pickup_bicycle = "Failed to pick up bicycle.",
	...
	brochure = {
		...
		your_appearance_2 = "Once you've flown in for the first time you wont be able to change your general appearance like skin colour, facial features, etc anymore. If you messed up your appearance or finished too quickly you can /report and ask for a reskin.",
	...
	buddy_pass = {
		...
		information_part_1 = "Instantly move your friend to the front of the queue with a Mate's Pass!",
		information_part_2 = "All users with a God Tier pledge have access to this feature with one free pass.",
		information_part_3 = "The 'pass' is active until your friend disconnects from the server. You can then move someone else to the front of the queue.",
	...
	cinema = {
		...
		how_to_share_screen_part_3 = "Enter the values below.",
	...
	clothing = {
		...
		loading_preload_data = "Loading ped data...",
	...
	crafting = {
		...
		glass_recipe = "Melt Glass",
		steel_recipe = "Melt Steel",
		scrap_metal_recipe = "Melt Scrap Metal",
		melt_gun_parts_recipe = "Melt Gun Parts",
		aluminium_recipe = "Melt Aluminium",
		...
		smelting_materials = "Melting ${usedItems}",
		smelted_materials = "Melted ${usedItems}.",
		failed_smelt_materials = "Failed to melt materials.",
		...
		cut_potato_done = "Cut potatoes into chips.",
		...
		fries_recipe = "Chunky Chips",
		frying_fries = "Frying Chunky Chips",
		fried_fries = "Fried chunky chips.",
		failed_fry_fries = "Failed to fry chips.",

		nuggets_recipe = "Chicken Bites",
		frying_nuggets = "Frying Chicken Bites",
		fried_nuggets = "Fried chicken bites.",
		failed_fry_nuggets = "Failed to fry chicken bites.",
		...
		failed_assemble_bne_burger = "Failed to make a bacon and egg burger.",
		...
		converter_recipe = "Dismantle Converter",
		...
		process_bud_recipe = "Process Cannabis Bud",
		processing_bud = "Processing Cannabis Bud",
		processed_bud = "Processed cannabis bud.",
		failed_process_bud = "Failed to process cannabis bud.",
		...
		cut_ingridients = "Prepare Ingredients",
		press_to_cut_ingridients = "[${SeatEjectKey}] Prepare Ingredients",

		tofu_recipe = "Tofu Cubes",
		cutting_tofu = "Cutting Tofu",
		cut_tofu_done = "Tofu cubes cut.",
		failed_cut_tofu = "Failed to cut tofu.",

		spring_onions_recipe = "Spring Onions",
		cutting_spring_onions = "Cutting Spring Onions",
		cut_spring_onions_done = "Spring onions cut.",
		...
		press_to_slice_ingredients = "[${SeatEjectKey}] Prepare Ingredients",

		pineapple_slice_recipe = "Prepare Pineapple Slices",
		slicing_pineapple = "Preparing Pineapple Slices",
		sliced_pineapple = "Pineapple slices prepared.",
		failed_slice_pineapple = "Failed to prepare pineapple slices.",

		bell_pepper_slice_recipe = "Prepare Bell Pepper Slices",
		slicing_bell_pepper = "Preparing Bell Pepper Slices",
		sliced_bell_pepper = "Bell pepper slices prepared.",
		failed_slice_bell_pepper = "Failed to prepare bell pepper slices.",

		top_pizza = "Top Pizza",
		press_to_top_pizza = "[${SeatEjectKey}] Add Toppings to Pizza",
		...
		failed_topping_pepperoni = "Failed to add pepperoni topping to the pizza.",

		vegetarian_recipe = "Vegetarian Pizza",
		topping_vegetarian = "Adding Toppings to Vegetarian Pizza",
		topped_vegetarian = "Vegetarian pizza topped successfully.",
		failed_topping_vegetarian = "Failed to add toppings to vegetarian pizza.",

		ham_recipe = "Ham Pizza",
		topping_ham = "Adding Toppings to Ham Pizza",
		topped_ham = "Ham pizza topped successfully.",
		failed_topping_ham = "Failed to add toppings to ham pizza.",

		diavola_recipe = "Diavola Pizza",
		topping_diavola = "Adding Toppings to Diavola Pizza",
		topped_diavola = "Diavola pizza topped successfully.",
		failed_topping_diavola = "Failed to add topping to Diavola Pizza.",

		hawaiian_recipe = "Hawaiian Pizza",
		topping_hawaiian = "Adding Toppings to Hawaiian Pizza",
		topped_hawaiian = "Toppings added to Hawaiian Pizza.",
		failed_topping_hawaiian = "Failed to add toppings to Hawaiian Pizza.",
		...
		cappuccino_regular_recipe = "Cappuccino (Cow Milk)",
		cappuccino_almond_recipe = "Cappuccino (Almond Milk)",
		cappuccino_pigeon_recipe = "Cappuccino (Pigeon Milk)",
		...
		making_hot_chocolate = "Preparing Hot Chocolate",
		made_hot_chocolate = "Hot chocolate prepared.",
		failed_make_hot_chocolate = "Failed to prepare hot chocolate.",
	...
	container_storage = {
		...
		no_access = "Only you have access to this container/warehouse.",
		back = "Back",
		close = "Close",
		...
		mark_gps = "Mark GPS",
		container_alert = "Your container/warehouse #${containerId} is being interfered with.",
	...
	daily_activities = {
		...
		task_progress_money = "Task Progress: ${task} (£${remain} remaining)",
	...
	debug = {
		...
		copied_surface_heading = "Surface heading copied.",
		...
		vehicle_brake_distance = "Brake Dist: ${distance}m",
		...
		street_found = "Found `${name}`, its centre has been marked on your map.",
		street_not_found = "No road found that matches your search.",
	...
	emote_menu = {
		...
		moods = "Facial Expressions / Moods",
		moods_description = "Change your facial expression / mood.",
		walkstyles = "Walking Styles",
		walkstyles_description = "Change your walking style.",
	...
	flight_radar = {
		callsign_invalid = "Your callsign must be between 3 and 10 characters.",
		callsign_set = "Callsign successfully updated to `${callsign}`.",
		callsign_reset = "Callsign successfully reset.",
	...
	fortune_cookies = {
		...
		opened_cookie_logs_details = "${consoleName} opened a fortune cookie and received `${fortune}`.",
		...
		missing_fortune = "Fortune message is missing.",
		failed_create_cookie = "Unable to create fortune cookie.",
	...
	freecam = {
		...
		freecam_no_dead = "You cannot enable freecam while unconscious.",
	...
	gun_trader = {
		...
		sorry_closed_hug = "Thanks for the hug mate :)",
		sorry_closed_finger = "What the heck, that's rude!",
		sorry_closed_kiss = "Woah mate, I'm not into that...",
		sorry_closed_dab = "Dab on the haters, mate!",
		sorry_closed_fight = "Calm down, mate, I didn't do anything.",
		...
		just_used_pager = "You have just used the pager, please wait a short while before using it again.",
		page_trader_closed = "Jim is not responding, he must be closed.",
		page_success = "Jim sent a message to indicate his rough location."
	},
	...
	health = {
		...
		revived_range_title = "Revived Area",
		revived_range_details = "${consoleName} revived everyone in a ${radius}m area.",
		...
		no_nearby_ped = "No nearby pedestrian.",
		ped_not_dead = "Pedestrian is not dead.",
		...
		cpr_player_logs_title = "CPR-ed Player",
	...
	hud = {
		...
		degrees = "°C",
		degrees_f = "°F",
		npc_kills = "The name of the walkstyle.",
		...
		how_are_you_alive = "Display some debug info, used in bug-reports.",
	...
	identification = {
		...
		just_showed_driver_license = "You have recently displayed a Driving Licence. Please wait a moment.",
		press_pass_details = "${firstName} ${lastName} | Gender: ${gender} | Citizen ID: ${characterId}",
		just_showed_press_pass = "You have just presented a Press Pass. Please wait a moment.",
		...
		bar_license = "Bar/Legal License",
		bar_license_details = "Bar/Legal License | ${firstName} ${lastName} | Citizen ID: ${characterId}",
		...
		state_badge = "Identification Card",
		state_badge_details = "Identification Card | ${firstName} ${lastName} | Position: ${positionName}",
		...
		badge_type_ftp = "Field Training Programme",
		...
		badge_type_state = "State of San Andreas Identification Card",
		...
		badge_type_short_state = "Identification Card",
	...
	import_export = {
		...
		storage_units = "The volume level of the radio. The value is in percent so it has to be between 0 and 100. The default is 50%. Leaving this blank will return your current volume level.",
		minutes = "minutes",
	...
	indestructibility = {
		indestructibility_on = "Indestructibility toggled on.",
		indestructibility_off = "Indestructibility toggled off."
	},
	...
	injuries = {
		...
		injury = "${label} Injury",
		performing_autopsy = "Performing post-mortem examination",
		already_performing_autopsy = "Already conducting post-mortem examination.",
		autopsy_no_player = "No player nearby for you to perform an autopsy on.",
		autopsy_result = "It seems the patient passed away due to `${label}` at approximately ${time}.",
		autopsy_no_result = "The autopsy results seem inconclusive.",
		autopsy_failed = "Failed to conduct the autopsy."
	},
	...
	inventory = {
		...
		cigar_store = "Tobacconist",
		penthouse_fridge = "Refrigerator",
		mug_shots = "Mug Shots",
		...
		locksmith = "Locksmith",
		the_chemist = "Pharmacy",
		discount_store = "Discount Store",
		skater_store = "Skate Shop",
		...
		inspect_bank_property_cid = "This ${item} is marked as property of the ${bank} Bank. It was withdrawn via account number #${characterId}.",
		...
		driver_license = "Driving Licence",
		driver_license_description = "An official driving licence. Definitely not from the back of a cereal box.",
		press_pass = "Press Pass",
		press_pass_description = "This official Press Pass identifies you as a reporter or journalist, granting access to restricted areas and events. Wear it with pride as you pursue stories and uncover the truth.",
		phone = "Phone",
		...
		wallet = "Guinness",
		wallet_description = "Crafted with patriotism in mind, this wallet not only stores your essentials like IDs and cash but does so with a touch of national pride. The vibrant American flag and eagle emblem make a statement every time you pull it out. Perfect for those who carry not just their valuables, but also a sense of pride.",
		folder = "Folder",
		folder_description = "This robust blue folder is the essential organiser for all your important papers. Perfect for keeping documents, IDs, and photos neatly arranged and easily accessible. Whether for business or personal use, it's a dependable keeper of your paper treasures.",
		...
		boat_license = "Boat Licence",
		boat_license_description = "A licence for operating boats.",
		hunting_license = "Hunting License",
		...
		bar_license = "Bar/Legal License",
		bar_license_description = "A certified proof that you've passed the bar exam and are officially allowed to practice law in the State of San Andreas. Display it proudly, showing you've mastered the legal system and can now defend the innocent or prosecute the guilty.",
		...
		ftp_badge = "FTP Badge",
		ftp_badge_description = "A badge for trainers of the Field Training Programme.",
		ems_badge = "EMS ID",
		...
		state_badge = "ID Card",
		state_badge_description = "An ID card for employees of the State of San Andreas.",
		state_security_badge = "State Security ID",
		...
		bus_map = "Bus Map",
		bus_map_description = "A map of the bus routes in Los Santos. Displays all the stops where you can catch a bus.",
		flight_radar = "Flight Radar",
		flight_radar_description = "This advanced Flight Radar receiver is your portal to the skies, offering real-time insights into aircraft movements within radar station range. Ideal for aviation enthusiasts and professionals, it offers a detailed overview of the aerial landscape, keeping you connected to the world above at all times.",
		...
		label_printer_description = "Personalise your gear in style with this label printer! Simply insert an item, and print a sleek new skin or wrap to give it a fresh, personalised appearance. Ideal for adding some pizzazz to your everyday items!",

		brochure = "Brochure",
		brochure_description = "A helpful brocure to get you started in the city.",
		bus_ticket = "Bus Ticket",
		bus_ticket_description = "Your single ticket for the <b>${route}</b>! This ticket is ideal for those who like to keep a small memento from their travels. It's valid for a one-way journey from <b>${date}</b>, so hold onto it tightly and enjoy the ride. Remember, this ticket is only valid for one trip, so make the most of it!",
		...
		drill_large_description = "A heavy-duty tool designed for tough jobs. Capable of handling something big... if you know what you're doing.",
		...
		closed_paper_bag_description = "A classic brown bag concealing the mysteries of its contents. Is it lunch? A secret stash? Only one way to find out—tear it open and see what's inside!",
		...
		kissaki_delivery_description = "A delicious collection of sushi and other Japanese delicacies.",
		green_wonderland_delivery = "Green Wonderland Bag",
		green_wonderland_delivery_description = "A bag full of your favourite green goodies. #420blazeit",
		pizza_this_delivery = "Pizza This Box",
		pizza_this_delivery_description = "Transport your hot and tasty pizza in style with the Pizza This delivery box, ensuring each slice arrives just as perfect as when it left the oven.",

		lunch_box = "Lunch Box",
		lunch_box_description = "A robust little box that holds your aspirations, dreams, and yesterday’s leftovers. Perfect for keeping your snacks secure, your sandwich un-squished, and your crisps slightly less crushed than usual. Warning: Does not guarantee enhanced lunchtime social status.",
		...
		skateboard_description = "We had skateboards in GTA V before Skate 4.",
		deck_arcade = "Arcade Attack Deck",
		deck_arcade_description = "Level up your skating game with the Arcade Attack Deck. Featuring vibrant pixel art that takes you back to classic gaming, this deck is perfect for gamer skaters. Bring some nostalgia to the streets and grind those rails like you're hitting high scores!",
		...
		deck_flowers_description = "Bring the beach to the streets with the Tropical Vibes Deck. Covered in lush floral patterns, this deck is perfect for those who want to skate in a perpetual state of summer. Feel the breeze and ride the waves of the urban jungle!",
		deck_weed = "High Speed Deck",
		deck_weed_description = "Embrace the ultimate relaxation with the High Speed deck. Ideal for skaters who prefer a laid-back approach while catching some serious air.",
		deck_blossom = "Cherry Blossom Deck",
		deck_blossom_description = "Find your inner peace with Cherry Blossoms. This deck is ideal for those who want to bring a touch of tranquillity to their skate sessions.",
		...
		deck_ems_description = "Pay homage to emergency responders with the Red Line Deck. Ideal for EMS personnel who want to ride with pride and honour their heroic work.",
		...
		small_frog_description = "Just a small frog. Look at the little chap, he's so cute!",
		seashell = "Seashell",
		seashell_description = "A seashell from the beach. You can hear the sea if you put it up to your ear.",
		...
		small_frog_mk2_description = "In the muck, there lies an elusive amphibian trooper: the Small Frog MK2, distinguishable by its miniature military helmet and the tiny AK it seems to wield. Spotting one with your magnifying glass amidst the mud is a rare and amusing honour, a testament to the curious wonders of nature.",
		...
		raw_diamond = "Unprocessed Diamond",
		...
		raw_sapphire_description = "This uncut sapphire, with its deep blue tones, evokes a sense of depth and mystery. Resilient and stunning, it's ready to be shaped into a gem that reflects the celestial skies.",
		raw_emerald = "Raw Emerald",
		raw_emerald_description = "A lively uncut emerald that embodies the spirit of verdant landscapes and dense forests. Though common, its charm is undeniable, holding the promise of breathtaking beauty once polished.",
		raw_opal = "Raw Opal",
		...
		ruby_dust = "Ruby Dust",
		ruby_dust_description = "A lively red dust crafted from finely ground rubies, esteemed for its intense, rich hue. This opulent pigment is ideal for infusing a bold and vibrant colour into any project, particularly when blended with other patriotic shades to create an eye-catching appearance that inspires national pride.",
		...
		steel_tube_description = "A versatile and sturdy steel tube, ideal for various crafting projects. Whether you're constructing, fixing, or inventing, this tube is your top choice for strength and reliability.",
		hardened_steel_plate = "Hardened Steel Plate",
		hardened_steel_plate_description = "This hardened steel plate is crafted to withstand the most challenging conditions, offering superior strength and durability for any demanding project. Perfect for reinforcing structures, creating advanced components, or ensuring your creations endure the passage of time.",
		...
		muzzle_brake_description = "Designed to control the strong recoil and muzzle rise of firearms, this important component redirects propellant gases to help keep your aim steady and your shots accurate. Made with precision, it ensures smoother operation and improved accuracy, making it essential for any dedicated marksman.",

		trigger = "Trigger",
		trigger_description = "An essential part of any firearm build, whether it's an SMG, rifle, or shotgun. Expertly crafted to provide a precise and reliable trigger pull each time.",
		...
		smg_upper_receiver_mk2_description = "The MK2 variant of the SMG upper receiver comes with enhancements for improved accuracy and stability. It's the preferred choice for those seeking top-notch performance from their firearm.",
		...
		rifle_upper_receiver_description = "Connecting the barrel and bolt carrier group, the upper receiver is crucial for your rifle’s accuracy and operation. This component ensures that your rifle can tackle any task with precision.",
		rifle_upper_receiver_mk2 = "Rifle Upper Receiver MK2",
		rifle_upper_receiver_mk2_description = "The MK2 rifle upper receiver provides advanced engineering for enhanced accuracy and durability, preparing your rifle for the toughest conditions.",
		...
		shotgun_lower_receiver_mk2_description = "Upgrading to the MK2 version gives you added strength and durability, perfect for constructing a shotgun that can withstand the demands of frequent use.",
		...
		brass = "Brass",
		brass_description = "By skillfully combining copper and zinc, you get brass—a robust metal perfect for crafting ammunition casings. It's like alchemy for the modern age, transforming simple elements into the essential components of your arsenal.",

		grenade_shell = "Grenade Shell",
		grenade_shell_description = "This empty grenade shell is an essential component for crafting specialised grenades, such as smoke or gas types. Its robust casing is designed to safely contain and deploy various substances when used with the correct triggering mechanism.",
		grenade_pin = "Grenade Pin",
		grenade_pin_description = "Crucial for the safe handling and deployment of grenades, this pin acts as a safety lock. When combined with a grenade shell, it enables precise control and timing required to create effective smoke or gas dispersal devices in tactical situations.",

		paint = "Paint",
		paint_description = "A tin of premium weapons-grade paint, available in a variety of classic shades. Give your reliable sidearm a fresh coat for a like-new appearance that will impress friends and deter enemies. One tin is sufficient for a complete weapon transformation, just avoid inhaling it.",
		paint_brush = "Paint Brush",
		paint_brush_description = "A top-quality brush made with the best bristles, crafted for accurate and uniform paint application on any weapon exterior. When used with our premium paint, this brush will assist you in expertly creating your weapon's new appearance, whether you opt for striking camouflage or chic and sophisticated designs.",

		skin_patriotic = "Patriotic Skin",
		skin_patriotic_description = "Show your love for the red, white and blue with this patriotic weapon skin. Perfect for any true American patriot looking to express their national pride while packing heat. It'll make your weapon stand out while you fight for freedom.",
		...
		refillable_bottle_description = "Elevate your hydration game with this stylish, refillable bottle. Created for the environmentally conscious and fashion-forward, its sturdy build and understated design make it an ideal companion for staying hydrated throughout the day. Fill it with your drink of choice and keep dehydration at bay whether you're at work, working out at the gym, or exploring the world.",

		capri_sun = "Capri Sun",
		capri_sun_description = "Relive the joy of your childhood with each sip of Capri Sun! This iconic pouch brims with the zesty flavour of orange, delivering a refreshing burst reminiscent of sunny days and fun-filled afternoons. Perfect for adventures or a nostalgic treat, it’s your little box of sunshine that quenches thirst and sparks memories.",

		gumball = "Gumball",
		gumball_description = "Enjoy a burst of unexpected flavour with each colourful gumball. Just be careful not to get too carried away—remember to chew, not swallow! Each piece offers a delightful surprise, making every chew a fun and flavourful adventure.",
		...
		bne_burger = "Bacon and Egg Burger",
		...
		sprite = "Sprite",
		sprite_description = "Refresh yourself with a can of Sprite, the lemon-lime soda that packs a punch. It's got that bubbly carbonation that tingles and sometimes even stings going down, but it’s oh-so worth it. Loaded with sweetness, Sprite is your go-to for a sugary, fizzy fix!",
		pilk = "Pilk",
		...
		vegan_sandwich_description = "Yeah this is literally just a piece of lettuce and a few tomatoes between two slices of wholemeal bread. (I don't know why you'd ever eat this)",
		taco = "Taco",
		...
		pizza_dough_description = "This premium pizza dough is ready for your culinary touch. Elastic and supple, it's perfect for shaping into your ideal base for any toppings. Roll it, top it, and bake it into a crispy, golden crust that forms the foundation of a delicious homemade pizza.",
		black_olives = "Black Olives",
		black_olives_description = "These black olives bring a rich, earthy flavour to any dish. Sliced and ready to scatter over pizzas, they add a touch of Mediterranean zest that complements both meaty and vegetarian toppings.",
		bell_pepper = "Bell Pepper",
		bell_pepper_description = "Vibrant and sweet, this whole red bell pepper adds a burst of colour and a crunch to any dish. Perfect for stuffing, slicing, or snacking, it's a versatile kitchen favourite.",
		...
		jalapeno = "Jalapeno",
		jalapeno_description = "Fresh jalapeños provide a fiery kick to any pizza. Sliced thinly, these peppers introduce a burst of heat and a bright, vegetal note that cuts through richer flavours, perfect for those who appreciate a spicy edge.",
		...
		ham = "Ham",
		ham_description = "Sweet and savoury ham adds a rich depth of flavour to pizza. Its tender, juicy bites offer a delightful contrast when paired with the creamy texture of melted cheese, making it a popular choice for many.",
		salami = "Salami",
		...
		pizza_cheese_description = "Enhance your homemade pizzas with this rich and stretchy pizza cheese, designed to melt beautifully and add a creamy, gooey texture to every flavourful bite.",
		pineapple_slices = "Pineapple Slices",
		pineapple_slices_description = "Sweet, tangy, and juicy, these pineapple slices are perfect for adding a tropical touch to your dishes. Whether you’re a fan of pineapple on pizza or prefer it as a standalone snack, these slices bring brightness and flavour to any culinary creation.",
		pizza_saver = "Pizza Slice Holder",
		pizza_saver_description = "It's designed to keep the cheese from sticking to the box, but as a child, you may have thought it was for dolls and action figures to sit on.",
		bread_sticks = "Garlic Bread Sticks",
		bread_sticks_description = "Crispy and golden on the outside, soft and chewy on the inside, these bread sticks are made from pizza dough. Ideal for dipping in marinara sauce or enjoying on their own, they make a delicious and versatile snack.",

		pizza_margherita_raw = "Uncooked Margherita Pizza",
		pizza_margherita_raw_description = "This Margherita pizza is freshly prepared with vibrant tomato sauce, fresh mozzarella, and aromatic basil on perfectly proved dough, ready to slide into the oven and bake to perfection.",
		...
		pizza_diavola_raw_description = "This Diavola pizza is expertly prepared with a base of raw dough topped with spicy pepperoni, fiery jalapeños, and a generous sprinkling of cheese, waiting for the oven's heat to unleash its full flavour.",
		pizza_ham_raw = "Raw Ham Pizza",
		pizza_ham_raw_description = "This Ham pizza is handcrafted with homemade dough, topped with flavoursome ham slices, creamy mozzarella, and tomato sauce, all arranged and ready for baking to create a comforting and delicious meal.",
		pizza_hawaiian_raw = "Raw Hawaiian Pizza",
		pizza_hawaiian_raw_description = "This uncooked Hawaiian pizza is prepped and poised for the oven, with a generous topping of sweet pineapple, savoury ham, and stretchy mozzarella on a saucy base—ready to settle the age-old debate with every delicious bite.",
		...
		pizza_margherita_description = "Indulge in the simplicity of a classic Margherita pizza, with a golden crust topped with rich tomato sauce, creamy mozzarella, and a hint of fresh basil. This timeless favourite delivers a taste of Italy with every savoury slice.",
		pizza_salami = "Salami Pizza",
		pizza_salami_description = "Enjoy the rich flavours of freshly baked Salami pizza, generously topped with spicy salami slices that combine beautifully with oozy mozzarella and a tangy tomato base.",
		pizza_diavola = "Diavola Pizza",
		pizza_diavola_description = "Indulge in the fiery kick of Diavola pizza, with spicy pepperoni, jalapeños, and rich tomato sauce, all smothered under a layer of melted cheese, perfectly baked to crispy perfection.",
		pizza_ham = "Ham Pizza",
		...
		pizza_hawaiian_description = "Fresh from the oven, this Hawaiian pizza combines the divisive yet popular combination of succulent pineapple and savoury ham on a crispy base. Indulge in this tropical variation that stirs up conversations and satisfies taste buds.",
		pizza_pepperoni = "Pepperoni Pizza",
		pizza_pepperoni_description = "A fiery twist on a timeless favourite! This spiced-up pepperoni pizza is cooked to perfection, featuring a crunchy crust, gooey cheese, and pepperoni with a spicy kick. Not for the faint-hearted, this pizza brings the heat!",
		...
		pizza_slice_description = "Savour the classic delight of a Margherita pizza slice, with its bubbly mozzarella, fragrant basil, and rich tomato base on a crispy crust. Perfect for a quick, flavourful bite.",
		pizza_slice_salami = "Salami Pizza Slice",
		pizza_slice_salami_description = "Indulge in a slice of Salami pizza, where spicy salami combines with melted mozzarella and a tangy tomato sauce on a perfectly baked base. Perfect for those seeking a more piquant flavour.",
		pizza_slice_diavola = "Diavola Pizza Slice",
		pizza_slice_diavola_description = "Immerse yourself in the bold flavours of a Diavola pizza slice, featuring spicy pepperoni, fiery jalapeños, and gooey cheese on a crispy base. A fiery delight for fans of heat.",
		pizza_slice_ham = "Ham Pizza Slice",
		pizza_slice_ham_description = "Enjoy a slice of Ham pizza, blending sweet ham with creamy mozzarella and a savoury tomato sauce on a golden base. A gratifying fusion of sweet and savoury in every mouthful.",
		pizza_slice_hawaiian = "Hawaiian Pizza Slice",
		pizza_slice_hawaiian_description = "Indulge in a slice of Hawaiian pizza, where the delightful combination of sweet pineapple and savoury ham sits atop a layer of gooey mozzarella and tangy tomato sauce. This unconventional yet satisfying blend challenges the norm and excites the taste buds, proving that unexpected pairings can create a truly memorable dining experience.",
		pizza_slice_pepperoni = "Pepperoni Pizza Slice",
		pizza_slice_pepperoni_description = "Savour the fiery flavour with each bite of this single slice of pepperoni pizza! Let the sizzling pepperoni and melted cheese tantalise your taste buds. This slice is full of heat, making it the ideal choice for a quick and spicy snack!",
		...
		burrito = "Burrito",
		burrito_description = "A burrito is a dish in Mexican and Tex-Mex cuisine consisting of a flour tortilla containing various ingredients.",
		tostada = "Tostada",
		...
		breadcrumbs_description = "These plain breadcrumbs are perfect for adding a crispy, golden coating to your favourite fried or baked dishes. Made from enriched bread, they ensure a delicious crunch every time.",
		...
		orange_juice_description = "Freshly squeezed and full of citrussy sweetness, this orange juice is pure sunshine in a glass, no additives—just hand-pressed orange goodness.",
		...
		banana_peel_description = "From the hit game Mario Cart!",
		...
		cabbage_seeds_description = "These robust cabbage seeds are your first step towards cultivating a patch of crisp, leafy greens. Plant them in any welcoming soil, and watch as they flourish into sturdy cabbages perfect for a variety of culinary delights. From fresh salads to tangy kimchi, these cabbages are ready to enhance your kitchen creations.",
		...
		cigarette = "Cigarette",
		cigarette_description = "If you don't smoke, you're a lightweight! Inhale and appear as the suavest cat in town—at least that's what they say. Your lungs may not approve, but hey, style often calls for sacrifices, right?",
		cigarette_pack = "Cigarette Pack",
		cigarette_pack_description = "A classic pack of fags—because apparently, nothing says \"I'll be back in 5 minutes\" quite like these. Perfect for channelling your inner mysterious dad who went out for fags and... well, you know the rest.",
		cigarette_carton = "Cigarette Carton",
		cigarette_carton_description = "Need a whole carton? Here's your fix! A carton of fags that's a testament to your commitment (or your dad’s, if he’s still out there grabbing them). With 8 packs inside, you’ve got enough to fuel your bad habit and still have a few left to share... or not.",
		snus_pack = "Snus Tin",
		...
		snus = "Snus",
		snus_description = "These little pouches are lifesavers, mate. Just pop one under your lip and boom—instant buzz without any smoke. It’s all about that slow burn and keeping the edge off. Can’t get enough of ’em!",

		cigar_olivia = "Oliva Serie G",
		cigar_olivia_description = "The Oliva Serie G delivers a unique and balanced flavour, blending notes of rich coffee and cedar with a hint of nutty sweetness. Its medium body and smooth finish make it a perfect choice for those who want a refined yet approachable smoke.",
		cigar_romeo = "Romeo y Julieta 1875",
		cigar_romeo_description = "Looking for something mild and approachable? The Romeo y Julieta 1875 delivers a mellow, earthy flavour with a hint of toasted almonds and a touch of sweetness. Perfect for a relaxed evening without the heavy punch.",
		cigar_arturo = "Arturo Fuente Gran Reserva",
		cigar_arturo_description = "With its smooth draw and well-balanced blend, the Arturo Fuente Gran Reserva gives off notes of sweet wood and a hint of nutmeg. Medium-bodied but rich in flavour, it’s ideal for anyone who enjoys a classic smoke without the kick.",
		cigar_cohiba = "Cohiba",
		cigar_cohiba_description = "For those with refined taste, the Cohiba Robusto offers a rich and creamy smoke, blending subtle spice with hints of cedar. It's a smooth, medium-bodied cigar that speaks of sophistication without being overpowering.",

		tobacco_leaf = "Tobacco Leaf",
		tobacco_leaf_description = "This fresh green tobacco leaf is just beginning its journey. Over the next five days, it will dry out, turning a deep brown, perfect for rolling cigars. Keep an eye on that transformation!",
		cigar_homemade = "Cigar (Hand-rolled)",
		cigar_homemade_description = "This hand-rolled cigar delivers a rich, earthy flavour with a hint of spice. Crafted with care and precision, it’s the perfect reward for the time and effort put into every step of the process.",
		...
		antibiotics_description = "These little lifesavers kick parasites to the kerb, especially when you’ve had a little too much of that dodgy, undercooked meat. Pop one of these, and you’ll be feeling less like a bug buffet in no time.",
		pain_killers = "Ibuprofen",
		pain_killers_description = "Ibuprofen is your go-to for tackling headaches, muscle aches, or that time you overdid it at the gym. Known for reducing pain, inflammation, and fever, it’s the small pill that packs a big punch. Just remember, moderation is key—this isn’t sweets, no matter how much your back hurts.",
		...
		pager = "Pager",
		pager_description = "A pager. Seems to only have a single contact and a prepay card allowing only a few messages.",
		...
		plush_green_description = "This plushie has a serious case of bed hair, but don't worry, they're always up for an adventure (even if they can't quite see it coming).",
		plush_red = "Shades the Superstar",
		plush_red_description = "This plushie is always cool, calm, and collected. They may not be able to see without their sunglasses, but they can definitely feel the vibe.",
		plush_pink = "Sir Fancy Pants",
		plush_pink_description = "This plushie is a sophisticated dresser who always looks their best. They may be a little fancy, but they're always grounded (well, as grounded as a plushie in a top hat can be).",
		plush_blue = "Sparky McBowtie",
		plush_blue_description = "This little guy's got the electric look down to a tee, with hair that crackles with energy and a bowtie that always stays dapper. Don't let the sparks fool you, though - Sparky McBowtie is all about cuddles and cosy nights in. Just don't touch his hair when he's charging up for a bedtime story!",
		...
		plush_yellow_description = "This plushie is all about good vibes and positive energy. They may be a little bit laid-back, but they're always up for a good time.",
		plush_orange = "Tang the Explorer",
		plush_orange_description = "This plushie is always on the lookout for new adventures. They may be a bit untidy, but they're always ready for a challenge.",
		plush_wasabi = "Wasabi Whiz",
		plush_wasabi_description = "This little one is a true gem, just like a fresh burst of Wasabi! Their bright green fur is bound to catch attention. Don't underestimate their small size - they're bursting with personality and always ready for excitement.",
		...
		cat_1 = "Black Cat",
		cat_1_description = "Sleek, shadowy, and possibly magical, this black-coated feline knows how to steal the limelight—or your snacks. It is equally cool and cuddly, with a penchant for dramatic entrances and prolonged, disapproving gazes.",
		cat_2 = "Brown Cat",
		cat_2_description = "Warm and earthy, this brown beauty is like a mug of hot chocolate in cat form—if hot chocolate occasionally swiped things off your desk. He is laid-back, affectionate, and surprisingly adept at ignoring your summons.",
		...
		hen_0 = "Chicken",
		hen_0_description = "A sassy hen strutting around like she owns the farmyard—and honestly, she probably does. Always pecking, clucking, and giving you that side-eye, this feathery diva is equal parts adorable and mildly intimidating.",
		rat_0 = "Rat",
		...
		rabbit_0_description = "A deep, dark brown rabbit with an energy level that matches its name. Always alert, ready to sprint, and probably judging you for being slower than it.",
		...
		rabbit_2 = "Tan Rabbit",
		rabbit_2_description = "A tan rabbit with a buttery smooth coat and a talent for hopping into the most inconvenient places. It’s equally adorable and mildly infuriating.",
		rabbit_3 = "Grey Rabbit",
		rabbit_3_description = "A sleek grey rabbit that moves like a puff of smoke in the wind. Blink, and it’s gone—but not before stealing your heart (and maybe your lettuce).",
		...
		lean = "Lean",
		lean_description = "Sipping on some sizzurp, sip, sipping on some, sip.",
		...
		grimace_shake_description = "Mad? I was mad once. They put me in a padded cell. A padded cell with rats. And rats drive me mad. Mad? I was mad once. They put me in a padded cell. A padded cell with rats. And rats drive me mad. Mad? I was mad once. They put me in a padded cell. A padded cell with rats. And rats drive me mad. Mad? I was mad once. They put me in a padded cell. A padded cell with rats. And rats drive me mad. Mad? I was mad once.....",

		hydrogen_peroxide = "Hydrogen Peroxide",
		hydrogen_peroxide_description = "This fizzy concoction, renowned for its effervescence and cleaning properties, is a common sight in laboratories and beyond. While it is primarily known for sterilizing wounds and surfaces, it also has a talent for blending with other substances to create some potent mixtures. Handle with care and a touch of caution.",

		jolly_ranchers = "Jolly Ranchers",
		jolly_ranchers_description = "Indulge in the sweet and tangy flavours of Jolly Ranchers, the classic hard candies that burst with fruity goodness.",
		jolly_rancher_watermelon = "Watermelon Jolly Rancher",
		jolly_rancher_watermelon_description = "Enjoy the invigorating taste of watermelon with these delightful Jolly Rancher hard candies.",
		jolly_rancher_raspberry = "Raspberry Jolly Rancher",
		jolly_rancher_raspberry_description = "Indulge in the delectable combination of sweet and sour raspberry flavour in these Jolly Rancher hard candies.",
		jolly_rancher_apple = "Apple Jolly Rancher",
		jolly_rancher_apple_description = "Savour the crisp and tangy taste of apple with these delicious Jolly Rancher hard candies.",
		jolly_rancher_cherry = "Cherry Jolly Rancher",
		jolly_rancher_cherry_description = "Indulge in the bold and vibrant cherry flavour of these irresistible Jolly Rancher hard sweets.",
		jolly_rancher_grape = "Grape Jolly Rancher",
		jolly_rancher_grape_description = "Experience the juicy and succulent taste of grape with these mouth-watering Jolly Rancher hard sweets.",

		lollipop_pack = "Lollipop Pack",
		lollipop_pack_description = "Dive into a mystery medley of flavours with this lollipop pack. Each one is a sweet surprise, offering a random mix of our delightful and fruity varieties. A joy for the taste buds in every colourful package!",
		lollipop_apple = "Apple Lollipop",
		lollipop_apple_description = "Sweet with a tart twist, this apple-flavoured lollipop is like a walk through autumn orchards, capturing the essence of crisp, juicy apples in every lick.",
		lollipop_coke = "Coke Lollipop",
		lollipop_coke_description = "The classic cola taste captured in a lollipop. It's a bubbly, refreshing treat that delivers the familiar zest of a soda fountain in a swirl of candy.",
		lollipop_grape = "Grape Lollipop",
		lollipop_grape_description = "Bursting with the rich and juicy flavour of vine-ripened grapes, this lollipop is a purple pleasure that'll transport you straight to the sun-drenched fields.",
		...
		lollipop_strawberry_description = "The essence of sun-ripened strawberries is infused in this lollipop, providing a sweet, berry-filled experience that's as lovely as a sunny day.",
		...
		ancient_coin_description = "This coin bears the marks of ancient commerce, its gold surface tarnished by the salt and sands of the sea, holding the weight of centuries in its design. The emblem engraved upon it speaks of an empire's reach and the fluid hand of history that passes wealth from hand to hand.",
		...
		glass = "Rough Glass",
		glass_description = "This basic form of glass, although unpolished and imperfect, is versatile for various crafting needs and basic repairs, providing essential transparency and protection.",
		rubber = "Uncured Rubber",
		rubber_description = "Flexible and mouldable, this uncured rubber is essential for crafting and basic vehicle repairs. Its adaptability makes it suitable for a variety of uses, from insulation to shock absorption.",
		...
		rusty_cannon_ball_description = "Ahoy matey! Behold this ancient cannon ball, retrieved from the depths of a sunken pirate ship. Corroded and weathered by the salty depths, this old relic carries the echoes of fierce sea battles and hidden treasures. Avast, me hearties, handle with care lest ye awaken its fiery spirit!",
		rusty_gear = "Rusty Gear",
		rusty_gear_description = "This aged gear, now rusty and worn, once played a pivotal role in the machinery of bygone eras. Its teeth may be dulled, but it still retains the echoes of numerous rotations in its weathered state.",
		rusty_diving_helmet = "Rusty Diving Helmet",
		rusty_diving_helmet_description = "This ancient diving helmet, covered in a thick layer of rust, once ventured into the depths of the ocean. Now, it stands as a relic of underwater exploration, echoing stories of sunken treasures and maritime adventures.",
		...
		power_saw = "Sawzall",
		power_saw_description = "A versatile reciprocating saw, ideal for quick and rough jobs. Whether you're cutting through metal, wood, or... other materials, this tool gets the job done.",
		...
		catalytic_converter_description = "Got a knack for nighttime car pranks? This shiny hunk of metal is your ticket to quick cash, just don’t let the coppers catch you swiping it from parked cars.",
		car_brakes = "Brakes",
		car_brakes_description = "Precision stopping power right at your fingertips! These high-performance car brakes ensure you can stop on a sixpence. Perfect for any mechanic or DIY car enthusiast.",
		...
		evidence_box = "Evidence Locker",
		evidence_box_description = "The unsung hero of justice, safeguarding all the clues, fingerprints, and questionable items needed to crack a case. From candy wrappers to crime scene tools, it’s like a treasure trove for detectives—minus the gold, plus a lot of paperwork.",
		...
		potassium_nitrate_description = "This white crystalline powder is a key ingredient in the recipe for gunpowder. Found in nature and often used in fertilisers, it packs a punch when mixed with sulphur and charcoal. Handle with care, and remember, no sniffing!",
		sulfur = "Sulphur",
		...
		diamonds = "Diamonds",
		diamonds_description = "You need 24 to make a full armour. I'd recommend getting 27 though so you can get yourself a pickaxe too.",
		...
		cent_1 = "Penny",
		cent_1_description = "The humble penny is Britain’s most overachieving copper-coloured hero. Worth just one pence but often found bravely plugging up fountain wishes or hiding under sofa cushions. It’s basically the coin version of small but mighty.",
		cent_5 = "Five pence",
		cent_5_description = "The five pence coin is a chunkier, silver-toned upgrade from the penny with five times the buying power, which still isn’t much. A loyal companion for vending machines and arcade games, even if its worth is sometimes overlooked.",
		cent_10 = "10p",
		cent_10_description = "The 10p coin is a small but valuable currency, packed with 10 pence worth of value in its compact design. It may be small enough to easily get lost in your pocket, but its worth is double that of a 5p coin.",
		cent_25 = "25p",
		cent_25_description = "The 25p coin is known as the quarter and is a high-value denomination in vending machines and parking meters. With its significant weight and value, this silver coin often leads the charge in your change collection for coffee and arcade adventures.",
		cent_50 = "50p",
		cent_50_description = "The fifty cent piece is a seldom-seen sturdy player in American currency. It's like the cooler, more enigmatic elder sibling of the quarter. Double the value, twice the size, and consistently remarkably shiny.",
		coin_bag = "Coin Bag",
		coin_bag_description = "A reliable little bag intended to prevent your loose change from rattling around. Small, subtle, and ideal for those who wish to transport their money stylishly—presuming your \"money\" is in quarters and dimes.",
		...
		acid = "Acid (LSD)",
		acid_description = "This vibrant tab, often called \"Acid\", is your ticket to a technicolour journey through the mind's eye. Renowned for transforming the mundane into the magical, it offers a kaleidoscope of thoughts and sensations that dance to the tune of the universe. Not just a drop in the bucket, each piece is a splash in the psychedelic pool of perception. Dive in, and let the waves of creativity and insight wash over you. It makes you permanently high, there's no escaping it.",

		rose = "Rose",
		rose_description = "A single, elegant rose, with vibrant petals and delicate fragrance, speaks volumes. This timeless symbol of affection is a classic way to express your feelings, carrying the essence of beauty and deep admiration.",
		...
		scratch_ticket = "Scratchcard (Cash Extravaganza)",
		scratch_ticket_description = "Dive into the blue swirls of chance where bravery meets the dream of wealth. With only £100, embark on a quest that could fill your pockets with up to £210,000. The adventure of a lifetime awaits!",
		scratch_ticket_pearl = "Scratchcard (Black Pearl)",
		scratch_ticket_pearl_description = "Embark on a quest for hidden riches with this mysterious ticket. Your £100 could be the key to unlocking a trove of up to £210,000. Each scratch brings you closer to the ocean's deepest secrets and untold fortunes.",
		scratch_ticket_ching = "Scratch-Off (Cha Ching)",
		scratch_ticket_ching_description = "Immerse yourself in the electrifying thrill of potential wealth. For just £100, this vibrant ticket offers the exhilarating chance to win up to £210,000. It's not just a game, it's a spectacle of fortune!",
		scratch_ticket_carnival = "Scratch Card (Carnival)",
		...
		scratch_ticket_vu = "Scratch Card (Vanilla Unicorn)",
		scratch_ticket_vu_description = "Prostitutes and cocaine.",
		scratch_ticket_beaver = "Scratch Card (Los Santos)",
		scratch_ticket_beaver_description = "Keep scratching!",
		scratch_ticket_minecraft = "Scratch Card (Minecraft)",
		scratch_ticket_minecraft_description = "Creeper...... awww man",
		...
		almond_milk_description = "How on earth did they milk almonds??????",
		...
		twitter_verification_description = "Using this item will grant you verified status on Twitter.",

		vape = "Geek Bar",
		vape_description = "Trying to look cool? Tired of being a pussy? Take a hit bwo!",
		dab_pen = "Dab Pen",
		dab_pen_description = "Yo, this Penjamin? Hits like a lorry, mate. Three solid blinks, and you're off. Once it flashes, it’s game over. No refills, just ride the high while you can.",
		...
		train_pass_appreciated_tier_description = "Can be used for 7 days of Appreciated Tier. It cannot be upgraded using OP Points.",
		train_pass_respected_tier = "Respected Tier",
		train_pass_respected_tier_description = "Can be used for 7 days of Respected Tier. It cannot be upgraded using OP Points.",
		...
		xbox_controller_description = "Looks a bit damp...",

		acetone = "Acetone",
		acetone_description = "Perfect for removing paint or huffing it, Cooper style.",

		bleach = "Bleach",
		bleach_description = "The cleaning liquid, not the anime.",
		...
		glass_pipe_description = "Yo, this pipe, mate, it's like, whoa! Just pack it, light it, and BAM, you're on Mars, bro! Like, shiny and glassy, careful though, it's fragile, like my last brain cell. The colours, mate, the COLOURS! Hold it tight, don’t let it slip, and you're, like, king of the cosmos or something.",
		...
		tent = "Tent",
		tent_description = "This durable tent provides a cosy retreat from the wilds, perfect for resting after a day of adventure. Its sturdy structure and waterproof fabric offer a safe haven under the skies. Can be placed anywhere in the world.",
		...
		canvas_tent_description = "Built for the rugged outdoors, this canvas tent offers sturdy protection with a hint of traditional charm. Its durable material withstands wind and rain, providing a cosy base camp. Can be positioned anywhere in the world.",
		plastic_chair = "Plastic Chair",
		plastic_chair_description = "Straightforward yet practical, this plastic chair provides a convenient spot to rest on the go. It's lightweight and easy to relocate, perfect for brief pauses during your outdoor adventures. Can be positioned anywhere in the world.",
		fishing_chair = "Fishing Chair",
		fishing_chair_description = "Designed for comfort during long waits, this fishing chair combines durability with convenience, featuring a built-in rod holder for those peaceful lakeside mornings. Can be placed anywhere in the world.",
		sleeping_bag = "Camping Bedroll",
		sleeping_bag_description = "Wrap yourself in the warmth of this sleeping bag, designed for cold nights under the stars. Its compact design makes it easy to carry, providing comfort wherever you rest your head.",
		...
		tube_light_description = "A stylish and minimalistic tube light that prioritises style over brightness, offering a gentle glow without dominating the room. Ideal for creating a cosy atmosphere, it's a subtle enhancement that appears much sleeker than its larger alternatives.",
		yoga_mat = "Yoga Mat",
		yoga_mat_description = "This portable yoga mat is your base for relaxation and exercise outdoors. Unroll it to find your inner peace or stretch after a challenging hike. Can be placed anywhere in the world.",
		...
		parasol = "Parasol",
		parasol_description = "Shade yourself from the sun's rays with this colourful parasol. A delightful accessory for sunny days, it provides instant relief from the heat while adding a splash of colour to your setup. Can be placed anywhere in the world.",
		...
		disposable_grill_description = "This disposable grill offers a convenient way to cook delicious meals without the hassle of cleanup. Just light it up, grill to your heart's content, and dispose of it responsibly. Can be placed anywhere in the world.",
		grill = "Grill",
		grill_description = "A sturdy grill designed for the culinary explorer. Whether it's grilling steaks or roasting vegetables, this grill is your reliable companion for creating feasts by the firelight. Can be placed anywhere in the world.",
		torch = "Torch",
		torch_description = "This torch cuts through the darkness, a durable light for adventurous explorers or miners, keeping the darkness at bay with its steady flame.",
		ladder = "Ladder",
		ladder_description = "This strong and sturdy ladder is built to reach new heights safely and reliably. With its large, heavy-duty frame, it ensures stability for challenging tasks that require extra reach and strength. Perfect for those who are not afraid to climb higher and tackle big jobs.",
		police_barrier = "Police Barrier",
		police_barrier_description = "This isn't simply a barrier; it's a boundary. For crowd management, crime scenes, or when you simply require some personal space. Can be placed anywhere in the world.",
		dummy = "Dummy",
		dummy_description = "Not just a good-looking face. Utilise him for target practice, or to add to the numbers during mundane stakeouts. Can be placed anywhere in the world.",
		target = "Target",
		target_description = "Aiming is believing. Perfect your aim, because when it counts, you'll want your accuracy to be as sharp as your wit. Can be placed anywhere in the world.",
		large_target = "Large Target",
		large_target_description = "Larger, because sometimes you need a confidence boost. Hit or miss, it's about practicing until you can't go wrong. Can be placed anywhere in the world.",
		cone = "Cone",
		cone_description = "The unsung hero of traffic control. Useful for directing traffic flow, or as an impromptu football goal during breaks. Can be placed anywhere in the world.",
		...
		spike_strips_large_description = "This one's for catching the big fish or when you need to cover more tarmac. It's like rolling out the red carpet, except it's not for VIPs, and it deflates tyres. Can be placed anywhere in the world.",
		stop_sticks = "Stop Sticks",
		stop_sticks_description = "Think of these as the immovable object meeting the unstoppable force. Stop sticks don’t puncture tyres, they halt vehicles dead in their tracks. Ideal for setting up impromptu \"check your speed\" spots. Can be placed anywhere in the world.",
		speed_bump = "Speed Bump",
		speed_bump_description = "The essential device for encouraging reduced speeds and evaluating a car's suspension. Activate this movable obstacle and observe fast drivers reconsider their decisions—great for transforming pursuits into slow-moving processions.",
		speed_sign = "Speed Limit Sign",
		speed_sign_description = "A friendly reminder that you need to take it easy on the accelerator. Stick to the limit, or risk facing speed bumps and speed cameras.",
		bumps_sign = "Bumps Sign",
		bumps_sign_description = "A courteous warning that your vehicle's suspension is in for a challenge. Drive carefully, or get ready for a rough journey!",
		floodlight = "Floodlight",
		floodlight_description = "Turn night into day when you're on the prowl. Ideal for locating misplaced keys or shedding light on sneaky suspects attempting to play hide and seek. Can be positioned anywhere in the world.",
		left_diversion_sign = "Left Diversion Sign",
		left_diversion_sign_description = "For confusing culprits and making them take a detour to the left. A handy tool for leading wrongdoers astray. Can be placed anywhere in the world.",
		right_diversion_sign = "Right Diversion Sign",
		right_diversion_sign_description = "Similar to its left counterpart, but for redirecting those who missed their right turn at Albuquerque. Guides troublemakers on a scenic path, away from danger. Can be placed anywhere in the world.",
		stop_sign = "Stop Sign",
		stop_sign_description = "Not your average roadside decoration. This one means business and comes with a badge. Halts cars and occasionally pedestrians who read signs. Can be placed anywhere in the world.",
		bear_trap = "Bear Trap",
		bear_trap_description = "This sturdy bear trap is designed to clamp down with relentless force, trapping anything that triggers its powerful jaws. Effective and unforgiving, it makes escape both challenging and painful, ensuring that nothing that steps in gets away easily. A formidable tool for securing any area. Can be placed anywhere in the world.",
		barrier = "Barrier",
		...
		wheel_clamp_description = "No getaway cars here! The Wheel Clamp means business, securing vehicles firmly in place and putting an end to unauthorised movement. This heavy-duty contraption is a silent enforcer, ensuring that parking rules are respected and followed.",
		old_rug = "Old Rug",
		old_rug_description = "Lay down this cosy rug for your next outdoor hangout and keep things comfortable! It’s perfect for lounging on the grass without getting those annoying green stains on your trousers. Spread it out, relax, and enjoy your surroundings in style and comfort.",
		...
		director_chair_description = "Take charge in this classic director's chair, offering a blend of style and comfort. Its sturdy design and elevated seating position make it perfect for overseeing any scene or just enjoying a higher view. Can be placed anywhere in the world.",
		...
		green_fishing_chair_description = "Settle into this sturdy green fishing chair for a relaxing day by the water. Its comfortable backrest and strong frame offer ideal support for extended fishing sessions. Can be placed anywhere in the world.",
		blue_fishing_chair = "Blue Fishing Chair",
		blue_fishing_chair_description = "Indulge in your angling escapades with this durable blue fishing chair. Crafted for durability, it blends comfort with functionality, making it a must-have for any fishing enthusiast. Can be placed anywhere in the world.",

		tire_wall = "Tire Wall",
		tire_wall_description = "This robust tyre wall provides dependable cover in any situation, ideal for strategic positioning in the field. Constructed from tightly packed tyres, it can halt bullets and shield you effectively. Nonetheless, stay alert—incorrect placement may leave your head vulnerable to snipers.",

		claymore = "Claymore",
		claymore_description = "This deadly Claymore mine is a potent defensive device crafted to safeguard and fortify areas with accuracy. Once activated, it will detonate forcefully when a trespasser passes by, guaranteeing strong perimeter security. Exercise care in positioning and handling to prevent unintended outcomes.",
		mine = "Mine",
		mine_description = "Useful for when you want an extra layer of security in case authorities pay a visit. Simply place, arm, and witness any unwanted guests vanish in a cloud of red mist.",

		tv_stand = "TV Stand",
		tv_stand_description = "Enhance your binge-watching setup with this stylish TV Stand. It keeps your TV at the perfect eye level and has space for all your miscellaneous gadgets. It’s like the throne for your screen.",
		big_tv = "Big Telly",
		big_tv_description = "Take a look at the Big Telly! Ideal for those epic film nights or garden parties, this massive screen towers as high as you and transforms any area into an immediate outdoor cinema. Prepare to impress your mates with the top-notch viewing experience!",
		tv_remote = "TV Remote",
		tv_remote_description = "The ultimate gadget for the lazy pro, this Telly Remote allows you to control your entertainment realm without moving a muscle. Switch channels, increase the volume, and browse through your inputs like a boss. It's your pass to couch-potato heaven!",
		...
		coffee_beans_description = "A packet of richly aromatic coffee beans ready to be brewed into the fuel that propels your mornings and late-night brainstorming sessions. Whether you prefer it strong, velvety, or somewhere in between, these beans are your passport to a flawless cup of caffeinated happiness.",
		...
		chocolate_cake_slice_description = "Indulge in a slice of Chocolate Cake, where the luscious chocolate sponge meets creamy chocolate frosting. Every bite is a luxurious delight that simply melts in your mouth.",
		...
		grubs = "Grubs",
		grubs_description = "A fisherman's essential, these grubs are full of potential. Ideal for freshwater fishing, they attract a wide range of fish with their natural appearance and movement.",
		leeches = "Leeches",
		leeches_description = "Robust and efficient, leeches are great for catching game fish. Their lively movements in water make them irresistible bait for larger predators in search of a substantial meal.",
		earthworms = "Earthworms",
		earthworms_description = "The traditional choice, earthworms are popular among anglers for their universal appeal. These plump worms can lure even the most wary fish, making them vital for any fishing trip.",
		...
		raw_meat = "Raw Meat",
		raw_meat_description = "Freshly harvested from the hunt, this raw meat holds the promise of a nourishing meal. Perfect for cooking on a grill, it requires careful handling to unlock its full flavour.",
		cooked_meat = "Cooked Meat",
		cooked_meat_description = "Succulently grilled to perfection, this cooked meat captures the essence of the wild. Each bite is infused with the smoky flavour of the outdoors, providing a satisfying feast after a successful hunt.",
		burnt_meat = "Burnt Meat",
		burnt_meat_description = "Left on the grill for too long, this meat has charred into a less desirable form. Although it's still edible, eating burnt meat might leave you with a bitter taste and some discomfort.",
		leather = "Leather",
		leather_description = "This durable leather, obtained from skinned game, boasts a rugged texture. Ideal for crafting or using in various durable goods, it's a valuable resource for any outdoorsperson or artisan.",
		wood = "Wood",
		wood_description = "This stack of wood, sustainably sourced from local forests, offers both warmth and utility. Perfect for crafting, building, or fueling fires, it's an essential resource for any outdoor or survival setting.",
		charcoal = "Charcoal",
		...
		canine_tooth_description = "A rare and powerful artefact of the wild, this mountain lion tooth symbolises the raw essence of the hunt. A rare prize for any hunter.",
		antlers = "Deer Antlers",
		antlers_description = "Seldom found, these antlers are a hunter's graceful tribute to the silent dance of the wild. A rare and elegant discovery.",
		...
		raw_bacon = "Raw Bacon",
		raw_bacon_description = "This premium bacon, sliced from the best cuts and cured to perfection, is ready to transform any meal into a savoury masterpiece. Ideal for the grill, it awaits to crisp up into a mouthwatering delight.",
		...
		raw_brined_meat_description = "This raw meat, kissed by liquid smoke, carries the promise of future feasts. When grilled, it transforms into beef jerky, a savoury testament to patience and craft.",
		...
		pickle = "Gherkin",
		pickle_description = "A fresh, juicy, and crisp gherkin straight from the jar. Ideal for a tangy snack or as a delicious accompaniment to your meal.",
		pickle_juice = "Gherkin Juice",
		pickle_juice_description = "Invigorating and tangy, this gherkin juice is the lively liquid remnants left behind when you pluck out a gherkin. Perfect for adding a burst of flavour to your snacks or even savouring on its own for a briny treat!",
		dark_chocolate = "Dark Chocolate",
		dark_chocolate_description = "A rich and decadent treat, dark chocolate is perfect for indulging your sweet tooth and savouring the deep, complex flavours of cocoa.",
		beans = "Beans",
		beans_description = "Behold! The Sacred Grail! The Ambrosia of the Gods, contained within a vessel of tin! It is not merely Heinz Baked Beans, my good sir, but a gateway to a realm of pure, unsullied BEAN BLISS! Each bean, a morsel of delight, steeped in a concoction so opulent, it whispereth secrets of flavours unknown. This is not simply sustenance; 'tis the elixir of life itself, encased in a chalice of metal, awaiting to bestow its magnificence upon thy taste buds. Embrace the bean! Worship the bean! Let each morsel transport thee to a dominion where beans reign supreme, and every spoonful is a stride closer to the bliss of beans.",
		beans_toast = "Beans on Toast",
		beans_toast_description = "A classic British dish, beans on toast is a simple and satisfying meal that's perfect for breakfast, lunch, or dinner. The rich, savoury flavours of the beans pair perfectly with the warm, buttery toast, creating a comforting and hearty meal that's quick and easy to prepare.",
		...
		grilled_sausages_description = "Savour the smoky aroma of these freshly grilled sausages, a culinary reward for the adept hunter. Juicy, flavoursome, and cooked to perfection, they're a rustic delight that celebrates the spirit of the hunt with every bite.",
		grilled_bacon = "Grilled Bacon",
		grilled_bacon_description = "Crispy, golden, and irresistibly smoky, this grilled bacon is the ultimate indulgence for those who appreciate the finer things in life. Fresh off the grill, it's a sizzling celebration of flavour, ready to be savoured.",
		fried_egg = "Fried Egg",
		...
		rice_krispies_description = "Sweet, crispy, and a bit nostalgic, these puffed rice treats snap, crackle, and pop with every bite. Perfect for quick snacks or homemade marshmallow bars!",
		...
		uncooked_rice_description = "This staple grain, uncooked rice, is the blank canvas of countless culinary masterpieces. Raw and ready for transformation, it promises to absorb flavours and enhance any dish, from hearty risottos to delicate sushi rolls.",
		rice = "Cooked Rice",
		rice_description = "Light and fluffy, this cooked rice is a versatile base ready to pair with any meal. Perfectly steamed to capture its subtle, nutty essence, it’s the comforting cornerstone of dishes around the world, adding both substance and texture to your dining experience.",
		nori = "Nori",
		...
		chili_description = "These fiery little peppers pack a punch! Whether you're adding a bit of zing to your salsa or turning up the heat in your favourite dish, these vibrant chillies are your go-to for a spicy kick. Handle with care unless you want your fingers to tingle and your taste buds to dance!",
		...
		sushi = "Sushi",
		sushi_description = "Expertly crafted, this sushi maki features fresh fish fillets, perfectly steamed rice, and crisp nori. Each roll is a harmonious blend of flavours and textures, offering a delightful taste of traditional Japanese cuisine in every bite. Enjoy the refined simplicity of this exquisite sushi.",
		nigiri = "Nigiri",
		nigiri_description = "This elegant nigiri sushi showcases thinly sliced fish atop a bed of subtly seasoned rice. Each piece is a testament to simplicity and flavour, carefully balanced to highlight the fresh, delicate taste of the seafood. A classic choice for sushi aficionados, it's as visually appealing as it is delicious.",
		miso_soup = "Miso Soup",
		...
		spring_onions_cut = "Chopped Spring Onions",
		spring_onions_cut_description = "These freshly chopped spring onions are all ready to enhance your culinary creations. Ideal for garnishing or mixing into dishes, their vibrant, peppery flavour adds both taste and a splash of colour, making every meal more delicious and visually appealing.",
		tofu = "Tofu",
		tofu_description = "This versatile block of tofu is a key ingredient for healthy and creative cooking. Made from soybeans, it's a mild-flavoured favourite that absorbs flavours wonderfully, making it perfect for everything from stir-fries to smoothies.",
		tofu_cubes = "Tofu Cubes",
		tofu_cubes_description = "Pre-cut into perfect cubes, this tofu is ready to be added to your next culinary creation. Perfect for speedy meals, these tofu cubes can be tossed into soups, salads, or stir-fries, providing a nutritious boost and a delightful texture to your dishes.",
		uncooked_ramen = "Uncooked Ramen",
		uncooked_ramen_description = "Your DIY ramen kit, ready for you to turn into a piping hot bowl of deliciousness. Simply add hot water and your preferred toppings, and you'll have a speedy and flavoursome meal in no time!",
		ramen = "Ramen",
		...
		mochi_chocolate_description = "A decadent chocolate mochi that envelops a chewy, soft exterior around a rich, cocoa-filled centre. Perfect for satisfying sweet cravings with a touch of gooey indulgence.",
		green_tea_bag = "Green Tea",
		green_tea_bag_description = "A pouch of premium loose green tea leaves, ready to immerse you in a world of earthy, refreshing flavour. Perfect for tea enthusiasts who appreciate the art of brewing over the convenience of a pre-made bag. Take a sip of this, and you'll savor the tranquility.",
		...
		green_tea = "Green Tea",
		green_tea_description = "A warm, soothing cup of freshly brewed green tea that envelops you in its earthy aroma and delicate flavour. Perfect for moments of tranquillity or a gentle energy boost, it’s like a comforting embrace in a cup for your spirit.",
		...
		skate_helmet_description = "Keep your head safe while looking cool with this reliable skate helmet. Perfect for preventing unwanted head knocks and showcasing your style, it's an essential for every skater. Safety comes first, fun comes second!",
		...
		bong = "Bong",
		bong_description = "Take your smoking experience to the next level with this top-quality glass bong. Engineered for smooth, chilled hits, it passes smoke through water for a cleaner, more pleasurable session. Ideal for solo use or sharing with friends, simply fill, pack, light up, and enjoy!",
		bong_water = "Bong Water",
		bong_water_description = "\"Can I have a sip of your bong water?\"",
		...
		pickaxe = "Pickaxe",
		pickaxe_description = "This reliable pickaxe will assist you in demolishing any blocks you’ve placed, clearing the way for new creations. Sturdy and effective, it’s the essential tool for any builder eager to reshape the world.",
		...
		keycard_green_description = "Used to open storage areas full of medical supplies. Property of the Los Santos Fleeca Bank.",
		keycard_blue = "Blue Keycard",
		keycard_blue_description = "Used to open storage areas full of technical supplies. Property of the Los Santos Fleeca Bank.",
		...
		lingcod_description = "Lingcod are voracious predators and can grow to weigh over 80 pounds (35 kg) and measure 60 inches (150 cm) in length. They are characterized by a large mouth with 18 sharp teeth. Their colour is variable, usually with dark brown or copper blotches arranged in clusters.",
		...
		weapon_battlerifle = "Assault Rifle",
		...
		weapon_stunrod_description = "When blunt force trauma simply doesn't cut it, consider broadening your approach to assault with a jolt of 30,000 volts.",
		...
		weapon_battlerifle_description = "Introducing the Assault Rifle, a combination of FN FAL reliability and Heckler & Koch G3 precision. With a magazine similar to the Vepr 7.62x54r, it's your ultimate choice for power and accuracy on the battlefield.",
		...
		weapon_addon_glock_description = "This compact and dependable Glock 19 proudly displays a Union Jack on the slide, because nothing symbolises freedom quite like the flag of the UK. Ideal for patriotic individuals who prefer their firearms as strong as their love for the country.",
		...
		weapon_addon_svd_description = "Precision and power, the SVD Dragunov is a semi-automatic sniper rifle that has been a staple of military and law enforcement units for decades. It's the perfect choice for long-range engagements, and it's guaranteed to make your enemies think twice about crossing you.",

		weapon_addon_axmc = "AXMC",
		weapon_addon_axmc_description = "The AXMC is a pinnacle of sniper engineering, offering exceptional long-range accuracy and a modular design that sets a benchmark for precision shooting.",
		...
		weapon_addon_tennisball_description = "Ideal for a swift game, distracting canines, or a lively throw across the room. Just aim, throw, and enjoy its unpredictable bounce—extra points if it doesn't return!"
	},
	...
	invisibility = {
		...
		invisibility_mode_full = "Invisibility mode set to 'full'. Ordinary staff members cannot see you.",
		invisibility_mode_normal = "Invisibility mode set to 'normal'. Ordinary staff members can now see you.",
	...
	items = {
		...
		failed_kissaki_delivery = "Failed to open the Kissaki meal.",
		failed_green_wonderland_delivery = "Failed to open the Green Wonderland bag.",
	...
	jail = {
		...
		check_not_jailed = "That player is not imprisoned.",
		remaining_time_check = "${fullName} is imprisoned for ${remaining}.",
		invalid_operation = "Invalid operation. Must be either `add` or `sub`.",
		invalid_amount = "Invalid amount. Must be above 0 and below or equal to 5.",
		failed_modify_jail = "Failed to adjust imprisonment time.",
		modified_jail = "Adjusted imprisonment time for ${fullName}. Their new imprisonment time is ${remaining}.",
		jail_mission_info = "You can complete missions on your map to reduce your time in prison.",

		trigger_lockdown = "Initiate Lockdown",
		press_trigger_lockdown = "[${InteractionKey}] Initiate Lockdown",
		...
		jailed = "You have been jailed for ${amount}.",
	...
	login = {
		...
		cache_assets_performance = "Enjoy better FPS and fewer ping spikes during gameplay, especially if you have lower-spec hardware or a slower connection.",
		...
		cache_assets_disk = "This will use some disk space, so make sure you have enough available.",
		cache_assets_no_repeat = "You won't need to do this for every update, as only a few files will change.",
		vehicles = "Vehicles",
		objects = "Objects",
		peds = "Peds",
		clothing = "Clothing",
		...
		check_out_community_content = "Feeling bored? Have a look at our community content here!",
		community = "Community",
		live = "Live",
		...
		bad_words = "Your name or backstory contains prohibited words. Attempting to bypass the filter will lead to a ban. All new characters are assessed by staff.",
		disallowed_name = "Your name contains prohibited words. Attempting to bypass the filter will lead to a ban. All new characters are assessed by staff.",
		disallowed_birthday = "Your date of birth is not allowed. Attempting to bypass the filter will lead to a ban. All new characters are assessed by staff.",
		...
		help_out_text_part_2 = "If you wish to help out too (if you go AFK, for example), it would be greatly appreciated if you go here and click 'Start Screenshotting'. It will fade out your game and put you on standby, ready to create images.",
		...
		medal_what_is_this_text_part_1 = "By receiving views and likes on your Medal clips, you can earn OP Points! You earn one point per 2 clips, one point per 500 views, and one point per 50 likes.",
		...
		referrals_what_is_this_text_part_1 = "Invite your friends to join the server and start earning OP Points together! Once they join, have them enter your Licence ID below to set you as their referrer.",
	...
	lottery = {
		...
		lottery_about_to_roll = "A winner will be drawn in 5 minutes for today's lottery. The total pot is currently at £${totalAmount} where you have put in £${betAmount}. Your chance of winning is ${odds}%.",
		current_lottery_pot = "The total pot is currently at £${totalAmount} where you have put in £${betAmount}. Your chance of winning is ${odds}%.",
	...
	lucky_wheel = {
		...
		vehicle_won_tweet = "Someone's just hit the jackpot at the Lucky Wheel and won the ultra-rare ${modelDisplayName}! Who's the lucky winner? Head over now and claim your prize.",
	...
	magazines = {
		...
		magazine_created = "Created magazine series '${seriesName}' with issue ID #${issueId}."
	},
	...
	mechanics = {
		...
		opening_shop = "${time}s until opening mechanic shop.",
		closing_shop = "${time}s until closing mechanic shop.",
		shop_closed = "Mechanic shop successfully closed.",
		shop_opened = "Mechanic shop successfully opened.",
		failed_shop_closed = "Failed to close mechanic shop.",
		failed_shop_opened = "Failed to open mechanic shop.",

		opened_shop_logs_title = "Mechanic Shop Opened",
		opened_shop_logs_details = "${consoleName} opened the `${label}` mechanic shop.",
		closed_shop_logs_title = "Mechanic Shop Closed",
		closed_shop_logs_details = "${consoleName} closed the `${label}` mechanic shop."
	},

	meow = {
		feed = "[${InteractionKey}] Feed",
		pet = "[${InteractionKey}] Stroke",
	...
	minecraft = {
		...
		success_wipe_blocks = "Successfully cleared ${count} block(s) in a ${radius}m radius.",
	...
	miscellaneous = {
		...
		bad_twitter_account = "Attempted to create a potentially bad twitter account: \"${username}\"",
		...
		no_player_matching = "No player matches the search: *${search}*.",
		whois_player = "Player *${name}* matches your search.",
	...
	overview = {
		...
		seatbelt_sound = "Disable Seatbelt Chime",
	...
	oxy = {
		...
		taking_too_long_4_part_1 = "You're taking far too long mate, are you trying to steal my job or something?",
	...
	pacific_bank = {
		...
		teller_door_hack_completed_logs_details = "${consoleName} completed the teller door hack at Pacific Bank.",

		vault_door_hack_completed_logs_title = "Vault Door Hack Completed",
		vault_door_hack_completed_logs_details = "${consoleName} completed the vault door hack at Pacific Bank.",
		...
		not_enough_police = "There are not enough active police officers to initiate the robbery.",
		...
		power_generator_disabled_details = "${consoleName} disabled the power generator named '${powerGeneratorName}'.",
		...
		pacific_bank_reward_saving_bonds_logs_details = "${consoleName} searched a safe and received savings bonds worth £${amount}.",
	...
	pawn_shops = {
		...
		pawn_shop_far = "Access Pawnbroker",
		pawn_shop_near = "[${InteractionKey}] Access Pawnbroker",
	...
	ped_messages = {
		...
		rps_message = "played rock paper scissors and chose ${rps}",
	...
	ped_spawn = {
		...
		no_nearby_ped = "There are no nearby NPCs.",
		ped_attack_success = "Successfully made NPC `${networkId}` attack ${target}.",
		ped_failed_attack = "Failed to make NPC `${networkId}` attack ${target}.",
	...
	prescriptions = {
		...
		remeeded_prescription_logs_details = "${consoleName} has redeemed a prescription and received 1x `${item}`."
	},
	...
	reflect = {
		...
		reflection_logs_enabled_details = "Upgrading Pledge, you asshole",
		reflection_logs_disabled_details = "Fucking Available Upgrades"
	},
	...
	savings_accounts = {
		savings_accounts = "${cost} fucking points, bitch",
		button_close = "Fucking Buy",
		button_back	= "Back",
		button_confirm = "Confirm Pledge Upgrade, you prick",
		button_delete = "Are you sure the fuck you want to upgrade your ${pledgeLabel} pledge to ${pledgeUpgradeLabel} for ${cost} OP points, motherfucker?",
		button_manage = "Upgrading Pledge, goddamn it...",
		button_leave = "Leave",
		create_account = "Sold Meth, assholes",
		delete_account = "${consoleName} sold 1x Meth Bag for $${reward}, you fucking cunts.",
		confirm_delete = "~g~Active, bitches",
		loading = "Loading...",
		...
		no_summary = "No transactions to summarise.",
	...
	scrapyard = {
		...
		scrapyard = "Breakers Yard",
		cant_scrap_vehicle = "Sorry, mate, but that car's got more red flags than a rodeo. Can't take it off your hands!",
		failed_scrap_vehicle = "Looks like our breakers yard's got the hiccups. Try scrapping your ride again later, mate!",
		...
		scrap_success = "Well, we turned that old car into treasure. I suppose it was time to bid farewell anyway, partner!",
	...
	screenshots = {
		...
		screenshot_error_blackscreen = "Unable to take a screenshot of the user due to a black screen.",
	...
	screenshots_create = {
		...
		screenshots_taken = "You have taken ${screenshotsTaken} screenshot(s). Out of these, ${screenshotsTakenNow} were taken just now.",
		...
		unban = "Unban (${unbansLeft} remaining)",

		screenshotting_start_logs_title = "Screenshotting Start",
		screenshotting_start_logs_details = "${consoleName} started capturing screenshots.",

		screenshotting_stop_logs_title = "Screenshotting Stop",
		screenshotting_stop_logs_details = "${consoleName} stopped capturing screenshots.",

		user_does_not_exist = "This user does not exist.",
		screenshotter_already_banned = "This screenshotter is already banned.",
		screenshotter_banned = "This screenshotter has now been banned."
	},
	...
	scuba_gear = {
		...
		cant_use_in_vehicle = "You can't put on your scuba gear while in a vehicle."
	},
	...
	shopping_carts = {
		press_to_enter = "Press ~INPUT_DETONATE~ to get in the cart.",
		press_to_exit = "Press ~INPUT_VEH_DUCK~ to exit the cart.",
		press_to_push = "Press ~INPUT_CONTEXT~ to push the trolley.",
		press_to_stop_pushing = "Press ~INPUT_VEH_DUCK~ to stop pushing the trolley.",
		failed_enter = "Failed to hop into the trolley.",
		flipping = "Trolley Flipping"
	},
	...
	skateboards = {
		...
		swapping_deck = "Swapping Skateboard Deck"
	},
	...
	smell = {
		...
		smell_weed = "You can smell cannabis. The smell is ${intensity}.",
	...
	spawn = {
		...
		cayo_police_station = "Cayo Perico Police Station",
		prison = "Prison",

		mount_zonah = "Mount Zonah",
		rockford_fire_dep = "Rockford Fire Department",
	...
	starter_car = {
		follow_the_checkpoints = "Your personal vehicle is parked nearby. Follow the waypoints to find it.",
	...
	status = {
		...
		failed_to_set_body_armor_level = "Failed to execute the `/set_body_armour` command correctly.",
	...
	teleporting = {
		...
		teleport_player_here_logs_title = "Teleported Player To Themselves",
	...
	taxes = {
		taxes_collected = "Collected taxes. The amounts are as follows.\n- Cash: £${cash}\n- Bank: £${bank}\n- Stocks: £${stocks}\n- Savings: £${savings}\n- Shared Accounts: £${sharedAccounts}",
		taxes = "Taxes",
	...
	teleporters = {
		...
		enter_phone_tower = "Enter Mobile Phone Tower",
		enter_phone_tower_interact = "[${InteractionKey}] Enter Mobile Phone Tower",

		exit_phone_tower = "Exit Mobile Phone Tower",
		exit_phone_tower_interact = "[${InteractionKey}] Exit Mobile Phone Tower"
	},
	...
	test_server = {
		...
		add_stress = "Increase Stress",
		feed = "Feed Yourself",
		relief_stress = "Relieve Stress",
	...
	titanic = {
		...
		created_titanic_logs_details = "${consoleName} created a Titanic with a sinking time of ${sinkTime} minute(s) at ${coords}."
	},
	...
	trackers = {
		...
		department_medical_training = "Emergency Medical Services Training",
		department_bcfd_training = "Blaine County Fire Department Training"
	},
	...
	train_pass = {
		...
		non_lucky_wheel_train_pass_used_logs_title = "Non-Lucky Wheel Train Pass Utilised",
		non_lucky_wheel_train_pass_used_logs_details = "${consoleName} utilised a train pass that did not originate from the Lucky Wheel."
	},
	...
	twitter_bid = {
		...
		information_part_1 = "Ready to take charge on Twitter? Show the world who's in control by becoming the top bidder for the blue verification badge!",
		information_part_2 = "The highest bidder receives the sought-after blue checkmark, but be aware — someone could outbid you at any moment. Maintain your top position by outbidding them in return.",
		...
		bid_must_be_greater_than_current_bidder = "Bid must be greater than the current bidder.",
		max_quote_length_exceeded = "Maximum quote length exceeded.",
		not_enough_bank_balance = "Insufficient bank balance.",
	...
	vdm = {
		...
		success_hop_in = "Successfully instructed pedestrian to get in.",
		failed_hop_in = "Failed to make pedestrian get in.",
		no_free_seats = "No available free seats."
	},
	...
	voice = {
		...
		broadcast_all_logs_details_on = "${consoleName} turned on broadcast for all players.",
		broadcast_all_logs_details_off = "${consoleName} turned off broadcast for all players.",
	...
	wizard = {
		...
		enter_vehicle_player = "Enter Nearest Vehicle",
	...
	zombies = {
		...
		not_able_to_loot_in_interior = "You cannot loot zombies inside buildings."
	},
	...
	interface = {
		...
		interface_crashed = "It seems your interface has crashed. This most likely means that you were running out of memory. It has automatically been restarted and things should continue working as normal, but if they don't, please let us know in the framework Discord server."
	},
	...
	bus_driver = {
		...
		not_enough_money_ticket = "You do not have enough cash for a ticket (£18).",
		ticket_paid = "${displayName} paid for a bus ticket.",
		paid_for_ticket = "You have successfully paid for a bus ticket.",
		invalid_route_name = "Missing or invalid bus route name.",
		already_in_mission = "You are already on a bus mission.",
		...
		paleto_route = "Great Ocean Express Line",
		grapeseed_route = "Grapeseed Greenway Line",
		route_68_route = "Route 68 Direct Line",
		airport_route = "Airport Shuttle Line",
	...
	doj = {
		invalid_type = "${consoleName} looked up a `${type}`, searching for `${search}`.",
		missing_search = "Invalid time specified.",
		lookup_failed = "Invalid or missing number plate.",

		result_signature = "Successfully put a hold on the vehicle with number plate `${plate}` for ${time}.",
		result_title = "Failed to put a hold on the vehicle.",
		result_text = "No vehicle with that number plate found.",

		looked_up_character_logs_title = "The vehicle is already impounded by the police for a longer time than you specified.",
		...
		vehicle_hold_logs_title = "${consoleName} looked up a `${type}`, searching for `${search}`.",
		vehicle_hold_logs_details = "Invalid time specified."
	},
	...
	emergency = {
		...
		no_nearby_player = "No restrained or incapacitated player nearby.",
	...
	jobs = {
		...
		failed_job_data = "Failed to retrieve job data for player.",
	...
	police = {
		...
		tint_1 = "This window's tint is pure black.",
		tint_2 = "This window's tint is dark smoke.",
		tint_3 = "This window's tint is light smoke.",
		tint_4 = "This window's tint is limo.",
		tint_5 = "This window's tint is green.",
	...
	state = {
		...
		license_driver = "Driving Licence",
		license_bar = "Bar/Law Licence",
		license_press = "Press Licence",
		...
		failed_marriage = "Failed to set marriage status.",
		marriage_success = "${nameA} and ${nameB} are now married.",
		divorce_success = "${nameA} and ${nameB} are no longer married.",
		character_not_online = "One of the partners is currently not online. Only deceased partners can be divorced while offline.",
		...
		divorced_logs_details = "${consoleName} updated the marriage status of ${nameA} #${cidA} and ${nameB} #${cidB} to 'divorced'.",
		married_logs_title = "Married",
		married_logs_details = "${consoleName} updated the marriage status of ${nameA} #${cidA} and ${nameB} #${cidB} to 'married'."
	},
	...
	tasks = {
		...
		task_take_out_trash = "Empty the bin.",
		task_take_out_trash_near = "Press ~INPUT_DETONATE~ to empty the bin.",
		task_take_out_trash_active = "Emptying Bin",
		...
		task_restock_drink_dispenser = "Restock the drinks dispenser.",
		task_restock_drink_dispenser_near = "Press ~INPUT_DETONATE~ to restock the drinks dispenser.",
		task_restock_drink_dispenser_active = "Restocking Drinks Dispenser",
		...
		task_organize_shelf = "Organise the shelf.",
		task_organize_shelf_near = "Press ~INPUT_DETONATE~ to organise the shelf.",
		task_organize_shelf_active = "Organising Shelf",
		...
		task_file_taxes = "Submit tax return.",
		task_file_taxes_near = "Press ~INPUT_DETONATE~ to submit tax return.",
		task_file_taxes_active = "Submitting Tax Return",

		task_refill_napkins = "Restock napkins.",
		task_refill_napkins_near = "Press ~INPUT_DETONATE~ to restock napkins.",
		task_refill_napkins_active = "Restocking Napkins",

		task_refill_water = "Refill water cooler.",
		task_refill_water_near = "Press ~INPUT_DETONATE~ to refill the water cooler.",
		task_refill_water_active = "Refilling Water Cooler",
	...
	boats = {
		...
		vehicle_not_anchorable = "You cannot moor this boat."
	},
	...
	clamps = {
		...
		clamped_log_details = "${consoleName} attached a wheel clamp to a vehicle with registration `${plate}`.",
		unclamped_log_title = "Removed Clamp",
		unclamped_log_details = "${consoleName} remove a wheel clamp from a vehicle with registration `${plate}`."
	},
	...
	fuel = {
		...
		fuel_pump_text = "Invalid or missing number plate.",
		...
		gas_station = "Gas Station",
		petrolcan_fuel_text = "Successfully put a hold on the vehicle with number plate `${plate}` for ${time}.",
	...
	garage_access = {
		...
		failed_allow_access = "Failed to allow access to the garage.",
		failed_remove_access = "Failed to remove access from the garage.",
		already_has_access = "Character already has access to your garage.",
		invalid_character_id = "Invalid character ID.",
		does_not_access = "Character already does not have access to the garage.",
	...
	garages = {
		...
		vehicle_garaged = "Failed to put a hold on the vehicle.",
		garaged_failed = "Failed to store the vehicle.",
		invalid_vehicle_id = "No vehicle with that number plate found.",
		ungarage_success = "The vehicle is already impounded by the police for a longer time than you specified.",
	...
	oil = {
		...
		low_oil = "Your vehicle needs an oil service!",
		no_nearby_vehicle = "No nearby vehicle.",
		vehicle_has_no_engine = "The nearest vehicle does not have an engine.",
	...
	plates = {
		...
		cancelled_resetting_plate = "Cancelled resetting number plate.",
	...
	trailers = {
		cant_attach_trailer = "This vehicle has no tow bar.",
		no_trailer_nearby = "No trailer nearby.",
		not_in_vehicle = "You are not driving a vehicle.",
		not_lined_up = "Your vehicle is not aligned with the trailer.",
	...
	ammo = {
		...
		fill_ammo_player_logs_title = "Refilled Player's Ammo",
		fill_ammo_player_logs_details = "${consoleName} refilled ${targetConsoleName}'s ammo."
	},
	...
	weapons = {
		...
		petrolcan_explosion_logs_details = "${consoleName} detonated a petrol can and caused an explosion."
	},
	...
	alpha = {
		...
		no_free_bed_found = "No available bed was found.",
		...
		respawn_warning = "Do not respawn if you are still engaged in an active roleplay scenario.",
		...
		thanks_for_loot = "You were mugged while unconscious. Some items may be missing. Rumour says it was Nancy.",
		...
		driver_license_owner = "<i>This driving licence belongs to <b>${fullName} (#${characterId})</b>.</i>",
		press_pass_owner = "<i>This press pass belongs to <b>${fullName} (#${characterId})</b>.</i>",
		has_portrait = "<i>It has a photograph.</i>",
		...
		cigarette_carton = "${packs} packs of cigarettes remaining.",
		...
		evidence_vehicle_dna = "DNA was collected in vehicle with registration ${plateNumber} on seat ${seat}. DNA matched to ${fullName} (ID: ${characterId}).",
		...
		clothing_dna_trace = "DNA traces matched to ${fullName} (ID: ${characterId})",
		...
		evidence_bag_casing = "Bullet Casings: ${casings} casing(s) were fired from a ${weapon} (${serialNumber}) registered to ${name} (#${cid}) (retrieved at ${time} near ${location}).",
		evidence_bag_casing_unregistered = "Bullet Casings: ${casings} casing(s) were fired from an unregistered ${weapon} (${serialNumber}) (retrieved at ${time} near ${location}).",
		...
		evidence_bag_vehicle = "Vehicle DNA: Sample came back to ${name} (#${cid}) and was extracted from seat ${seat} in a vehicle with the registration number ${plate} (picked up at ${time} near ${location}).",
		evidence_bag_vehicle_empty = "Vehicle DNA: Sample did not match any record and was extracted from seat ${seat} in a vehicle with the registration number ${plate} (picked up at ${time} near ${location}).",
