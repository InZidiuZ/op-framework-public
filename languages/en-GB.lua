...
OP.Global.Locales.Languages["en-GB"] = {
	...
	commands = {
		...
		suspension_height_command_help = "Adjust a vehicle's visual suspension height.",
		suspension_height_command_parameter_value = "value",
		suspension_height_command_parameter_value_help = "The amount you would like it to be adjusted. This can range from -0.15 to 0.1, with 0 being the default.",
		...
		wipe_throwables_command_help = "Clears all thrown weapons within the specified radius.",
		wipe_throwables_command_parameter_radius = "radius",
		wipe_throwables_command_parameter_radius_help = "The radius to clear thrown weapons in (default: 5).",
	...
	vpn = {
		vpn_not_allowed_for_new_players = "Players with less than 24 hours of playtime are not permitted to use a VPN."
	},
	...
	staff_pm = {
		...
		reports_too_fast = "You are sending reports too quickly, please slow down.",
		...
		staff_toggled = "Your staff status has been toggled off.",
