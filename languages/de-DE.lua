...
OP.Global.Locales.Languages["de-DE"] = {
	...
	commands = {
		...
		suspension_height_command_parameter_value_help = "Der Betrag, um den Sie es ändern möchten. Dies kann von -0,15 bis 0,1 reichen, wobei 0 der Standardwert ist.",
