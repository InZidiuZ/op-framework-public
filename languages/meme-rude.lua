...
OP.Global.Locales.Languages["meme-rude"] = {
	...
	inventory = {
		...
		sleeping_bag_description = "A portable bed for the weary traveler, perfect for camping, hunting, and fishing! It's supposed to be like sleeping on a fucking cloud... but let's be real, it's just a shitty bag on the ground.",
	...
	vape = {
		...
		plain_vape = "Nerdy Ass Bar",
		weed_vape = "Nerdy Ass Bar (THC Oil)",
		mango_vape = "undefined",
		strawberry_vape = "undefined",
		menthol_vape = "undefined",
		apple_vape = "undefined",
