...
OP.Global.Locales.Languages["meme-rude"] = {
	...
	admin = {
		...
		important_staff_pm_title = "undefined",
		close_staffpm = "undefined",
		staffpm_from = "undefined",
	...
	commands = {
		...
		garage_vehicle_command_parameter_network_id = "undefined",
		garage_vehicle_command_parameter_network_id_help = "undefined",
	...
	debug = {
		...
		addon_model = "${modelName} (Addon), because just the model name wasn't enough for your dumbass.",
	...
	inventory = {
		...
		inspect_bank_gold_bar = "undefined",
		inspect_gold_bar = "undefined",
		...
		paper = "Photo Fucking Paper",
		paper_description = "A fucking blank piece of paper for printing fucking pictures.",
		card_paper = "Fucking Card Paper",
		card_paper_description = "A fucking blank piece of paper for printing fucking business cards.",
		...
		keycard_green_description = "undefined",
		keycard_blue = "Blue as My F*cking Balls Keycard",
		keycard_blue_description = "undefined",
		keycard_red = "Fucking Red Keycard",
		keycard_red_description = "undefined",
	...
	meow = {
		...
		chill_active = "Fucking chilling with Maxwell",
		meditate_active = "Fucking meditating with Maxwell",
		salute_active = "Fucking saluting Maxwell",
		stretch_active = "Fucking stretching with Maxwell",
	...
	printer = {
		...
		printed_logs_details = "${consoleName} fuckin' printed a `${itemName}` using that fuckin' `${paperType}` with the image URL `${url}`."
	},
	...
	sync = {
		...
		developer_ambience_on = "Fuckin' developer ambience fuckin' toggled the fuck on.",
		developer_ambience_off = "Fuckin' developer ambience fuckin' toggled the fuck off."
	},
	...
	garages = {
		...
		unable_to_withdraw = "Sorry, shithead, but you can't withdraw the fuckin' vehicle right now.",
		...
		vehicle_garaged = "F*ck yeah, we successfully put that piece of sh*t in the f*cking garage",
