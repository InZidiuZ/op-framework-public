...
OP.Global.Locales.Languages["meme-rude"] = {
	...
	emotes = {
		...
		uncarry_missing_permissions = "You fucking tried to force stop carrying without fucking proper permissions, you dumb shit.",
	...
	admin = {
		...
		add_vehicle_added_vehicle_for_player = "Added that fucking piece of shit vehicle with the model name `${modelName}` for that dumbass ${consoleName}.",
		add_vehicle_added_vehicle = "Added that shitty vehicle with the model name `${modelName}`.",
		...
		vehicle_saved = "Successfully saved the f**king vehicle with model name `${modelName}`.",
		...
		important_staff_pm_title = "!STAFF PM You -> ${recipient}, pay attention!",
		close_staffpm = "Close, dumbass",
		staffpm_from = "StaffPM from <i>${from}</i>, so listen up!",
		important_staff_pm_logs_title = "Important F**king Staff PM",
		important_staff_pm_logs_details = "${senderConsoleName} sent the following important f**king message to ${recipientConsoleName}: `${message}`",
		...
		super_jump_feature = "Super Fucking Jump",
		server_id_hidden_feature = "Fucking Hidden Server-ID",
		fake_disconnect_feature = "Fake-DC, You Fucking Cunt",
		...
		clean_ped_no_permission = "Attempted to Fuckin' Clean a Player's Shitty Ped Without Fuckin' Proper Permissions.",
		...
		item_durability_set_no_permission = "You fucking tried setting an item's durability without fucking proper permissions, you dumbass.",

		item_metadata_set_no_permission = "You fucking tried setting an item's metadata without fucking proper permissions, you idiot.",
	...
	anti_cheat = {
		...
		underground_ban = "Well, well, well, looks like you've fucking fallen into a damn rabbit hole, you moron.",
		...
		type_bad_screen_word = "Shitty Screen Word",
	...
	commands = {
		...
		wipe_command_parameter_model_name_help = "If you are bloody wanting to only delete entities of a certain model name, insert a model name here, ya disgusting wanker. Otherwise leave bloody blank, at `false` or `0`, you bloody twat. You can also set this to `vehicles`, `peds`, `objects` or `doors`, you filthy nonce.",
		...
		cache_join_toggle_command = "undefined",
		cache_join_toggle_command_help = "undefined",
		...
		debug_info_command_substitutes = "",
                ...
                where_is_street_command_help = "Locate a certain street on the map. Because apparently, you're too dumb to find it yourself.",
                where_is_street_command_parameter_name = "name",
                where_is_street_command_parameter_name_help = "The name or part of the name of the street. Figure it out, genius.",
	...
	proxy = {
		...
		proxied_via_logs_details = "${consoleName} was fucking proxied via `${serverName}`."
	},
	...
	boomboxes = {
		...
		music = "S***ty Music",
                ...
                mute_boomboxes = "Mute Boomboxes, because nobody wants to hear that shit.",
                mute_boomboxes_enabled = "All boomboxes are now muted. Thank fucking god.",
                mute_boomboxes_disabled = "All boomboxes are no longer muted. Prepare your ears for the auditory assault.",
	...
	cache = {
		...
		join_cache_disabled = "undefined",
		join_cache_enable = "undefined"
	},
	...
	containers = {
		drill_container = "Press ~INPUT_CONTEXT~ to drill open the bloody container, ya bloody madlad.",

		drilling_container = "F*cking Container",
		failed_drill = "F*ck, your a*s couldn't drill open the damn container.",
		drill_success = "Heck yeah, you drilled that sh*t open!",
	...
	debug = {
		...
		delete_entity_no_permissions = "Tried to delete some fucking entity without fucking proper permissions.",
		...
		move_entity_no_permissions = "Tried to move some fucking entity without fucking proper permissions.",
		...
		network_owner_subscription_no_permissions = "Fuck, you tried to subscribe to those fucking entity network owners without the goddamn proper permissions.",
	...
	inventory = {
		...
		penthouse_fridge = "Penthouse Fucking Fridge",
		...
		chorus_fruit_description = "A fucking fruit that can fucking teleport you to a fucking random fucking location.",
	...
	locate = {
		...
		locate_entity_no_permissions = "Fucking tried to locate a fucking entity without fucking proper permissions.",
	...
	login = {
		...
		welcome_msg = "You got some shit to start with. Use it with the number keys, bro. \n\nPress **${InventoryKey}** to check your fucking inventory or press **1** to read the shit you were given.",
		...
		slots_set_to = "The shitty server slots have been set to `${slots}`.",
		slots_already_set_to = "The goddamn server slots are already set to `${slots}`.",
	...
	meow = {
		...
		feed_active = "Fucking Feeding Maxwell",
		pet_active = "Fucking Petting Maxwell",
		brush_active = "Brushing Maxwell, you fucking wanker",
		catnip_active = "Giving Maxwell some fucking catnip",
		treat_active = "Giving Maxwell a fucking treat",
		check_up_active = "Fucking checking up on Maxwell",

		maxwell_appeared = "Oh shit, that fuck Maxwell just showed up near your stupid ass.",
		maxwell_shot = "Fucking shot Maxwell"
	},
	...
	printer = {
		...
		image_url = "https://files.catbox.moe/you-are-retarded.jpg",
	...
	radio = {
		...
		radio_debug_no_permissions = "Tried to fucking toggle the fucking radio debug without fucking proper permissions.",
	...
	riot_mode = {
		...
		add_riot_player_no_permissions = "Tried to add a fucking player to the riot list without any goddamn permissions. Nice try, asshole.",
		remove_riot_player_no_permissions = "Tried to remove a fucking player from the riot list without any goddamn permissions. Nice try, asshole.",
	...
	teleporting = {
                source_no_character = "Source player has no character loaded. What the hell are they doing?",
                target_no_character = "Target player has no character loaded. Did they forget who they are?",
                invalid_coordinates = "Invalid coordinates. Are you trying to teleport to Narnia or something?",
                no_waypoint_set = "No waypoint set. Get your shit together and set a waypoint.",
                failed_teleport_to_player = "Failed to teleport to player. Get your teleportation shit together.",
                failed_teleport_player_here = "Failed to teleport player to you. Can't even do basic teleportation, can you?",
                failed_teleport_player_player = "Failed to teleport player to player. Figure your crap out before you try to teleport someone.",
                no_back_coords = "Nowhere to teleport back to. Did you even set a return point, dumbass?",
                cant_tp_same_player = "You can't teleport a player to themselves. What, are they gonna teleport into their own damn body or something?"
	...
	teleporters = {
                area_not_clear = "The destination is blocked by a goddamn vehicle. Move your sorry ass outta the way!"
		...
		exit_submarine_interact = "[${InteractionKey}] Get Your Fucking Ass Out of the Submarine",
                ...
                enter_garage = "Get Your Ass Inside the Damn Garage",
                enter_garage_interact = "[${InteractionKey}] Enter This Goddamn Garage",

                exit_garage = "Get the Hell Out of the Garage",
                exit_garage_interact = "[${InteractionKey}] Exit This Stupid Garage",

                enter_viewer_booth = "Enter the Viewer Booth Like a Boss",
                enter_viewer_booth_interact = "[${InteractionKey}] Enter This Fancy Viewer Booth",

                exit_viewer_booth = "Leave the Viewer Booth, No One Cares",
                exit_viewer_booth_interact = "[${InteractionKey}] Exit This Lame Viewer Booth"
	},
	...
	treasure_maps = {
		...
		map_tier_4_description = "This fucking map looks more fucking expensive than most fucking treasures. Let's fucking go!!!!",
                ...
                press_to_combine_pieces = "Press ~INPUT_CONTEXT~ to combine map pieces into full maps. Because apparently you need instructions for everything, you clueless idiot.",

                treasure_map = "Treasure Map (Tier ${mapTier}), because you're too lazy to find treasure on your own",

                treasure_maps_debug_enabled = "Treasure maps debug enabled. Like anyone cares about your debugging nonsense.",
                treasure_maps_debug_disabled = "Treasure maps debug disabled. Whoop-de-fucking-doo.",

                treasure_map_debug = "Map (Tier: ${mapTier}, Distance: ${distance}), because you're too dumb to figure it out yourself",
                dig_zone = "Dig Zone, because apparently you need to be told where to dig",

                combining_maps = "Combining Maps, because you're too incompetent to do it without guidance",

                combined_map = "Combined map of tier ${mapTier}. Congratulations, you managed to do something right for once.",
                no_maps_to_combine = "You have no maps to combine. Surprise, surprise, you useless piece of shit.",

                treasure_map_dug_up_logs_title = "Treasure Map Dug Up, because apparently you need validation for your meaningless achievements",
                treasure_map_dug_up_logs_details = "${consoleName} has dug up a treasure map of tier ${mapTier} and received drop ID ${dropId}. Whoop-de-fucking-doo."
	},
	...
	tunerchip = {
   		 pimp_ride = "Pimp My Ride™, because your car looks like shit",
	...
	twitter_bid = {
    		...
    		information_part_1 = "Want to let everyone know who's boss on Twitter? Be the biggest bidder on the verification mark! But who cares?",
    		information_part_2 = "Whoever pays the most amount of money gets to have the blue verification mark, until another person bids a higher sum. Like anyone cares about your verification",
    		information_part_3 = "If someone outbids you, you do not get your money back. Tough luck, loser.",
    		information_part_4 = "Make sure to put a slick quote for people to glance at in order to make everyone have a spite for you. Like anyone actually cares what you say",
    		...
    		bid_amount = "Bid Amount, because you're willing to waste money on worthless shit",
	...
	bus_driver = {
		start_route = "Press ~INPUT_CONTEXT~ to start a fookin' route",
		...
		east_route = "Bloody Arcade",
		pillbox_route = "Pillbox, mate",
		little_seoul_route = "Little Seoul... wanker",
	...
	duty = {
		toggle_duty_status_no_permissions = "You fucking asshole tried to toggle on duty status via fucking command without proper fucking permissions.",
	...
	alpha = {
		...
		thanks_for_loot = "You were fucking mugged while unconscious, you piece of shit. Some fucking items may be fucking missing. Roumor says it was fucking Nancy.",
