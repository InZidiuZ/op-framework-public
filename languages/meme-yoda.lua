...
OP.Global.Locales.Languages["meme-yoda"] = {
	...
	printer = {
		...
		printed_logs_details = "${consoleName}, `${itemName}` printed, `${paperType}` using, image URL `${url}`, top-text: `${topText}` and bottom-text: `${bottomText}`."
	},
	...
	vape = {
		...
		plain_vape = "Geek Bar, it is (No Flavor)",
