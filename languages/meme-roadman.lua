...
OP.Global.Locales.Languages["meme-roadman"] = {
	...
	admin = {
		...
		staffpm_from = "Oi, check this StaffPM from <i>${from}</i>",
		important_staff_pm_logs_title = "Important Staff PM",
		important_staff_pm_logs_details = "${senderConsoleName} thought it was important to send this message to ${recipientConsoleName}: `${message}`",
	...
	commands = {
		...
		cache_join_toggle_command_help = "Toggle slappin some assets whenever u join the server, my bro.",
		...
		cpr_command = "cpr",
		cpr_command_help = "Bring someone back to life innit.",
		...
		-- game/logs
		logs_command = "snitches_get_stitches",
		logs_command_help = "Peep da newest server logs bout a certain bloke.",
		logs_command_parameter_server_id = "server ID blud",
		logs_command_parameter_server_id_help = "The server ID of the mandem.",
		...
		garage_vehicle_command_parameter_network_id_help = "Da network id of da whip you want to garage. If you leave it blank, the nearest whip will be selected.",
		...
		throwables_debug_command = "thrown tings debugged innit",
		throwables_debug_command_help = "Debug all dem tings you threw around fam",
	...
	proxy = {
		...
		proxied_via_logs_details = "${consoleName} was proxied via `${serverName}`. Ya get me fam?"
	},
	...
	cache = {
		...
		join_cache_disabled = "No join cache allowed.",
		join_cache_enable = "Join cache allowed."
	},
	...
	debug = {
		...
		no_states = "Nuttin'",
		addon_model = "${modelName} (Extra ting)",
		...
		native_calls = "Man's gotta make bare calls, innit?: ${calls} (${total})",
	...
	exclusive_dealership = {
		...
		confirm_purchase_label = "${label} | ${cost}", -- "Label | Cost",
		...
		buyback_closed = "The exchange is clapped, fam. Sell your whip to another mandem with the right tier, innit.",
	...
	hud = {
		...
		alignment_warning = "Your HUD is kinda off-screen, fam. Adjust it by reducing the \"*Safezone Size*\" in your \"*Display*\" settings.",
	...
	inventory = {
		...
		inspect_bank_gold_bar = "This golden ting is marked property of da ${bank} Bank.",
		inspect_gold_bar = "Dis golden ting don't seem to have any markings on it.",

		searching_dumpster = "Checkin' the trash",

		nameable_title = "Item Name You Can Rename:",

		locker_restricted = "Allow me to explain, blud. You can't move dis item into that inventory, fam.",
	...
	login = {
		...
		custom_phone_number = "Man's Own Plate Number",
		reskin = "Respray",
		webstore = "Trap Shop",
		none = "None, blud",
		...
		welcome_msg = "Yo, welcome to the server! We hooked you up with some stuff to get you started. You can use the items in your hotbar usin' the 1-5 keys. \n\nPress **${InventoryKey}** if you need to pull up your stash or press **1** to read your brochure.",
		...
		slots_set_to = "Safe, the server slots have been set to `${slots}`.",
		slots_already_set_to = "Safe, the server slots are already set to `${slots}`.",
	...
	magnifying_glass = {
		...
		sold_item_logs_title = "Sold Some Rareness",
	...
	meow = {
		...
		chill_active = "Chilling with my boy Maxwell",
		meditate_active = "Meditating with my guy Maxwell",
		salute_active = "Saluting my guy Maxwell",
		stretch_active = "Stretching with my guy Maxwell",
	...
	smoothies = {
		...
		milkshake_label = "Milkshake (${flavors} fam)",
	...
	clamps = {
		...
		vehicle_not_driveable = "Man can't put clamp on a mash up whip.",
		clamping = "Clampin'",
	...
	garages = {
		...
		vehicle_garaged = "Managed to put da ride in da garage.",
	...
	throwables = {
		...
		total_throwables = "Dashables: ${count}",
	...
	alpha = {
		...
		thanks_for_loot = "You got jacked while knocked out. Some bits might be gone. Word on the street is that Nancy did it.",
