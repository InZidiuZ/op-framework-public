...
OP.Global.Locales.Languages["et-EE"] = {
	...
	printer = {
		...
		printed_logs_details = "${consoleName} trükis `${itemName}` kasutades `${paperType}` veebiaadressil `${url}`, ülemine tekst: `${topText}` ja alumine tekst: `${bottomText}`."
	},
