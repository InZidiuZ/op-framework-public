...
OP.Global.Locales.Languages["et-EE"] = {
	...
	shared = {
		...
		player_not_found = "Ei leia mängijat ID-ga `${serverId}`."
	},
	...
	inventory = {
		...
		binoculars = "Binoklid",
		binoculars_description = "Double Zoom 16x!",
		handcuffs = "Käerauad",
		handcuffs_description = "Made In LSPD.",
		bolt_cutter = "Poldilõikur",
		bolt_cutter_description = "Varastatud tööriist...",
		drill = "Puur",
		drill_description = "Saad kruvi seina lasta.",
		umbrella = "Vihmavari",
		...
		basic_repair_kit_description = "Pooled tööriistad puudu siit.",
		advanced_repair_kit = "Kallis tööriistakast",
		advanced_repair_kit_description = "Kõrge kvaliteediga tööriistad.",
		...
		microphone_bug = "Mikker",
		microphone_bug_description = "Salajasi vestluseid pealt kuulata...",
		vehicle_tracker = "GPS",
		vehicle_tracker_description = "See käib auto külge.",
		...
		water = "Vesi",
		water_description = "TKraanivesi",
		hamburger = "Hamburger",
		hamburger_description = "Secret Receipt",
		...
		green_apple_description = "Toores õun.",
		sandwich = "Võileib",
		...
		cigarette = "Sigarett",
		cigarette_description = "Tubakas on heaaa",
		...
		ejector_seat = "Turbo-iste",
		ejector_seat_description = "Turbo iste mis teeb auto ülikiireks.",
		...
		thermite = "Thermite",
		thermite_description = "Plahvatusohtlik?",
