...
OP.Global.Locales.Languages["zh-CN"] = {
	...
	emotes = {
		...
		lockpicking_cuffs = "开锁手铐",
		lockpick_cuffs_too_fast = "您动作过快。",
		success_lockpick_cuffs = "成功开锁手铐。",
		failed_lockpick_cuffs = "手铐扳手使用失败。",
		lockpick_lost = "你丢失了手铐扳手。",

		not_cuffed = "你没有被铐上。",
		unable_to_lockpick = "你无法使用手铐扳手。",

		lockpick_cuffs_logs_title = "锁扣手铐",
		lockpick_cuffs_logs_details = "${consoleName} 使用 `${itemName}` 成功锁扣了自己的手铐。",

		you_are_not_being_carried = "你当前没有被搬运。",
		successfully_uncarried = "成功强制停止搬运。",
		failed_uncarried = "强制停止搬运失败。",
		uncarry_missing_permissions = "尝试强制停止携带但没有权限。",
	...
	admin = {
		...
		add_vehicle_added_vehicle_for_player = "为玩家 ${consoleName} 添加了车辆，车辆模型名称为 `${modelName}`。",
		add_vehicle_added_vehicle = "添加了车辆，车辆模型名称为 `${modelName}`。",
		...
		staff_pm_first_time = "我们注意到您从未使用过工作人员私信功能。要回复工作人员私信，请使用 /staffpm 命令。",
		...
		indestructibility_on = "已开启“无毁坏性”。",
		indestructibility_off = "已关闭“无毁坏性”。",
		...
		evidence_view_on = "已打开证据查看功能。",
		evidence_view_off = "关闭证据视图。",
		evidence_view_title = "切换证据视图",
		evidence_view_details_on = "${consoleName} 打开了高级证据视图。",
		evidence_view_details_off = "${consoleName} 关闭了高级证据视图。",
		...
		tp_coords_invalid_coordinates = "无效的坐标。",
		tp_coords_teleported_to_coordinates = "传送至坐标 X: ${x}，Y: ${y}，Z: ${z}。",

		teleported_to_waypoint = "传送至标记点 ${locationLabel}。",
		no_waypoint_set = "您需要先设置路径点。",

		teleported_to_coordinates_logs_title = "传送到坐标",
		teleported_to_coordinates_logs_details = "${consoleName} 传送到坐标 X: ${x}，Y: ${y}，Z: ${z}。",
		teleported_to_waypoint_logs_title = "传送到路径点",
		teleported_to_waypoint_logs_details = "${consoleName} 传送到路径点 ${locationLabel}。",
		...
		enabled_features_list = "已启用的功能:",
		aimbot_feature = "自瞄",
		disabled_collisions_feature = "禁用碰撞",
		disabled_recoil_feature = "禁用后坐力",
		evidence_view_feature = "证据查看",
		hit_indicator_feature = "命中指示器",
		indestructibility_feature = "无敌",
		infinite_ammo_feature = "无限子弹",
		invisibility_feature = "隐身",
		muted_sirens_feature = "消音警笛",
		nitro_boost_feature = "氮气加速",
		no_nearby_vehicles_feature = "无附近车辆",
		peeking_feature = "窥视",
		roll_control_feature = "翻滚控制",
		speed_boost_feature = "速度增强",
		speed_up_progress_bar_feature = "加速进度条",
		sticky_feet_feature = "吸附脚",
		wallhack_feature = "透视",
		watching_feature = "观察",
		fortnite_feature = "堡垒之夜",
		reflection_feature = "伤害反射",
		stable_cam_feature = "稳定摄像",
		super_jump_feature = "超级跳跃",
		server_id_hidden_feature = "隐藏服务器ID",
		fake_disconnect_feature = "伪断开连接",
		brighter_nights_feature = "亮夜",
		...
		refill_nitro_missing_permissions = "玩家尝试未经授权填充氮气。",
		...
		register_weapon_missing_permissions = "玩家尝试注册武器但没有足够的权限。",
		...
		tint_invalid = "武器着色无效。",
		tint_range_invalid = "武器着色范围无效（必须在 0 到 ${max} 之间）。",
		...
		clean_ped_no_permission = "Added Bank",
		...
		item_durability_set_no_permission = "没有权限设置物品耐久度。",

		item_metadata_set_no_permission = "没有权限设置物品元数据。",
		item_metadata_invalid_metadata = "无效的物品元数据。",
		...
		identity_set = "成功设置您的身份为`${name}`。",
		identity_reset = "成功重置您的身份。",
		identity_set_failed = "无法设置您的身份。",
		identity_hud = "身份：${playerName}",

		set_identity_no_permission = "玩家未经适当权限尝试设置其玩家名称。",
		...
		toggle_collisions_missing_permissions = "玩家未获得足够权限尝试切换碰撞模式。",
		wipe_first_owned_missing_permissions = "玩家未获得足够权限尝试清除自己的首次拥有实体。",

		freeze_missing_permissions = "玩家未获得足够权限尝试冻结或解冻其他玩家。",
		...
		slap_missing_permissions = "玩家未经适当的权限试图打击另一个玩家。",
		...
		damage_player_missing_permissions = "玩家未经允许试图对另一玩家造成伤害。",
		...
		identity_on_logs_details = "${consoleName}将身份设置为`${playerName}`。",
		identity_off_logs_details = "${consoleName} 重置了他们的身份。",

		clean_ped_logs_title = "清理角色模型",
		clean_ped_logs_details = "${consoleName} 清理了 ${targetName} 的角色模型。",

		invalid_job_search = "无效的职位搜索（必须至少为3个字符）。",
		failed_job_search = "无法搜索职位。",
		job_search_no_results = "没有找到职位。",
		job_search_results = "将 ${consoleName} 的职位设置为 \"${jobName}, ${departmentName}, ${positionName}\"（分数：${score}）。",

		job_reset_success = "成功为 ${consoleName} 重置职位。",
		failed_job_reset = "重置工作失败。",
		...
		set_job_logs_title = "设置职业",
		set_job_logs_details = "${consoleName} 将 ${targetConsoleName} (#${characterId}) 的职业设置为 `${jobName}, ${departmentName}, ${positionName}` (评分: ${score}, 搜索: `${search}`)。",

		reset_job_logs_title = "重置职业",
		reset_job_logs_details = "${consoleName} 重置了 ${targetConsoleName} (#${characterId}) 的职业。"
	},
	...
	anti_cheat = {
		...
		bad_screen_word_ban = "我们听说过开卷考试，但这也太离谱了。",
	...
	commands = {
		...
		report_command_parameter_message_help = "您想发送的信息。",
		...
		wipe_command_parameter_model_name_help = "如果只想删除特定模型名称的实体，请在此处输入模型名称。否则留空、设置为 `false` 或 `0`。您也可以将其设置为 `vehicles`、`peds`、`objects` 或 `doors`。",
		...
		spawn_vehicle_command_parameter_model_name_help = "您想要生成的车辆的模型名称。",
		...
		add_vehicle_command_parameter_model_help = "您要添加的车辆的模型名称或模型哈希。",
		...
		indestructibility_command_help = "切换 '无敌模式'。",
		indestructibility_command_parameter_server_id = "服务器 ID",
		indestructibility_command_parameter_server_id_help = "如果你想为其他玩家切换 '无敌模式'，在此处插入他们的服务器 ID。",
		...
		job_command = "职业",
		job_command_help = "基于搜索来更新某人的职业。",
		job_command_parameter_server_id = "服务器ID",
		job_command_parameter_server_id_help = "玩家的服务器ID，或者将其设置为0以选择自己。",
		job_command_parameter_search = "搜索",
		job_command_parameter_search_help = "要搜索的职位/部门/职位名称或其中的一部分，或者将其设置为“none”以删除职业。",
		...
		reflect_damage_command_help = "开启或关闭反弹伤害功能（任何攻击你的玩家将会受到伤害）",
		...
		show_all_evidence_command_help = "显示所有附近的弹壳证据。",
		...
		set_identity_command_help = "覆盖你的角色名字。",
		...
		set_metadata_command_parameter_slot_help = "要在其中设置物品耐久度的槽位。",
		set_metadata_command_parameter_metadata = "元数据",
		set_metadata_command_parameter_metadata_help = "要设置的元数据 JSON。",
		...
		tp_player_command_help = "将你传送到玩家身边。",
		tp_player_command_parameter_server_id = "服务器ID",
		tp_player_command_parameter_server_id_help = "你要传送到的玩家的服务器ID。",
		tp_player_command_substitutes = "",

		tp_here_command = "tp_here",
		tp_here_command_help = "将一个玩家传送到你的位置。",
		tp_here_command_parameter_server_id = "服务器ID",
		tp_here_command_parameter_server_id_help = "你希望传送的玩家的服务器ID。",
		tp_here_command_substitutes = "",

		tp_to_command = "tp_to",
		tp_to_command_help = "将一个玩家传送到另一个玩家身边。",
		tp_to_command_parameter_source_id = "源玩家 ID",
		tp_to_command_parameter_source_id_help = "要传送的玩家。",
		tp_to_command_parameter_destination_id = "目标玩家 ID",
		tp_to_command_parameter_destination_id_help = "要传送到的玩家。",
		...
		-- game/debug
		debug_command = "debug",
		debug_command_help = "切换实体调试器。这将显示附近实体的一些通用信息。",
		...
		rectangle_command = "矩形",
		rectangle_command_help = "在三维空间中创建一个矩形。",
		rectangle_command_substitutes = "rect",

		define_area_command = "define_area",
		define_area_command_help = "定义一个区域。",
		...
		cpr_command = "cpr",
		cpr_command_help = "对最近的行人或玩家进行心肺复苏。",
		...
		-- game/logs
		logs_command = "日志",
		logs_command_help = "查看特定玩家的最新服务器日志。",
		logs_command_parameter_server_id = "服务器ID",
		logs_command_parameter_server_id_help = "玩家的服务器ID。",
		...
		ped_spawn_command_parameter_fearless = "无畏",
		ped_spawn_command_parameter_fearless_help = "生物是否应该害怕枪支/等等（默认：否）。",
		...
		takeover_ped_command_help = "让你控制特定的人物.",
		takeover_ped_command_parameter_network_id = "网络ID",
		takeover_ped_command_parameter_network_id_help = "你想接管的人物的网络ID。",
		takeover_ped_command_substitutes = "接管",
		...
		radio_volume_command_parameter_volume_help = "收音机的音量级别。值必须在0和1之间。默认值为0.5。留空将返回当前音量级别。",
		...
		weather_command_parameter_weather_help = "您想要设置的天气名称。有效的天气名称包括：晴朗（EXTRASUNNY）、晴朗（CLEAR）、多云（CLOUDS）、烟雾（SMOG）、雾天（FOGGY）、阴天（OVERCAST）、雨天（RAIN）、雷雨（THUNDER）、变晴（CLEARING）、中性（NEUTRAL）、雪天（SNOW）、暴风雪（BLIZZARD）、轻雪（SNOWLIGHT）、圣诞（XMAS）和万圣节（HALLOWEEN）.",
		...
		toggle_developer_ambience_command = "切换开发者环境音",
		...
		ignite_player_command = "点燃玩家",
		ignite_player_command_help = "使目标玩家短暂着火。",
		ignite_player_command_parameter_server_id = "服务器ID",
		ignite_player_command_parameter_server_id_help = "目标玩家的服务器ID。",
		ignite_player_command_substitutes = "点燃, 燃烧",
		...
		no_ped_population_areas_debug_command = "无人口区域调试",
		no_ped_population_areas_debug_command_help = "切换“无人口区域”调试器。",
		...
		entity_states_command_parameter_network_id_help = "实体的网络ID。",
		...
		toggle_duty_status_command_parameter_server_id_help = "目标服务器ID，如果要切换自身的上、下班状态，此参数为空。",
		...
		garage_vehicle_command_parameter_network_id = "网络 ID",
		garage_vehicle_command_parameter_network_id_help = "您想要存放的车辆的网络 ID。如果留空，则选择最近的车辆。",
		...
		give_key_command_parameter_server_id_help = "您要给予钥匙的玩家的服务器 ID。可以留空（或输入 0）以将其给予最近的人。",
		...
		custom_plate_command_parameter_plate_number_help = "您想设置的车牌号。车牌号最长为8个字符，只能由大写字母和数字组成。",
		...
		speed_limiter_command = "限速器",
		speed_limiter_command_parameter_speed = "速度",
		speed_limiter_command_parameter_speed_help = "您想要限速器使用的速度是多少？您可以留空以重置它，重置将使其恢复正常。",
		speed_limiter_command_help = "覆盖限速器的正常行为，预设速度限制。",
		...
		throwables_debug_command = "可投掷物品调试",
		throwables_debug_command_help = "调试附近的可投掷物品。",
	...
	admin_menu = {
		...
		teleport_player = "传送到玩家",
		teleport_player_here = "传送玩家到你这里",
		failed_teleport_to_player = "传送到玩家失败",
		failed_teleport_player_here = "传送玩家到你这里失败",
		invalid_target_server_id = "无效的目标服务器ID",
		invalid_destination_server_id = "无效的目标服务器ID",
		invalid_source_server_id = "无效的源服务器ID",
		failed_teleport_player_to_player = "传送玩家到玩家失败",
		teleported_player_to_player = "将玩家传送到其他玩家身边。"
	},
	...
	attachments = {
		...
		modifying_attachments = "修改 ${amount} 个附件",
		...
		tint_changed = "将涂装从 `${fromTint}` 更改为 `${toTint}`"
	},
	...
	battle_royale = {
		...
		toggle_battle_royale_missing_permissions = "玩家尝试切换战斗皇家，但他们没有足够的权限去这么做。",
		start_battle_royale_missing_permissions = "玩家尝试开始战斗皇家，但他们没有足够的权限去这么做。",
		...
		player_died = "${name} 已阵亡：剩余人数 ${remainingPlayers}。",
		player_killed = "${name} 被 ${killerName} 击败，原因为 ${deathCause}，距离 ${distance} 米：剩余人数 ${remainingPlayers}。",
		player_won = "${name} 获胜！",
		your_team = "你的队伍：",
		...
		join_battle_royale_instance_missing_permissions = "玩家尝试加入绝地求生实例，但没有所需的权限。",
		no_match_found = "${consoleName}不在任何比赛中。",
		joined_instance = "加入了${consoleName}的实例。",
		leave_battle_royale_instance_missing_permissions = "玩家尝试离开一个战斗皇家实例，但没有所需的权限。",
		left_instance = "离开实例。",
	...
	bombs = {
		...
		toggle_ignition_bomb_missing_permissions = "玩家尝试切换点火炸弹，但没有所需的权限。"
	},
	...
	boosting = {
		...
		scratch = "VIN刮擦",
		press_to_scratch = "按下 ~g~E ~w~进行VIN刮擦。",
	...
	brochure = {
		...
		safety_hint = "提示：你可以按下ALT键和鼠标中键将武器解锁。请注意安全！",
	...
	crafting = {
		...
		cut_item = "切割土豆",
		press_to_cut_item = "[${SeatEjectKey}] 切割土豆",
		cutting_item = "正在切割3个土豆",
		cut_item_done = "将土豆切成薯条。",
		failed_cut_item = "切土豆失败。",

		fry_item = "炸薯条",
		press_to_fry_item = "[${SeatEjectKey}] 炸薯条",
		frying_item = "正在炸薯条",
		fried_item = "炸好的比利时薯条。",
		failed_fry_item = "炸薯条失败。",

		grill_item = "烤生汉堡肉饼",
		press_to_grill_item = "[${SeatEjectKey}] 烤生汉堡肉饼",
		grilling_item = "正在烤汉堡肉饼",
		grilled_item = "烤好的汉堡肉饼。",
		failed_grill_item = "烤汉堡肉饼失败。",
		...
		assembling_burger = "正在组装汉堡",
		assembled_burger = "已组装汉堡",
		failed_assemble_burger = "无法组装汉堡。",

		assembling_cheeseburger = "正在组装芝士汉堡",
		assembled_cheeseburger = "已组装芝士汉堡",
		failed_assemble_cheeseburger = "无法组装芝士汉堡。",
		...
		craft_sheet_metal = "制作金属板",
		press_to_craft_sheet_metal = "[${SeatEjectKey}] 制作金属板",
		crafting_sheet_metal = "制作金属板",
		crafted_sheet_metal = "制作金属板成功。",
		failed_craft_sheet_metal = "制作金属板失败。",
		...
		process_rubber = "加工橡胶",
		press_process_rubber = "[${SeatEjectKey}] 加工橡胶",
		failed_process_rubber = "无法加工橡胶。",

		process_aluminium = "加工铝",
		press_process_aluminium = "[${SeatEjectKey}] 加工铝",
		failed_process_aluminium = "无法加工铝。",

		process_steel = "加工钢",
		press_process_steel = "[${SeatEjectKey}] 加工钢",
		failed_process_steel = "无法加工钢。",

		craft_lens = "制作镜片",
		press_craft_lens = "[${SeatEjectKey}] 制作镜片",
		crafting_lens = "制作透镜",
		...
		pulverize_aluminium = "粉碎铝",
		press_pulverize_aluminium = "[${SeatEjectKey}] 粉碎铝",
		pulverizing_aluminium = "正在粉碎铝",
		pulverized_aluminium = "粉碎了铝。",
		failed_pulverize_aluminium = "粉碎铝失败。",

		pulverize_steel = "粉碎钢",
		press_pulverize_steel = "[${SeatEjectKey}] 粉碎钢材",
		...
		craft_device_scanner = "制作设备扫描器",
		press_craft_device_scanner = "[${SeatEjectKey}] 制作设备扫描器",
		...
		bake_brownies = "烘焙布朗尼",
		press_bake_brownies = "[${SeatEjectKey}] 烘焙布朗尼",
		...
		craft_radio_decrypter = "制作无线电解密器",
		press_craft_radio_decrypter = "[${SeatEjectKey}] 制作无线电解密器",
	...
	daily_activities = {
		...
		put_bets_in_jackpot = "在彩池中下注总值 $${amount}。",
		win_bets_in_jackpot = "在彩池中赢取总价值 $${amount} 的物品。",
		...
		not_enough_op_points = "你需要 ${cost} OP Points 来恢复你的连续登录天数，你当前有 ${points} OP Points。",
	...
	debug = {
		...
		owned_by_us = "本地所有",
		owned_by = "所有者",
		one_state_set = "已设置1个状态",
		many_states_set = "已设置${count}个状态",
		no_states = "无状态",
		addon_model = "${modelName} (Addon)",
		entity_health = "健康值 ${health}/${maxHealth}",
		...
		move_entity_no_permissions = "未获得足够的权限尝试移动实体。",
		...
		network_owner_subscription_no_permissions = "尝试订阅实体网络所有者时没有足够的权限。",
	...
	dna_evidence = {
		...
		evidence_text = "证据类型：DNA证据\n从${fullName} #${characterId}收集到的DNA\n\n附加信息：\n • 获取时间戳：${time}"
	},
	...
	exclusive_dealership = {
		...
		deny_purchase = "没事，我不想要了",
		accept_purchase = "是的，我想购买",
		accept_purchase_info = "您确定要购买这辆车吗？此操作不可撤销。",
		...
		buyback_closed = "交易关闭。您可以向具有正确级别的其他玩家出售您的车辆。",
	...
	import_export = {
		...
		confirm_dialog = "你确定要运送${total}磅的货物，需支付$${price}吗？这个运输不能取消。",
		confirm = "是",
		...
		created_shipment_details = "${consoleName} 已为 ${company} 创建了一个 ${weight} 磅的货物运输订单，总价值 $${price}。",

		claimed_shipment_title = "货物已被认领",
		claimed_shipment_details = "${consoleName} 已认领了 ${company} 的 ${weight} 磅货物运输订单。",
	...
	inventory = {
		...
		police_store = "警察商店",
		fib_store = "FIB 商店",
		police_badge_store = "警察徽章柜台",
		doc_badge_store = "医生徽章柜台",
		flower_store = "斯泰西的花店",
		gift_store = "德尔佩罗礼品店",
		ems_store = "急救服务商店",
		drug_store = "药品柜台",
		...
		inspect_bank_gold_bar = "这个金条是${bank}银行的财产。",
		inspect_gold_bar = "这个金条似乎没有任何标记。",

		searching_dumpster = "搜索垃圾箱",

		nameable_title = "可命名物品名称：",

		locker_restricted = "您无法将此物品移动到该库存中。",
		...
		logs_combined_title = "合并物品",
		logs_combined_details = "${consoleName} 合并了 ${inputs} 来制作了 1x ${output}。",
		...
		paper = "照片纸",
		paper_description = "用于打印照片的一张空白纸张。",
		card_paper = "名片纸",
		card_paper_description = "用于打印名片的一张空白纸张。",
		printer = "打印机",
		...
		raw_diamond = "未加工的钻石",
		raw_diamond_description = "从矿井中取出的天然钻石。",
		raw_morganite = "未加工的摩根石",
		raw_morganite_description = "从矿井中取出的天然摩根石。",
		raw_ruby = "未加工的红宝石",
		raw_ruby_description = "从矿井中取出的天然红宝石。",
		raw_sapphire = "未加工的蓝宝石",
		raw_sapphire_description = "从矿井中取出的天然蓝宝石。",
		raw_emerald = "原翡翠",
		raw_emerald_description = "新鲜从矿山出来的翡翠原石。",

		ruby_dust = "红宝石粉",
		ruby_dust_description = "从红宝石中得到的粉末。",
		sapphire_dust = "蓝宝石粉",
		sapphire_dust_description = "从蓝宝石中得到的粉末。",

		morganite = "粉晶",
		morganite_description = "切割和抛光后的粉晶。",
		ruby = "红宝石",
		ruby_description = "切割和抛光后的红宝石。",
		sapphire = "蓝宝石",
		sapphire_description = "切割和抛光后的蓝宝石。",
		emerald = "翡翠",
		emerald_description = "切割和抛光后的翡翠。",

		ring = "戒指",
		ring_description = "只是一个空白的戒指。",

		morganite_ring = "玛瑙戒指",
		morganite_ring_description = "一枚漂亮的戒指，中间有一个大的玛瑙。非常适合结婚、最好的朋友或完全陌生的人。",
		ruby_ring = "红宝石戒指",
		ruby_ring_description = "一枚漂亮的戒指，中间有一个大的红宝石。非常适合结婚、最好的朋友或完全陌生的人。",
		sapphire_ring = "蓝宝石戒指",
		sapphire_ring_description = "一枚漂亮的戒指，中间有一个大的蓝宝石。非常适合结婚、最好的朋友或完全陌生的人。",
		emerald_ring = "翡翠戒指",
		emerald_ring_description = "一枚美丽的戒指，中间有一颗大翡翠。非常适合婚礼、最好的朋友或完全陌生人。",
		diamond_ring = "钻石戒指",
		diamond_ring_description = "一枚美丽的戒指，中间有一颗大钻石。非常适合婚礼、最好的朋友或完全陌生人。",

		gemstone_scanner = "宝石扫描器",
		gemstone_scanner_description = "用于扫描宝石的工具。",
		...
		grenade_shell = "手榴弹外壳",
		grenade_shell_description = "用于手榴弹的外壳。",
		grenade_pin = "手榴弹销子",
		grenade_pin_description = "用于手榴弹的销子。",

		paint = "油漆",
		paint_description = "对篱笆和房屋有用，只是不要开始吸它。",
		paint_brush = "油漆刷",
		paint_brush_description = "用于上油漆。",

		skin_patriotic = "爱国皮肤",
		skin_patriotic_description = "为所有热血美国人准备的。",
		skin_brushstroke = "刷痕皮肤",
		skin_brushstroke_description = "所有艺术爱好者的选择。",
		skin_skull = "骷髅皮肤",
		skin_skull_description = "所有个性青年的选择。",
		skin_leopard = "豹纹皮肤",
		skin_leopard_description = "所有动物爱好者的选择。",
		skin_zebra = "斑马纹皮肤",
		skin_zebra_description = "所有动物爱好者的选择。",
		skin_geometric = "几何纹皮肤",
		skin_geometric_description = "所有数学迷的选择。",

		refillable_bottle = "可加注的瓶子",
		refillable_bottle_description = "拯救海龟，真的真的。",

		capri_sun = "卡比蓝",
		capri_sun_description = "童年的美味食品。",

		gumball = "口香糖",
		gumball_description = "一个口香糖，还能说什么呢？",

		chorus_fruit = "合唱果",
		chorus_fruit_description = "一种可以将你传送至随机位置的水果。",
		...
		cigarette = "香烟",
		cigarette_description = "如果你不抽烟就是懦夫。",
		cigarette_pack = "香烟包装",
		cigarette_pack_description = "为你有香烟瘾的爸爸准备的（希望他回来拿香烟）。",
		...
		antibiotics = "抗生素",
		antibiotics_description = "帮助您清除感染和寄生虫。",
		pain_killers = "止痛药",
		pain_killers_description = "这是销售的巅峰时间，我需要我的药物。",
		weed_seeds = "大麻种子",
		...
		aluminium = "粗铝",
		aluminium_description = "用于修理和制作。",
		glass = "粗玻璃",
		glass_description = "用于修理和制作。",
		rubber = "未硫化橡胶",
		rubber_description = "用于修理和制作。",
		scrap_metal = "废金属",
		scrap_metal_description = "用于修理和制作。",
		steel = "生钢",
		steel_description = "用于修理和制作。",

		purified_aluminium = "纯净铝",
		purified_aluminium_description = "用于专业修理。",
		tempered_glass = "钢化玻璃",
		tempered_glass_description = "用于专业修理。",
		vulcanized_rubber = "硫化橡胶",
		vulcanized_rubber_description = "用于专业修理。",
		processed_metal = "加工金属",
		processed_metal_description = "用于专业修理。",
		refined_steel = "精炼钢",
		refined_steel_description = "用于专业修理。",

		power_saw = "电锯",
		power_saw_description = "用于锯东西。",
		...
		acid = "酸液",
		acid_description = "让你永久性地HIGH起来。没有逃脱的办法。",

		rose = "玫瑰",
		rose_description = "我猜是ERP吧，兄弟",

		teddy_bear = "泰迪熊",
		teddy_bear_description = "一个会真正倾听你的朋友。",
		...
		campfire = "篝火",
		campfire_description = "可放置在世界的任何地方。非常适合露营、狩猎和钓鱼！此物品无法再次拾取。",
		tent = "帐篷",
		tent_description = "可放置在世界的任何地方。非常适合露营、狩猎和钓鱼！",
		cloth_tent = "布帐篷",
		cloth_tent_description = "可放置在世界上任何地方。非常适合野营、狩猎和钓鱼！",
		canvas_tent = "帆布帐篷",
		canvas_tent_description = "可放置在世界上任何地方。非常适合野营、狩猎和钓鱼！",
		plastic_chair = "塑料椅",
		plastic_chair_description = "可放置在世界上任何地方。非常适合野营、狩猎和钓鱼！",
		fishing_chair = "钓鱼椅",
		fishing_chair_description = "可放置在世界上任何地方。非常适合野营、狩猎和钓鱼！",
		yoga_mat = "瑜伽垫",
		yoga_mat_description = "可以放置在世界任何地方。非常适合露营、狩猎和钓鱼！",
		cooler_box = "冷藏箱",
		cooler_box_description = "可以放置在世界任何地方。非常适合露营、狩猎和钓鱼！",
		parasol = "遮阳伞",
		parasol_description = "可以放置在世界任何地方。非常适合露营、狩猎和钓鱼！",
		parasol_table = "遮阳伞桌",
		parasol_table_description = "可以放置在世界任何地方。非常适合露营、狩猎和钓鱼！",
		table = "桌子",
		table_description = "可以放置在世界上的任何地方。非常适合露营，狩猎和钓鱼！",
		towel = "毛巾",
		towel_description = "可以放置在世界上的任何地方。非常适合露营，狩猎和钓鱼！",
		disposable_grill = "一次性烤架",
		disposable_grill_description = "可以放置在世界上的任何地方。非常适合露营，狩猎和钓鱼！此物品无法再次拾取。",
		grill = "烤架",
		grill_description = "可以放置在世界上的任何地方。非常适合露营，狩猎和钓鱼！",
		police_barrier = "警戒栏",
		police_barrier_description = "可以放置在世界的任何地方。",
		dummy = "假人",
		dummy_description = "可以放置在世界的任何地方。",
		target = "目标",
		target_description = "可以放置在世界的任何地方。",
		large_target = "大目标",
		large_target_description = "可以放置在世界的任何地方。",
		cone = "锥形桶",
		cone_description = "可以放置在世界的任何地方。",
		spike_strips = "钉板",
		spike_strips_description = "可以放置在世界的任何地方。",
		spike_strips_large = "大型刺钉",
		spike_strips_large_description = "可以放置在世界的任何地方。",
		floodlight = "泛光灯",
		floodlight_description = "可以放置在世界的任何地方。",
		left_diversion_sign = "左侧分流标志",
		left_diversion_sign_description = "可以放置在世界的任何地方。",
		right_diversion_sign = "右侧分流标志",
		right_diversion_sign_description = "可以放置在世界的任何地方。",
		stop_sign = "停止标志",
		stop_sign_description = "可以放置在世界的任何地方。",
		bear_trap = "捕熊陷阱",
		bear_trap_description = "可以放置在世界的任何地方。",
		barrier = "栏杆",
		...
		bandit_1 = "强盗 1",
		bandit_1_description = "可以放置在世界上的任何地方。",
		bandit_2 = "强盗 2",
		bandit_2_description = "可以放置在世界上的任何地方。",
		hostage_1 = "人质1",
		hostage_1_description = "可以放置在世界的任何地方。",
		hostage_2 = "人质2",
		hostage_2_description = "可以放置在世界的任何地方。",

		director_chair = "导演椅",
		director_chair_description = "可以放置在世界的任何地方。方便携带的舒适座椅。",
		beach_chair = "沙滩椅",
		beach_chair_description = "可以放置在世界的任何地方。方便携带的舒适座椅。",
		green_fishing_chair = "绿色钓鱼椅",
		green_fishing_chair_description = "可以放置在世界的任何地方。方便携带的舒适座椅。",
		blue_fishing_chair = "蓝色钓鱼椅",
		blue_fishing_chair_description = "可以放置在世界上的任何地方。方便出行的舒适座椅。",

		tire_wall = "轮胎墙",
		tire_wall_description = "当你需要掩护但没有的时候使用。",

		claymore = "克莱莫尔",
		claymore_description = "终极反人员地雷。",

		tv_stand = "电视架",
		tv_stand_description = "用它在任何你想要的地方支撑电视。",
		tv_remote = "电视遥控器",
		tv_remote_description = "通用遥控器（量子电池不包含在内）.",
		...
		chocolate_cake_description = "用最好的可可豆制成的美味蛋糕。",
		cupcake = "纸杯蛋糕",
		...
		grubs = "蛆虫",
		grubs_description = "非常适合钓鱼。",
		leeches = "水蛭",
		leeches_description = "适合钓鱼。",
		earthworms = "蚯蚓",
		earthworms_description = "适合钓鱼。",
		fishing_rod = "钓鱼竿",
		fishing_rod_description = "适合钓鱼。",
		raw_meat = "生肉",
		raw_meat_description = "一块新鲜的肉。",
		cooked_meat = "熟肉",
		cooked_meat_description = "刚煮熟的肉。",
		burnt_meat = "烧焦的肉",
		burnt_meat_description = "烤焦的肉。",
		leather = "皮革",
		leather_description = "从鹿身上取下的一张漂亮的毛皮。",
		wood = "木材",
		wood_description = "一块刚从树上取下的木头。",
		charcoal = "木炭",
		charcoal_description = "比普通煤更好。",
		...
		thermal_goggles = "热成像眼镜",
		thermal_goggles_description = "能帮助你透过墙壁看见东西（只是开个玩笑xD）。",
		...
		weapon_addon_pp19_description = "俄罗斯卓越的顶峰之作，适合任何一种“突袭”。",
		...
		weapon_addon_rpk16_description = "史上最完美的机关枪，只要别忘了运动套装。",
	...
	jail = {
		...
		remaining_time = "剩余时间: ${remaining} 个月。",
		jailed = "您已被关押 ${amount} 个月。",
	...
	locate = {
		...
		locate_entity_no_permissions = "未获得适当权限，尝试定位实体。",
	...
	login = {
		...
		bad_words_in_character_creation = "尝试创建一个角色时，姓名或背景故事中可能含有不良字词: \"${badWords}\"",
		disallowed_words_in_character_name = "尝试创建一个可能有问题的角色姓名: \"${characterName}\"",
		disallowed_birthday_ban = "尝试创建一个可能有问题的生日: \"${birthday}\"",
		...
		cache_assets = "缓存资源",
		download_assets = "您想下载并缓存服务器的大部分资源吗？这样做会引发一些问题：",
		cache_assets_less_lag = "可能会减少游戏过程中的延迟、帧丢失和网络延迟波动。特别是当您使用低端硬件或较慢的连接时。",
		cache_assets_crashes = "在此过程中可能会导致游戏崩溃。如果发生这种情况，请使用“慢速下载”选项。",
		cache_assets_restart = "完成后，我们建议您重新启动游戏，因为这可能会导致本次会话的延迟。",
		cache_assets_disk = "这将占用一些磁盘存储空间，请确保有足够空间。在更新后，清除旧缓存以释放空间可能也是值得的。",
		vehicles = "车辆",
		objects = "物件",
		peds = "行人",
		clothing = "服装",
		...
		bad_words = "您的角色名称或背景故事中存在不良词汇。",
		disallowed_name = "您的角色名称中存在不允许的词汇。",
		disallowed_birthday = "不允许使用该出生日期。",
	...
	lottery = {
		...
		lottery_about_to_roll = "将在5分钟后抽出今天的彩票获胜者。当前彩池总额为$${totalPot}，您投了$${betAmount}。您赢的几率为 ${odds}%。",
		current_lottery_pot = "当前彩票奖池总额为 $${totalPot}，你已投入 $${betAmount}。你的中奖几率为 ${odds}%。",
		drew_a_lottery_winner = "彩票的获奖者已经产生。",
		roll_lottery_no_permission = "该玩家试图进行彩票抽奖，但没有权限。",
		winner_has_been_picked = "${fullName} 赢得了彩票奖池的 $${totalPot}！他们下注了 $${betAmount}，中奖几率为 ${odds}%。",
		...
		lottery_log_description = "${fullName} (#${characterId}) 赢得了${totalPot}美元的彩票奖池。他们押注了${betAmount}美元。"
	},
	...
	lucky_wheel = {
		...
		logs_lucky_wheel_reward_chips_details = "${consoleName} 转动了轮盘并赢得了价值为 $${amount} 的筹码。",
		...
		logs_lucky_wheel_reward_queue_priority_details = "${consoleName} 转动了轮盘并赢得了一周的排队优先权。"
	},
	...
	magnifying_glass = {
		...
		sold_item_logs_title = "出售稀有物品",
		sold_item_logs_details = "${consoleName} 卖出了 ${item} 以获得 $${price}。"
	},
	...
	mechanics = {
		...
		upgrades_list = "${armor}, ${engine}, ${brakes}, ${transmission} 和 ${turbo}。",
	...
	meow = {
		...
		chill = "[${InteractionKey}] 放松",
		meditate = "[${InteractionKey}] 冥想",
		salute = "[${InteractionKey}] 敬礼",
		stretch = "[${InteractionKey}] 拉伸",

		feed_active = "正在喂食Maxwell",
		pet_active = "正在抚摸Maxwell",
		brush_active = "正在刷毛Maxwell",
		catnip_active = "正在给Maxwell猫草",
		treat_active = "给麦克斯韦喂食",
		check_up_active = "检查麦克斯韦的情况",
		chill_active = "和麦克斯韦一起放松",
		meditate_active = "与麦克斯韦一起冥想",
		salute_active = "向麦克斯韦敬礼",
		stretch_active = "与麦克斯韦一起伸展",
	...
	mining = {
		...
		drill_no_drops = "你在这块石头中没有找到宝石。",
		drill_drops = "你在这块石头中找到了一些宝石。",
		used_drill = "你的钻头损坏了。",
		still_shook = "你还在上次的爆炸中受到震撼，这块石头中没有找到宝石。",
	...
	notepads = {
		...
		notepad_info_missing_permissions = "玩家尝试未经授权获取便条信息。",
		wipe_notepads_missing_permissions = "玩家尝试未经授权清空便条。"
	},
	...
	notices = {
		...
		add_notice_missing_permissions = "玩家尝试未经授权添加便条。",
		remove_notice_missing_permissions = "玩家尝试移除通知但没有足够的权限。"
	},
	...
	orbitcam = {
		...
		orbitcam_no_permission = "尝试切换环绕相机但没有必要的权限。"
	},
	...
	overview = {
		...
		about_sound_effects_text = "这些字段允许您覆盖一些音效。它们需要一个 .oog 文件的链接才能正常工作。链接必须是 https:// 的，不能是 http:// 的。一种简单的上传文件的方法是将文件上传到 discord，然后复制其链接，并将其插入到这里的字段中。",
		...
		sound_effect_save = "保存",
		sound_effect_reset = "恢复",

		disable_tablet_animation = "禁用平板电脑动画",
		staff_notifications_reports = "举报通知",
		staff_notifications_staff_chat = "职员聊天通知",
		staff_notifications_general = "常规通知",
		staff_notifications_anti_cheat = "反作弊通知",
		...
		show_common_events_off = "显示常见事件：关闭",
		show_common_events_on = "显示常见事件：开启",
		...
		bad_screen_word_title = "屏幕敏感词",
		bad_screen_word_about = "在这里列出了屏幕上出现有违规词汇的玩家。这将有助于找到那些可能使用修改器的玩家。",
	...
	panic = {
		press_panic_button = "您还有5秒钟的时间按下紧急按钮（X键）。",
	...
	ped_spawn = {
		...
		ped_task_success = "成功将'${task}'任务分配给生成的行人。",
		ped_failed_task = "无法将'${task}'任务分配给生成的行人。",
		invalid_target = "无效的目标服务器ID。",
		missing_task = "缺少任务参数。",
		invalid_task = "无效的行人任务'${task}'。",
		target_required = "此行人任务需要一个有效的目标。",
		ped_emote_success = "成功使生成的行人播放'${emote}'表情动作。",
		ped_failed_emote = "无法让生成的NPC执行 '${emote}' 表情。",
		invalid_emote = "无效的表情 '${emote}'。",
	...
	ped_takeover = {
		failed_reset = "切换回原始NPC失败。",
		failed_reset_not_exist = "您的原始NPC不存在或距离您较远。",
		failed_takeover = "无法接管角色。",
		invalid_network_id = "无效的网络ID。"
	},

	peds = {
		ped_robbing_injection = "过度的抢劫角色！（绕过服务器超时，很可能使用注入器完成此操作）",
		robbed_ped_logs_title = "抢劫的角色",
		robbed_ped_logs_details = "${consoleName}抢劫了一个角色，并获得了$${payout}。",
	...
	pictures = {
		selfie_description = "${firstName} ${lastName}的照片。"
	},
	...
	player_scales = {
		...
		set_player_scale_no_permission = "玩家没有权限设置其他玩家的比例。",
	...
	printer = {
		...
		printed_logs_details = "${consoleName} 使用 `${paperType}` 打印 `${itemName}`，图片链接为 `${url}`。"
	},
	...
	radio = {
		...
		radio_volume_set = "收音机音量已设置为`${radioVolume}`。",
		radio_volume_current = "您当前的收音机音量设置为`${radioVolume}`。",
		...
		radio_debug_no_permissions = "无访问权限，无法开启/关闭无线电调试。",
	...
	riot_mode = {
		...
		add_riot_player_no_permissions = "未获得足够的权限以将玩家添加到骚乱名单。",
		remove_riot_player_no_permissions = "未获得足够的权限以将玩家从骚乱名单中移除。",
	...
	shockwaves = {
		create_shockwave_missing_permissions = "玩家尝试创建冲击波但没有所需的权限。",
		push_player_missing_permissions = "玩家尝试推开另一个玩家但没有所需的权限。",
	...
	smoothies = {
		...
		milkshake_label = "奶昔（${flavors}）",
		smoothie_label = "冰沙（${flavors}）",
		seperator = "和"
	},
	...
	special_imports = {
		...
		purchased_vehicle = "成功购买${label}，花费了${price}。该车辆已添加到您的车库。",

		something_went_wrong = "出了点问题。",
		not_enough_money = "您的资金不足。",
		invalid_package = "无效的套餐级别。（您需要至尊级别）",

		dealership_closed = "经销商目前关闭。",
	...
	sync = {
		...
		invalid_weather = "天气`${weatherName}`无效。有效的天气名称为CLEAR，EXTRASUNNY，CLOUDS，OVERCAST，RAIN，CLEARING，THUNDER，SMOG，FOGGY，XMAS，SNOWLIGHT和BLIZZARD。",
		...
		developer_ambience_on = "已开启开发人员环境音效。",
		developer_ambience_off = "已关闭开发人员环境音效。"
	},
	...
	time_scale = {
		...
		set_time_scale_missing_permissions = "玩家尝试设置时间刻度但没有所需的权限。",
	...
	titanic = {
		...
		create_titanic_missing_permissions = "玩家尝试创建泰坦尼克号，但他们没有必要的权限。"
	},
	...
	trackers = {
		...
		department_ems_training = "医护培训"
	},

	trading_cards = {
		access_store = "[${InteractionKey}] 进入商店",
	...
	treasure_maps = {
		...
		press_to_combine_pieces = "按下 ~INPUT_CONTEXT~ 组合${mapTier}级地图碎片。",
	...
	tsunami = {
		...
		set_ocean_scaler_no_permission = "玩家没有设置海洋比例的所需权限。",
	...
	voice = {
		...
		voice_chat = "语音聊天",
		voice_server_connected = "已连接到语音服务器。向相关玩家发送语音数据。",
		voice_server_disconnected = "与语音服务器断开连接。等待重新连接。",
		...
		listening_missing_permissions = "玩家尝试切换其收听状态，但他们没有所需的权限。",
		voice_mute_missing_permissions = "玩家尝试切换其他玩家的静音状态，但他们没有所需的权限。",
	...
	weed_field = {
		pick_weed = "按下 ~INPUT_CONTEXT~ 拾取大麻。",
		picking_weed = "正在拾取大麻"
	},
	...
	wizard = {
		...
		ignite_success = "成功点燃${consoleName}。",
		ignite_failed = "无法点燃玩家。",
		...
		vehicle_temp_action_missing_permissions = "玩家在没有足够权限的情况下尝试运行车辆临时动作。"
	},
	...
	-- global/*
	entities = {
		in_no_ped_population_area = "你处在一个'无人口区域'。",
		not_in_no_ped_population_area = "你不处于'无人口区域'。"
	},
	...
	states = {
		...
		get_entity_states_missing_permissions = "玩家在没有适当权限的情况下尝试获取特定实体的状态。"
	},
	...
	duty = {
		toggle_duty_status_no_permissions = "尝试使用命令切换工作状态，但没有足够的权限。",
	...
	clamps = {
		...
		vehicle_not_driveable = "无法给损坏的车辆安装夹具。",
		clamping = "安装夹具中",
	...
	fuel = {
		...
		fuel_pump_text = "加油费用: $${fuelCost}~n~按下 ~g~E ~w~停止加油.",
		vehicle_text = "油量: ${fuelLevel}%",
		tank_full = "油箱已满。",
		vehicle_busy = "附近的车辆正在使用。",
		purchase_jerry_can = "按下 ~g~${InventoryKey} ~w~购买一个汽油罐。",
		gas_station = "加油站",
		petrolcan_fuel_text = "汽油剩余数量: ${petrolAmount}%~n~按下 ~g~E ~w~停止加油。",
	...
	garages = {
		...
		unable_to_withdraw = "无法取出车辆，因为目前车辆正在被使用。",
		...
		invalid_model = "无效或未知的车辆模型。",
		vehicle_in_the_way = "有辆车挡住了刷车点。",
		vehicle_is_out = "你的车辆已经出来了。",
		vehicle_stored = "你的车辆已被存储。",
		error_storing = "存储车辆失败。这辆车是你的吗？",
		...
		vehicle_weight = "重量：${weight}",
		last_garage_letter = "上次 - 车库 ${letter}",
		last_garage_impound = "上次 - 扣押车辆",
	...
	plates = {
		...
		fake_plate_missing_permissions = "玩家尝试通过命令设置假车牌，但没有足够的权限。"
	},
	...
	vehicles = {
		...
		manual_gears_enabled = "已启用手动换档。",
		manual_gears_disabled = "已禁用手动换档。",
		manual_gear_set_to = "换档到 ${gearId}。",
		speed_limiter_set_to_metric = "速度限制器现在将限制速度为 ${speed} 公里/小时。",
		speed_limiter_set_to_imperial = "速度限制器现在将限制速度为 ${speed} 英里/小时。",
		speed_limiter_reset = "速度限制器现在将限制车辆切换时的速度。",
		speed_limiter_on_metric = "速度限制器设置为 ${speed} 公里/小时。",
		speed_limiter_on_imperial = "速度限制器设置为 ${speed} 英里/小时。",
		speed_limiter_on_plane_metric = "速度限制器设置为 ${speed} 公里/小时和 ${altitude} 米。",
		speed_limiter_on_plane_imperial = "速度限制器设置为 ${speed} 英里每小时 和 ${altitude} 英尺。",
		speed_limiter_on_helicopter_metric = "速度限制器设置为 ${altitude} 米（悬停）。",
		speed_limiter_on_helicopter_imperial = "速度限制器设置为 ${altitude} 英尺（悬停）。",
		...
		toggled_vehicle_weapons_not_in_a_vehicle = "您不在车辆中。",
	...
	wheels = {
		press_to_slash = "[${InteractionKey}]按住割开",
		hold_to_slash = "按住割开",
		slashing_tire = "刺破轮胎"
	},
	...
	alpha = {
		...
		serial_number = "序列号：${serialNumber}<br>这把武器注册给了${fullName}（#${characterId}）。",
		serial_number_unknown = "序列号：未知",
		...
		citizen_card_has_portrait = "<i>它有一张照片。</i>",
		...
		evidence_clothing = "一件衣物（${clothingType}）。",
		evidence_car_dna = "从车牌${plateNumber}取得了DNA，与${DNAOwnerName}（${DNAOwner}）有关。",
		evidence_dna = "从${fullName} #${characterId}收集的DNA。",
		evidence_fingerprint = "${fullName} #${characterId}的指纹。",
		evidence_not_processed = "这个证物袋尚未经过处理。",
		additional_information = "额外信息：",
		picked_up_at_location = "在此位置拾取：",
		clothing_dna_trace = "DNA痕迹追溯至${fullName}（#${cid}）",
