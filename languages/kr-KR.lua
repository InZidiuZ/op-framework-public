...
OP.Global.Locales.Languages["kr-한"] = {
	...
	admin = {
		...
		indestructibility_feature = "불멸성",
		invisibility_feature = "비가시성",
		nitro_boost_feature = "니트로 부스트",
		no_nearby_vehicles_feature = "주변 차량 없음",
		speed_boost_feature = "속도 향상",
	...
	starter_car = {
		your_vehicle_is_nearby = "개인 차량은 근처에 주차되어 있습니다.",
		would_you_like_directions = "가는 길을 알려드릴까요?",
		press_to_respond = "수락하려면 ~INPUT_FRONTEND_ACCEPT~를 누르고 거부하려면 ~INPUT_FRONTEND_CANCEL~을 누릅니다.",
		follow_the_checkpoints = "체크포인트를 따라가세요",

		received_logs_title = "받은 시작 자동차",
		received_logs_details = "${consoleName} 님이 시작된 자동차를 받았습니다(모델: ${modelName})."
	},
	...
	garages = {
		...
		press_to_access = "~INPUT_CONTEXT~ 를 눌러 차고에 액세스합니다.",
		ui_return = "반환",
	...
	alpha = {
		...
		hair = "머리",
		hair_color = "머리색",
		hair_highlight_color = "강조 색",
		remove_undershirt = "밑면 제거",
		no_idea = "잘 모르겠네",
		head = "머리",
		...
		left_wrist = "왼쪽 손목",
		right_wrist = "오른쪽 손목",
		remove_helmets = "헬멧 제거",
		remove_glasses = "안경 제거",
		remove_earrings = "귀걸이 제거",
		remove_left_wrist = "왼쪽 손목 제거",
		remove_right_wrist = "오른쪽 손목 제거",
		blemishes = "결점",
		facial_hair = "수염",
		eyebrows = "눈썹",
		ageing = "에이징",
		...
		chest_hair = "흉모",
		body_blemishes = "신체 결함",
		add_body_blemishes = "본문 결함 추가",
		opacity = "불투명도",
		colours = "색상",
		press_to_access_clotheshop = "~INPUT_CONTEXT~ 를 눌러 의류 스폿에 액세스합니다.",
		changing_only_clotheshop = "옷을 바꾸려면 /outfit을 하세요.",
		clothing_store = "옷가게",
		finish_creation = "문자 사용자 지정을 완료하려면 ~g~G~w~를 누릅니다. 이 작업은 취소할 수 없습니다.",
		finish_creation_timer = "[${timer}s] 문자 사용자 지정을 완료하려면 ~g~G~w~를 길게 누르세요. 이 작업은 취소할 수 없습니다.",
