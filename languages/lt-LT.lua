...
OP.Global.Locales.Languages["lt-LT"] = {
	...
	commands = {
		...
		model_view_command_parameter_clamp = "spenelis",
		model_view_command_parameter_clamp_help = "Pristabdyti dydį visada būti didesniam nei 0.25 (padeda su mažais modeliais).",
